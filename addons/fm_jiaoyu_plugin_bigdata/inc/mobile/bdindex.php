...
if ($operation == 'display') {
    ...
    $twtj = SetEchartsData("14日体温统计","duline",false,$payment_year_axis,$annual_income);
    ...
    if($keep_MC){
        ...
        //昨日正常体温
        // $yzc = pdo_fetchcolumn("SELECT count(distinct sid) FROM " . GetTableName('morningcheck') . " WHERE schoolid = '{$schoolid}' AND createdate = '{$yesterday}' AND ( (tiwen BETWEEN '35.5' AND '37.5') or tiwen < '1')");
