    ...
    if (!empty($ckmac)) {
        ...
        if($ckmac['is_video'] == 2){
            ...
            if($aliyun){
                ...
                $Category = AddCategorys($appid,$key,$schoolid,$weid);
                $result['data']['alivodappid'] = $appid;
                $result['data']['alivodkey'] = $key;
                $result['data']['category'] = $Category['CateId'];
            }
            $result['data']['is_video'] = 2;
        }else{
            $result['data']['is_video'] = 1;
        }
