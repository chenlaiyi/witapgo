 ...
 * @LastEditTime: 2020-12-14 14:57:01
 */
global $_GPC, $_W;
//有人脸的学校列表
...
if(!empty($schoollist)){
    foreach($schoollist as $vs){
        ...
        foreach($cardlist as $value_cl){
            ...
            $GetDatesetWithBj = GetDatesetWithBj($vs['schoolid'],$_W['uniacid'],$groupNo);
            $TempTimeSet = $GetDatesetWithBj[$groupNo]['timeset']['todaytimeset'];
            }
            // $userInfos[] = array(
            //     'idCardNum' => '',
