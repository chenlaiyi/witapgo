...
$qh    = pdo_fetchAll("SELECT sid,sname FROM " . tablename($this->table_classify) . " where weid = '{$weid}' AND schoolid ={$schoolid} And type = 'xq_score'  AND is_show_qh = 1");
$yearList = array(
...
if($operation == 'display'){
    ...
    $StudentList = znlGetReportNew($schoolid,$_GPC['sid'],$param);
