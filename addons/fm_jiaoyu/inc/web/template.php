...
if(!$_W['schooltype']){
	...
	$TeaiconArray['tspecialform'] = array('name' =>'营销宝表单','icon' => MODULE_URL.'public/mobile/img/btn/bot/59ddef4d7a25b_90.png','do'=>'tspecialform','url' => $this -> createMobileUrl('tspecialform', array('schoolid' => $schoolid)));
}
if(keep_Lx()){
...
if($operation == 'display'){
	...
	if(!$_W['schooltype']){
		...
		$icondata[] = array('name' =>'营销宝表单','typeid' => $type2,'ssort' => 11,'icon' => MODULE_URL.'public/mobile/img/59ddef4d7a25b_88.png','do'=>'tspecialform','url' => $this -> createMobileUrl('tspecialform', array('schoolid' => $schoolid)));
	}
	//type3 校园管理
