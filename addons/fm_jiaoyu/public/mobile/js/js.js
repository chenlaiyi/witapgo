...
function geneDialog(userName) {
	//定义回答人物信息， 格式:首字:{id:首字,name:名字,avatar:头像}
	//使用方法：_members.首字
	var defaultMembers = {
		lj: {
			id: 'lj',
...
//_dialog使用方法:html里定义data-target-dialog=n，这里定义_dialog.d'n'
	// 引导对话
	/*
	_dialog是主体
	在php里处理，不用——members，直接将author里的内容替换为{id：,name:,avatar:}就行
	...
	*/
	...
	//这里定义的是后续，如2_1就是_dialog.d2的第1个后续
	// 关于 存储空间 - 30部奥斯卡 的对话
	_dialog.d2_1 = [{
		type: 'plain',
		author: _members.me,
