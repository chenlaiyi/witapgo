function geneDialog(e) {
	...
	_members = $.extend(_members, t), _dialog.d0 = [{
		...
		type: "plain",
		author: _members.lj,
		content: "我们刚刚发布了小米Max，先发几张美图和外观视频，你欣赏一下",
		pause: 3e3
	}, {
		type: "video",
		author: _members.lj,
		...
		type: "plain",
		author: _members.lj,
		content: "怎么样，不错吧？太忙没来得及邀请你参加发布会，我把大家叫过来单独给你介绍"
	}, {
		type: "plain",
		author: _members.lj,
		content: "想了解啥尽管问吧：）"
...
$.fn.loadingMask = function() {
	...
	function p() {
		n(), geneDialog(_userName),setdia(_dia), l(_dialog.d0, function() {
			$(".J_noticeInput").show()
			...
			$(".J_galleryOverlay").filter('[data-gallery="1"]').show(), $(".J_gallerySlide").css({
