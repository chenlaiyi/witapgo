<?php
$sql="
CREATE TABLE IF NOT EXISTS `ims_wx_school_address` (
...
CREATE TABLE IF NOT EXISTS `ims_wx_school_allcamera` (
  ...
  `ios_playtype` tinyint(1) NOT NULL DEFAULT '1' COMMENT '1播放器2原生',
  `android_playtype` tinyint(1) NOT NULL DEFAULT '1' COMMENT '1播放器2原生',
  ...
  `ispx` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `ims_wx_school_articledz` (
  ...
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '点赞状态1点赞2取消',
  `createtime` int(10) unsigned NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `ims_wx_school_articlepl` (
  ...
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '评论是否显示1显示，2隐藏',
  `createtime` int(10) unsigned NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `ims_wx_school_bjq` (
  ...
  `wp` varchar(30) NOT NULL DEFAULT '0' COMMENT '0',
...
CREATE TABLE IF NOT EXISTS `ims_wx_school_checklog` (
  ...
  `note_way` tinyint(1) NOT NULL DEFAULT '1',
  `note_pass` tinyint(1) NOT NULL DEFAULT '1',
...
CREATE TABLE IF NOT EXISTS `ims_wx_school_checkmac` (
  ...
  `is_video` tinyint(1) NOT NULL DEFAULT '1' COMMENT '1关2开',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `ims_wx_school_classcard_activity` (
  ...
  `cate` tinyint(4) NOT NULL DEFAULT '1' COMMENT '1报名活动2投票活动',
  `starttime1` int(11) NOT NULL,
  `endtime1` int(11) NOT NULL,
  `attr` varchar(1000) DEFAULT NULL COMMENT '投票选项',
...
CREATE TABLE IF NOT EXISTS `ims_wx_school_classcard_application` (
  ...
  `bjarray` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `ims_wx_school_classcard_countdown` (
  ...
  `count_down` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `ims_wx_school_classcard_exam` (
  ...
  `exam_course` varchar(255) DEFAULT NULL,
  `course_id` int(11) DEFAULT NULL,
  `start_time` int(11) DEFAULT NULL,
  `end_time` int(11) DEFAULT NULL,
  `invigilator` varchar(1000) DEFAULT NULL,
  `school_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `ims_wx_school_classify` (
  ...
  `is_show_qh` tinyint(1) NOT NULL DEFAULT '1' COMMENT '是否显示期号0否，1是',
  `is_upload` tinyint(1) NOT NULL DEFAULT '1' COMMENT '相册分类是否允许上传1是0否',
  `bjid` int(10) NOT NULL DEFAULT '1' COMMENT '对应的班级id',
  `kcid` int(10) NOT NULL,
  `phototype` tinyint(1) NOT NULL DEFAULT '2' COMMENT '相册类型2班级1个人',
  `is_show` tinyint(1) NOT NULL DEFAULT '1' COMMENT '是否显示通讯录及群发通知，0不显示，1显示',
  `xzf_datastatus` tinyint(1) DEFAULT '1' COMMENT '1新增2更新',
  `xzf_needsync` tinyint(1) DEFAULT '0',
  ...
  `bjrate` decimal(5,2) NOT NULL DEFAULT '1.00' COMMENT '班级倍率',
  `bzrrate` decimal(5,2) NOT NULL DEFAULT '1.00' COMMENT '班主任倍率',
...
CREATE TABLE IF NOT EXISTS `ims_wx_school_cost` (
  ...
  `is_print` tinyint(1) NOT NULL DEFAULT '2' COMMENT '是否启用打印机',
  `printarr` varchar(100) NOT NULL DEFAULT '' COMMENT '打印机',
  `serverend` char(10) NOT NULL DEFAULT '0' COMMENT '考勤卡服务到期时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `ims_wx_school_coursebuy` (
  ...
  `bjid` int(11) NOT NULL DEFAULT '0' COMMENT '培训学校使用',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `ims_wx_school_ddscorecategory` (
  ...
  `addition` tinyint(1) NOT NULL DEFAULT '1',
...
CREATE TABLE IF NOT EXISTS `ims_wx_school_ddscorelog` (
  ...
  `weid` int(11) NOT NULL,
  `cid` int(11) NOT NULL,
  `score` varchar(10) NOT NULL DEFAULT '1',
...
CREATE TABLE IF NOT EXISTS `ims_wx_school_dianzan` (
  ...
  `createtime` int(10) unsigned NOT NULL COMMENT '创建时间',
  `kujx` varchar(30) NOT NULL DEFAULT '0' COMMENT '图片路径',
...
CREATE TABLE IF NOT EXISTS `ims_wx_school_getcash` (
  ...
  `paytype` tinyint(1) NOT NULL DEFAULT '0' COMMENT '1微信支付2现金付费3其他方式',
  `contrank` varchar(200) NOT NULL COMMENT '提现备注',
  `approval` tinyint(1) NOT NULL DEFAULT '0' COMMENT '1未审核2审核',
  `shtid` varchar(50) NOT NULL DEFAULT '0' COMMENT '审核人',
  `shrank` varchar(200) NOT NULL COMMENT '审核备注',
  `paytid` varchar(50) NOT NULL DEFAULT '0' COMMENT '付款操作人',
  `payrank` varchar(200) NOT NULL COMMENT '付款备注',
  `paytime` int(11) NOT NULL,
  `dztime` int(11) NOT NULL,
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '1未付2已付',
...
CREATE TABLE IF NOT EXISTS `ims_wx_school_getcash_order` (
  ...
  `fee` decimal(10,2) NOT NULL,
  `createtime` int(10) NOT NULL,
  `status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '1未结2已付',
  `type` tinyint(1) NOT NULL COMMENT '1课时提现',
  `kdid` int(10) DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `ims_wx_school_getcashrule` (
  ...
  `ruleword` varchar(2000) DEFAULT NULL COMMENT '提现规则文字说明',
  `payweid` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `ims_wx_school_growuppage` (
  ...
  `isallok` tinyint(1) NOT NULL DEFAULT '0',
  `is_send` tinyint(1) NOT NULL DEFAULT '0',
  `is_ok_stu` tinyint(1) NOT NULL DEFAULT '0' COMMENT '学生是否完成',
  `createtime` char(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ims_wx_school_index` (
  ...
  `is_online` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否在线教程0否，1是',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `ims_wx_school_kc_getcashrule` (
  ...
  `kcid` int(11) NOT NULL,
  `payweid` int(11) NOT NULL,
  `is_needsh` tinyint(1) NOT NULL DEFAULT '0' COMMENT '1需要审核,2否',
...
CREATE TABLE IF NOT EXISTS `ims_wx_school_kc_signset` (
  ...
  `schoolid` int(10) unsigned NOT NULL COMMENT '学校ID',
  `kcid` int(10) unsigned NOT NULL COMMENT '归属课程ID',
  `tea_sign_confirm` tinyint(1) unsigned NOT NULL DEFAULT '2',
  `stu_sign_confirm` tinyint(1) unsigned NOT NULL DEFAULT '2',
  `more_tea_sign` tinyint(1) unsigned NOT NULL DEFAULT '2',
  `sh_tea_teacherids` varchar(600) DEFAULT '',
  `tea_change_stutype` tinyint(1) unsigned NOT NULL DEFAULT '2',
  `tea_sign_fuke` tinyint(1) unsigned NOT NULL DEFAULT '2',
  `tea_sign_old` tinyint(1) unsigned NOT NULL DEFAULT '2',
  `tea_add_ks` tinyint(1) unsigned NOT NULL DEFAULT '2',
  `tea_edit_ks` tinyint(1) unsigned NOT NULL DEFAULT '2',
  `tea_mobile_pk` tinyint(1) unsigned NOT NULL DEFAULT '2',
  `tea_no_myks` tinyint(1) unsigned NOT NULL DEFAULT '2',
  `allow_ksdf` tinyint(1) unsigned NOT NULL DEFAULT '2',
  `allow_kspl` tinyint(1) unsigned NOT NULL DEFAULT '2',
  `allow_shera_pl` tinyint(1) unsigned NOT NULL DEFAULT '2',
  `createtime` int(10) unsigned NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `ims_wx_school_kcbiao` (
  ...
  `createtime` int(10) unsigned NOT NULL,
  `sk_start` int(11) unsigned NOT NULL,
  `sk_end` int(11) unsigned NOT NULL,
  `is_allow_reply` tinyint(1) NOT NULL DEFAULT '2' COMMENT '1允许2否',
  `is_allow_ykreply` tinyint(1) NOT NULL DEFAULT '2' COMMENT '1允许2否',
  `sid` int(10) DEFAULT '0',
  `tempsid` int(10) DEFAULT '0',
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `ims_wx_school_kcpingjia` (
  ...
  `star` int(3) NOT NULL,
  `createtime` int(11) NOT NULL,
  `ksid` int(10) unsigned NOT NULL COMMENT '所属课时',
  `tosid` int(10) unsigned NOT NULL COMMENT '评价的学生',
  `totid` int(10) unsigned NOT NULL COMMENT '评价的老师',
  `masterid` int(10) unsigned NOT NULL COMMENT '主ID',
  `is_master` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '1主评论0回复',
  `is_show` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '是否显示',
  `photo` varchar(2000) DEFAULT NULL COMMENT '评价图片组',
  `audio` varchar(2000) DEFAULT NULL COMMENT '评价语音',
...
CREATE TABLE IF NOT EXISTS `ims_wx_school_kcsign` (
  ...
  `ismaster_tid` tinyint(1) NOT NULL DEFAULT '1' COMMENT '1主讲2助教',
  `signtype` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `ims_wx_school_leave` (
  ...
  `pardstatus` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `ims_wx_school_lxvis` (
  ...
  `snowid` varchar(20) NOT NULL DEFAULT '0',
  `tempcard` char(16) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `ims_wx_school_mcreportlist` (
  ...
  `sid` int(11) NOT NULL,
  `type` int(11) NOT NULL,
  `semestertype` tinyint(1) NOT NULL DEFAULT '1',
  ...
  `createtime` int(11) NOT NULL,
  `content` text NOT NULL,
  `cnbotssemesterid` varchar(40) NOT NULL DEFAULT '0',
  `bjid` int(10) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `ims_wx_school_media` (
  ...
  `is_video` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0相册1视频',
...
CREATE TABLE IF NOT EXISTS `ims_wx_school_morningcheck` (
  ...
  `height` float(6,2) NOT NULL DEFAULT '1.00' COMMENT 'cm',
  `weight` float(6,3) NOT NULL DEFAULT '1.000' COMMENT 'kg',
  ...
  `is_send` tinyint(1) NOT NULL DEFAULT '1' COMMENT '是否发送',
  `cough` tinyint(1) NOT NULL DEFAULT '2' COMMENT '咳嗽，1是2否',
  `vomit` tinyint(1) NOT NULL DEFAULT '2' COMMENT '呕吐，1是2否',
  `trauma` tinyint(1) NOT NULL DEFAULT '2' COMMENT '外伤，1是2否',
  `diarrhea` tinyint(1) NOT NULL DEFAULT '2' COMMENT '腹泻，1是2否',
  `cold` tinyint(1) NOT NULL DEFAULT '2' COMMENT '感冒，1是2否',
  ...
  `issb` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否设备0不是1是',
  `nail` tinyint(1) NOT NULL DEFAULT '1' COMMENT '指甲1正常2异常',
  `handHerpes` tinyint(1) NOT NULL COMMENT '手掌疱疹0未检测1正常2异常',
  `herpes` tinyint(1) NOT NULL COMMENT '疱疹0未检测1正常2异常',
  `headache` tinyint(1) NOT NULL DEFAULT '2' COMMENT '头痛，1是2否',
  `is_mc` tinyint(1) NOT NULL DEFAULT '0' COMMENT '晨检定制，1是0否',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `ims_wx_school_news` (
  ...
  `isshow` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否显示内容2关闭，0-1开启',
  `isopenpl` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否开启评论2关闭，0-1开启',
  `defaultshow` tinyint(1) NOT NULL DEFAULT '1' COMMENT '默认显示评论0-1显示，2隐藏',
  `isopendz` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否开启点赞2关闭，0-1开启',
...
CREATE TABLE IF NOT EXISTS `ims_wx_school_notice` (
  ...
  `is_sync` tinyint(1) DEFAULT '0' COMMENT '是否同步班牌',
...
CREATE TABLE IF NOT EXISTS `ims_wx_school_online` (
  ...
  `type` tinyint(1) DEFAULT '1' COMMENT '1任务2在线',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `ims_wx_school_order` (
  ...
  `createtime` int(10) unsigned NOT NULL COMMENT '创建时间',
  `kujx` varchar(30) NOT NULL DEFAULT '0' COMMENT '支付LOGO',
  ...
  `redpacketlogid` int(10) DEFAULT '0' COMMENT '红包记录id',
  `couponlogid` int(10) DEFAULT '0' COMMENT '优惠券记录id',
  `extra_info` int(10) DEFAULT '0',
  `wqorderid` varchar(1000) DEFAULT '' COMMENT '本地流水号',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `ims_wx_school_saleform` (
  ...
  `tid` varchar(10) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_wx_school_schoolset` (
  ...
  `uid` text,
  `stutemplate` varchar(10) DEFAULT 'old',
  `teatemplate` varchar(10) DEFAULT 'old',
  `tx_pay` tinyint(1) NOT NULL DEFAULT '2' COMMENT '提现付款1启用2关闭',
  `is_dybp` tinyint(1) NOT NULL DEFAULT '1' COMMENT '大云班牌',
  ...
  `twqswitch` tinyint(1) NOT NULL DEFAULT '1',
  ...
  `top` tinyint(1) NOT NULL DEFAULT '0' COMMENT '人脸是否是否。0否，1是',
  `teapictype` text NOT NULL COMMENT '老师相册分类',
  `stupictype` text NOT NULL COMMENT '老师相册分类',
  `isallowup` tinyint(1) NOT NULL DEFAULT '2' COMMENT '是否允许家长上传1是2否',
  `is_mc` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否晨检',
  `yqdkset` text NOT NULL COMMENT '疫情打卡设置',
  `is_manual` tinyint(3) NOT NULL DEFAULT '0' COMMENT '成长手册',
  `addedinfo` text COMMENT '万能字段',
  `is_allow_send_voice` tinyint(1) DEFAULT '2' COMMENT '发送语音1允许2不允许',
  `xzf_scid` int(11) NOT NULL,
  `znl_appid` varchar(100) DEFAULT NULL,
  `znl_appsecret` varchar(100) DEFAULT NULL,
  `senddoor` tinyint(1) DEFAULT '0',
  `priority` tinyint(1) DEFAULT '0',
  `is_tx_tea` tinyint(1) DEFAULT '0',
  `synctime` varchar(10) NOT NULL DEFAULT '0',
  `is_limit_send` tinyint(1) NOT NULL DEFAULT '1',
  `is_repet` tinyint(1) NOT NULL DEFAULT '1',
  `dd_limit_time` int(10) NOT NULL DEFAULT '0',
  `dd_repet_time` int(10) NOT NULL DEFAULT '0',
  `synctime_month` varchar(10) NOT NULL DEFAULT '0',
  `synctime_xq` varchar(10) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `ims_wx_school_score` (
  ...
  `createtime` int(10) unsigned NOT NULL,
  `tid` varchar(200) NOT NULL DEFAULT '' COMMENT '操作人',
...
CREATE TABLE IF NOT EXISTS `ims_wx_school_set` (
  ...
  `dkcgtz` varchar(300) DEFAULT '',
  `twcltz` varchar(300) DEFAULT '',
  `jktxtz` varchar(300) DEFAULT '',
  ...
  `faceset` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否开启，0否，1是',
  ...
  `xzfstatus` tinyint(1) DEFAULT '2' COMMENT '1开启2关闭',
  `xzftoken` varchar(255) NOT NULL,
  `xzftokentime` char(10) NOT NULL,
  `tyshtx` varchar(200) DEFAULT '' COMMENT '通用审核提醒',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `ims_wx_school_sharerecord` (
  ...
  `spid` int(11) NOT NULL,
  `kcid` int(11) NOT NULL,
  `shtime` int(11) NOT NULL DEFAULT '1',
...
CREATE TABLE IF NOT EXISTS `ims_wx_school_shoucepyk` (
  ...
  `createtime` int(10) unsigned NOT NULL,
  `ssort` int(10) unsigned NOT NULL COMMENT '排序',
  `sid` int(10) NOT NULL DEFAULT '0' COMMENT '评语分类ID',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `ims_wx_school_special` (
  ...
  `marketingtype` tinyint(1) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_wx_school_students` (
  ...
  `s_type` tinyint(3) NOT NULL DEFAULT '1' COMMENT '走读住校',
  ...
  `is_banzhang` tinyint(4) NOT NULL DEFAULT '0' COMMENT '是否为班长0否，1是',
  `isopen` tinyint(1) NOT NULL DEFAULT '1' COMMENT 'keep_Ls考勤开关1开2关',
  `xzf_datastatus` tinyint(1) DEFAULT '1',
  `xzf_needsync` tinyint(1) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_wx_school_tcourse` (
  ...
  `tea_getcash` tinyint(1) unsigned NOT NULL DEFAULT '2' COMMENT '1启用老师提现2否',
  ...
  `coupon` tinyint(1) NOT NULL DEFAULT '1' COMMENT '优惠券0开1关',
  `redpacket` tinyint(1) NOT NULL DEFAULT '1' COMMENT '红包0开1关',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `ims_wx_school_teachers` (
  ...
  `lxvis` tinyint(1) NOT NULL DEFAULT '0' COMMENT '受访老师1开启0关闭',
  `lxdoorman` tinyint(1) NOT NULL DEFAULT '0' COMMENT '门卫1开启0关闭',
  ...
  `xzf_datastatus` tinyint(1) DEFAULT '1',
  `xzf_needsync` tinyint(1) DEFAULT '1',
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `ims_wx_school_template_library` (
  ...
  `type` tinyint(1) NOT NULL,
  `content` longtext NOT NULL,
  `thumb` varchar(1000) NOT NULL DEFAULT '' COMMENT '封面',
  `description` text NOT NULL,
  `ssort` int(11) NOT NULL,
  `status` tinyint(1) NOT NULL DEFAULT '1',
  `createtime` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ims_wx_school_user` (
  ...
  `is_allow_video` tinyint(1) DEFAULT '1' COMMENT '1不允许2允许',
  `createtime` int(10) unsigned NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `ims_wx_school_wxpay` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `kujx` varchar(30) NOT NULL DEFAULT '0' COMMENT '订单ID',
  `weid` int(10) unsigned NOT NULL,
  `schoolid` int(10) unsigned NOT NULL COMMENT '学校ID',
...
if(!pdo_fieldexists("wx_school_allcamera", "is_pay")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_allcamera")." ADD `is_pay` tinyint(1) NOT NULL DEFAULT '2' COMMENT '单独付费与否';");
}
...
if(!pdo_fieldexists("wx_school_allcamera", "days")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_allcamera")." ADD `days` int(11) unsigned DEFAULT '10';");
}
if(!pdo_fieldexists("wx_school_allcamera", "is_try")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_allcamera")." ADD `is_try` tinyint(1) NOT NULL DEFAULT '1' COMMENT '是否允许试看';");
}
if(!pdo_fieldexists("wx_school_allcamera", "try_time")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_allcamera")." ADD `try_time` int(11) unsigned DEFAULT '30' COMMENT '试看时间';");
}
if(!pdo_fieldexists("wx_school_allcamera", "payweid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_allcamera")." ADD `payweid` int(11) unsigned COMMENT '收款公众号';");
}
if(!pdo_fieldexists("wx_school_allcamera", "ios_playtype")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_allcamera")." ADD `ios_playtype` tinyint(1) NOT NULL DEFAULT '1' COMMENT '1播放器2原生';");
}
if(!pdo_fieldexists("wx_school_allcamera", "android_playtype")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_allcamera")." ADD `android_playtype` tinyint(1) NOT NULL DEFAULT '1' COMMENT '1播放器2原生';");
}
...
if(!pdo_fieldexists("wx_school_allcamera", "ispx")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_allcamera")." ADD `ispx` tinyint(1) NOT NULL DEFAULT '0';");
}
...
if(!pdo_fieldexists("wx_school_app", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_app")." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("wx_school_app", "weid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_app")." ADD `weid` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_app", "schoolid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_app")." ADD `schoolid` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_app", "bigdata")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_app")." ADD `bigdata` tinyint(1) unsigned NOT NULL DEFAULT '0';");
}
if(!pdo_fieldexists("wx_school_app", "tuiguang")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_app")." ADD `tuiguang` tinyint(1) unsigned NOT NULL DEFAULT '0';");
}
if(!pdo_fieldexists("wx_school_app", "tuan")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_app")." ADD `tuan` tinyint(1) unsigned NOT NULL DEFAULT '0';");
}
if(!pdo_fieldexists("wx_school_app", "zhuli")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_app")." ADD `zhuli` tinyint(1) unsigned NOT NULL DEFAULT '0';");
}
if(!pdo_fieldexists("wx_school_app", "status")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_app")." ADD `status` tinyint(1) unsigned NOT NULL DEFAULT '0';");
}
if(!pdo_fieldexists("wx_school_app", "createtime")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_app")." ADD `createtime` int(10) unsigned NOT NULL;");
}
...
if(!pdo_fieldexists("wx_school_articledz", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_articledz")." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("wx_school_articledz", "weid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_articledz")." ADD `weid` int(10) unsigned NOT NULL COMMENT '公众号ID';");
}
if(!pdo_fieldexists("wx_school_articledz", "schoolid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_articledz")." ADD `schoolid` int(10) unsigned NOT NULL COMMENT '学校ID';");
}
...
if(!pdo_fieldexists("wx_school_articledz", "status")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_articledz")." ADD `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '点赞状态1点赞2取消';");
}
if(!pdo_fieldexists("wx_school_articledz", "createtime")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_articledz")." ADD `createtime` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_articlepl", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_articlepl")." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("wx_school_articlepl", "weid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_articlepl")." ADD `weid` int(10) unsigned NOT NULL COMMENT '公众号ID';");
}
if(!pdo_fieldexists("wx_school_articlepl", "schoolid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_articlepl")." ADD `schoolid` int(10) unsigned NOT NULL COMMENT '学校ID';");
}
...
if(!pdo_fieldexists("wx_school_articlepl", "status")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_articlepl")." ADD `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '评论是否显示1显示，2隐藏';");
}
if(!pdo_fieldexists("wx_school_articlepl", "createtime")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_articlepl")." ADD `createtime` int(10) unsigned NOT NULL;");
}
...
if(!pdo_fieldexists("wx_school_banners", "thumb")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_banners")." ADD `thumb` varchar(5000) NOT NULL DEFAULT '';");
}
...
if(!pdo_fieldexists("wx_school_banners", "click")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_banners")." ADD `click` varchar(1000) DEFAULT '' COMMENT '点击量';");
}
...
if(!pdo_fieldexists("wx_school_bjq", "wp")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_bjq")." ADD `wp` varchar(30) NOT NULL DEFAULT '0';");
}
...
if(!pdo_fieldexists("wx_school_bjq", "ali_vod_id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_bjq")." ADD `ali_vod_id` varchar(100) DEFAULT '';");
}
...
if(!pdo_fieldexists("wx_school_busgps", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_busgps")." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("wx_school_busgps", "weid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_busgps")." ADD `weid` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_busgps", "schoolid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_busgps")." ADD `schoolid` int(10) unsigned NOT NULL;");
}
...
if(!pdo_fieldexists("wx_school_busgps", "lat")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_busgps")." ADD `lat` decimal(18,10) NOT NULL DEFAULT '0.0000000000' COMMENT '经度';");
}
if(!pdo_fieldexists("wx_school_busgps", "lon")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_busgps")." ADD `lon` decimal(18,10) NOT NULL DEFAULT '0.0000000000' COMMENT '纬度';");
}
if(!pdo_fieldexists("wx_school_busgps", "type")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_busgps")." ADD `type` tinyint(1) unsigned NOT NULL DEFAULT '0';");
}
if(!pdo_fieldexists("wx_school_busgps", "createtime")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_busgps")." ADD `createtime` int(10) unsigned NOT NULL;");
}
...
if(!pdo_fieldexists("wx_school_byinfo", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_byinfo")." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("wx_school_byinfo", "weid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_byinfo")." ADD `weid` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_byinfo", "schoolid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_byinfo")." ADD `schoolid` int(10) unsigned NOT NULL COMMENT '学校ID';");
}
...
if(!pdo_fieldexists("wx_school_byinfo", "tsigntime")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_byinfo")." ADD `tsigntime` int(10) unsigned NOT NULL COMMENT '老师签字时间';");
}
...
if(!pdo_fieldexists("wx_school_camerask", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_camerask")." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("wx_school_camerask", "weid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_camerask")." ADD `weid` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_camerask", "schoolid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_camerask")." ADD `schoolid` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_camerask", "carmeraid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_camerask")." ADD `carmeraid` int(10) unsigned NOT NULL COMMENT '画面ID';");
}
if(!pdo_fieldexists("wx_school_camerask", "userid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_camerask")." ADD `userid` int(10) unsigned NOT NULL COMMENT '用户ID';");
}
if(!pdo_fieldexists("wx_school_camerask", "type")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_camerask")." ADD `type` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '1视频试看';");
}
if(!pdo_fieldexists("wx_school_camerask", "createtime")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_camerask")." ADD `createtime` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_changbjlog", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_changbjlog")." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_checklog", "surestatus")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_checklog")." ADD `surestatus` tinyint(1) NOT NULL DEFAULT '0';");
}
...
if(!pdo_fieldexists("wx_school_checklog", "note_way")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_checklog")." ADD `note_way` tinyint(1) NOT NULL DEFAULT '1';");
}
if(!pdo_fieldexists("wx_school_checklog", "note_pass")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_checklog")." ADD `note_pass` tinyint(1) NOT NULL DEFAULT '1';");
}
...
if(!pdo_fieldexists("wx_school_checkmac", "macset")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_checkmac")." ADD `macset` varchar(2000) DEFAULT '';");
}
...
if(!pdo_fieldexists("wx_school_checkmac", "cardtype")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_checkmac")." ADD `cardtype` tinyint(1) unsigned NOT NULL DEFAULT '2' COMMENT '1IC2ID';");
}
...
if(!pdo_fieldexists("wx_school_checkmac", "is_bobao")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_checkmac")." ADD `is_bobao` tinyint(1) NOT NULL DEFAULT '1' COMMENT '播报';");
}
if(!pdo_fieldexists("wx_school_checkmac", "is_master")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_checkmac")." ADD `is_master` tinyint(1) NOT NULL DEFAULT '1' COMMENT '是否全校';");
}
if(!pdo_fieldexists("wx_school_checkmac", "bj_id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_checkmac")." ADD `bj_id` int(10) unsigned COMMENT '绑定班级ID';");
}
if(!pdo_fieldexists("wx_school_checkmac", "js_id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_checkmac")." ADD `js_id` int(10) unsigned COMMENT '教室ID';");
}
...
if(!pdo_fieldexists("wx_school_checkmac", "is_video")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_checkmac")." ADD `is_video` tinyint(1) NOT NULL DEFAULT '1' COMMENT '1关2开';");
}
...
if(!pdo_fieldexists("wx_school_classcard_activity", "cate")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_activity")." ADD `cate` tinyint(4) NOT NULL DEFAULT '1' COMMENT '1报名活动2投票活动';");
}
...
if(!pdo_fieldexists("wx_school_classcard_checklog", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_checklog")." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("wx_school_classcard_checklog", "weid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_checklog")." ADD `weid` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_classcard_checklog", "schoolid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_checklog")." ADD `schoolid` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_classcard_checklog", "macid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_checklog")." ADD `macid` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_classcard_checklog", "cardid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_checklog")." ADD `cardid` varchar(200) NOT NULL DEFAULT '' COMMENT '卡号';");
}
if(!pdo_fieldexists("wx_school_classcard_checklog", "sid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_checklog")." ADD `sid` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_classcard_checklog", "tid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_checklog")." ADD `tid` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_classcard_checklog", "bj_id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_checklog")." ADD `bj_id` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_classcard_checklog", "lat")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_checklog")." ADD `lat` decimal(18,10) NOT NULL DEFAULT '0.0000000000' COMMENT '经度';");
}
if(!pdo_fieldexists("wx_school_classcard_checklog", "lon")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_checklog")." ADD `lon` decimal(18,10) NOT NULL DEFAULT '0.0000000000' COMMENT '纬度';");
}
if(!pdo_fieldexists("wx_school_classcard_checklog", "temperature")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_checklog")." ADD `temperature` varchar(10) DEFAULT '';");
}
if(!pdo_fieldexists("wx_school_classcard_checklog", "pic")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_checklog")." ADD `pic` varchar(255) DEFAULT '' COMMENT '图片';");
}
if(!pdo_fieldexists("wx_school_classcard_checklog", "type")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_checklog")." ADD `type` varchar(50) DEFAULT '' COMMENT '进校类型';");
}
if(!pdo_fieldexists("wx_school_classcard_checklog", "leixing")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_checklog")." ADD `leixing` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '1进校2离校3迟到4早退';");
}
if(!pdo_fieldexists("wx_school_classcard_checklog", "pard")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_checklog")." ADD `pard` tinyint(2) unsigned NOT NULL DEFAULT '0' COMMENT '1本人2母亲3父亲4爷爷5奶奶6外公7外婆8叔叔9阿姨10其他11老师';");
}
if(!pdo_fieldexists("wx_school_classcard_checklog", "createtime")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_checklog")." ADD `createtime` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_classcard_checklog", "isread")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_checklog")." ADD `isread` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '1已读2未读';");
}
if(!pdo_fieldexists("wx_school_classcard_checklog", "checktype")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_checklog")." ADD `checktype` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '1刷卡2微信';");
}
if(!pdo_fieldexists("wx_school_classcard_checklog", "isconfirm")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_checklog")." ADD `isconfirm` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '1确认2拒绝';");
}
...
if(!pdo_fieldexists("wx_school_classcard_checklog", "pic2")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_checklog")." ADD `pic2` varchar(255) DEFAULT '' COMMENT '图片2';");
}
...
if(!pdo_fieldexists("wx_school_classcard_duty", "schoolid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_duty")." ADD `schoolid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '分校id';");
}
if(!pdo_fieldexists("wx_school_classcard_duty", "weid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_duty")." ADD `weid` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_classcard_duty", "bj_id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_duty")." ADD `bj_id` int(10) unsigned NOT NULL;");
}
...
if(!pdo_fieldexists("wx_school_classcard_epaper", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_epaper")." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("wx_school_classcard_epaper", "weid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_epaper")." ADD `weid` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_classcard_epaper", "schoolid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_epaper")." ADD `schoolid` int(10) unsigned NOT NULL;");
}
...
if(!pdo_fieldexists("wx_school_classcard_epaper", "createtime")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_epaper")." ADD `createtime` int(10) unsigned NOT NULL;");
}
...
if(!pdo_fieldexists("wx_school_classcard_honour", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_honour")." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("wx_school_classcard_honour", "weid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_honour")." ADD `weid` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_classcard_honour", "schoolid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_honour")." ADD `schoolid` int(10) unsigned NOT NULL;");
}
...
if(!pdo_fieldexists("wx_school_classcard_honour", "createtime")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_honour")." ADD `createtime` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_classcard_kouhao", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_kouhao")." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("wx_school_classcard_kouhao", "weid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_kouhao")." ADD `weid` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_classcard_kouhao", "schoolid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_kouhao")." ADD `schoolid` int(10) unsigned NOT NULL;");
}
...
if(!pdo_fieldexists("wx_school_classcard_kouhao", "createtime")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_kouhao")." ADD `createtime` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_classcard_mac", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_mac")." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("wx_school_classcard_mac", "weid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_mac")." ADD `weid` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_classcard_mac", "schoolid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_mac")." ADD `schoolid` int(10) unsigned NOT NULL;");
}
...
if(!pdo_fieldexists("wx_school_classcard_mac", "macid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_mac")." ADD `macid` varchar(200) NOT NULL DEFAULT '' COMMENT '设备编号';");
}
if(!pdo_fieldexists("wx_school_classcard_mac", "banner")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_mac")." ADD `banner` varchar(2000) DEFAULT '';");
}
...
if(!pdo_fieldexists("wx_school_classcard_mac", "macset")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_mac")." ADD `macset` varchar(2000) DEFAULT '';");
}
if(!pdo_fieldexists("wx_school_classcard_mac", "is_on")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_mac")." ADD `is_on` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '1启用2不启用';");
}
if(!pdo_fieldexists("wx_school_classcard_mac", "createtime")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_mac")." ADD `createtime` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_classcard_mac", "type")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_mac")." ADD `type` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '1进校2离校';");
}
if(!pdo_fieldexists("wx_school_classcard_mac", "twmac")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_mac")." ADD `twmac` varchar(200) NOT NULL DEFAULT '-1';");
}
if(!pdo_fieldexists("wx_school_classcard_mac", "cardtype")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_mac")." ADD `cardtype` tinyint(1) unsigned NOT NULL DEFAULT '2' COMMENT '1IC2ID';");
}
if(!pdo_fieldexists("wx_school_classcard_mac", "bj_id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_mac")." ADD `bj_id` int(10) unsigned NOT NULL COMMENT '班级id';");
}
if(!pdo_fieldexists("wx_school_classcard_mac", "is_master")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_mac")." ADD `is_master` tinyint(3) unsigned NOT NULL COMMENT '是否全校播报';");
}
if(!pdo_fieldexists("wx_school_classcard_mac", "is_bobao")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_mac")." ADD `is_bobao` tinyint(1) NOT NULL DEFAULT '1' COMMENT '播报';");
}
if(!pdo_fieldexists("wx_school_classcard_mac", "js_id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_mac")." ADD `js_id` int(10) unsigned COMMENT '教室ID';");
}
...
if(!pdo_fieldexists("wx_school_classcard_praise", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_praise")." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("wx_school_classcard_praise", "weid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_praise")." ADD `weid` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_classcard_praise", "schoolid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_praise")." ADD `schoolid` int(10) unsigned NOT NULL;");
}
...
if(!pdo_fieldexists("wx_school_classcard_praise", "createtime")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_praise")." ADD `createtime` int(10) unsigned NOT NULL;");
}
...
if(!pdo_fieldexists("wx_school_classcard_praise_comment", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_praise_comment")." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("wx_school_classcard_praise_comment", "weid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_praise_comment")." ADD `weid` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_classcard_praise_comment", "schoolid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_praise_comment")." ADD `schoolid` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_classcard_praise_comment", "bj_id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_praise_comment")." ADD `bj_id` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_classcard_praise_comment", "tid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_praise_comment")." ADD `tid` int(10) unsigned NOT NULL;");
}
...
if(!pdo_fieldexists("wx_school_classcard_praise_comment", "createtime")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_praise_comment")." ADD `createtime` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_classcard_praise_comment", "ssort")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_praise_comment")." ADD `ssort` int(10) unsigned NOT NULL COMMENT '排序';");
}
if(!pdo_fieldexists("wx_school_classcard_praise_type", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_praise_type")." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("wx_school_classcard_praise_type", "weid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_praise_type")." ADD `weid` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_classcard_praise_type", "schoolid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_praise_type")." ADD `schoolid` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_classcard_praise_type", "tid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_praise_type")." ADD `tid` int(10) unsigned NOT NULL;");
}
...
if(!pdo_fieldexists("wx_school_classcard_praise_type", "createtime")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_praise_type")." ADD `createtime` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_classcard_set", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_set")." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("wx_school_classcard_set", "weid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_set")." ADD `weid` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_classcard_set", "schoolid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_set")." ADD `schoolid` int(10) unsigned NOT NULL;");
}
...
if(!pdo_fieldexists("wx_school_classcard_set", "createtime")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_set")." ADD `createtime` int(10) unsigned NOT NULL;");
}
...
if(!pdo_fieldexists("wx_school_classcard_temperature_log", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_temperature_log")." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("wx_school_classcard_temperature_log", "weid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_temperature_log")." ADD `weid` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_classcard_temperature_log", "schoolid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_temperature_log")." ADD `schoolid` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_classcard_temperature_log", "macid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_temperature_log")." ADD `macid` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_classcard_temperature_log", "cardid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_temperature_log")." ADD `cardid` varchar(200) NOT NULL DEFAULT '' COMMENT '卡号';");
}
if(!pdo_fieldexists("wx_school_classcard_temperature_log", "sid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_temperature_log")." ADD `sid` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_classcard_temperature_log", "bj_id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classcard_temperature_log")." ADD `bj_id` int(10) unsigned NOT NULL;");
}
...
if(!pdo_fieldexists("wx_school_classify", "qun")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classify")." ADD `qun` varchar(200) NOT NULL DEFAULT '' COMMENT 'QQ群链接';");
}
...
if(!pdo_fieldexists("wx_school_classify", "is_over")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classify")." ADD `is_over` tinyint(1) NOT NULL DEFAULT '1';");
}
if(!pdo_fieldexists("wx_school_classify", "start")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classify")." ADD `start` varchar(1000) DEFAULT '' COMMENT '班级之星';");
}
if(!pdo_fieldexists("wx_school_classify", "star")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classify")." ADD `star` varchar(1000) DEFAULT '' COMMENT '班级之星';");
}
if(!pdo_fieldexists("wx_school_classify", "qh_bjlist")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classify")." ADD `qh_bjlist` varchar(1000) DEFAULT '' COMMENT '期号对应班级';");
}
...
if(!pdo_fieldexists("wx_school_classify", "qhtype")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classify")." ADD `qhtype` tinyint(1) NOT NULL DEFAULT '1';");
}
if(!pdo_fieldexists("wx_school_classify", "is_bjzx")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classify")." ADD `is_bjzx` tinyint(1) NOT NULL DEFAULT '1' COMMENT '班级之星';");
}
...
if(!pdo_fieldexists("wx_school_classify", "is_print")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classify")." ADD `is_print` tinyint(1) NOT NULL DEFAULT '2' COMMENT '是否启用打印机';");
}
if(!pdo_fieldexists("wx_school_classify", "printarr")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classify")." ADD `printarr` varchar(100) NOT NULL DEFAULT '' COMMENT '打印机';");
}
...
if(!pdo_fieldexists("wx_school_classify", "is_show_qh")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classify")." ADD `is_show_qh` tinyint(1) NOT NULL DEFAULT '1' COMMENT '是否显示期号0否，1是';");
}
if(!pdo_fieldexists("wx_school_classify", "is_upload")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classify")." ADD `is_upload` tinyint(1) NOT NULL DEFAULT '1' COMMENT '相册分类是否允许上传1是0否';");
}
if(!pdo_fieldexists("wx_school_classify", "bjid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classify")." ADD `bjid` int(10) NOT NULL DEFAULT '1' COMMENT '对应的班级id';");
}
...
if(!pdo_fieldexists("wx_school_classify", "phototype")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classify")." ADD `phototype` tinyint(1) NOT NULL DEFAULT '2' COMMENT '相册类型2班级1个人';");
}
if(!pdo_fieldexists("wx_school_classify", "is_show")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classify")." ADD `is_show` tinyint(1) NOT NULL DEFAULT '1' COMMENT '是否显示通讯录及群发通知，0不显示，1显示';");
}
if(!pdo_fieldexists("wx_school_classify", "xzf_datastatus")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classify")." ADD `xzf_datastatus` tinyint(1) DEFAULT '1' COMMENT '1新增2更新';");
}
if(!pdo_fieldexists("wx_school_classify", "xzf_needsync")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classify")." ADD `xzf_needsync` tinyint(1) DEFAULT '0';");
}
...
if(!pdo_fieldexists("wx_school_classify", "bjrate")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classify")." ADD `bjrate` decimal(5,2) NOT NULL DEFAULT '1.00' COMMENT '班级倍率';");
}
if(!pdo_fieldexists("wx_school_classify", "bzrrate")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classify")." ADD `bzrrate` decimal(5,2) NOT NULL DEFAULT '1.00' COMMENT '班主任倍率';");
}
...
if(!pdo_fieldexists("wx_school_cost", "is_print")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_cost")." ADD `is_print` tinyint(1) NOT NULL DEFAULT '2' COMMENT '是否启用打印机';");
}
if(!pdo_fieldexists("wx_school_cost", "printarr")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_cost")." ADD `printarr` varchar(100) NOT NULL DEFAULT '' COMMENT '打印机';");
}
if(!pdo_fieldexists("wx_school_cost", "serverend")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_cost")." ADD `serverend` char(10) NOT NULL DEFAULT '0' COMMENT '考勤卡服务到期时间';");
}
...
if(!pdo_fieldexists("wx_school_coursebuy", "bjid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_coursebuy")." ADD `bjid` int(11) NOT NULL DEFAULT '0' COMMENT '培训学校使用';");
}
...
if(!pdo_fieldexists("wx_school_ddscorecategory", "addition")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_ddscorecategory")." ADD `addition` tinyint(1) NOT NULL DEFAULT '1';");
}
if(!pdo_fieldexists("wx_school_ddscorecategory", "type")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_ddscorecategory")." ADD `type` tinyint(1) NOT NULL DEFAULT '1';");
}
...
if(!pdo_fieldexists("wx_school_ddscorecategory", "isspecial")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_ddscorecategory")." ADD `isspecial` tinyint(1) NOT NULL DEFAULT '0';");
}
...
if(!pdo_fieldexists("wx_school_ddscorecategory", "ssort")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_ddscorecategory")." ADD `ssort` int(10) DEFAULT '0';");
}
...
if(!pdo_fieldexists("wx_school_ddscorelog", "score")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_ddscorelog")." ADD `score` varchar(10) NOT NULL DEFAULT '1';");
}
if(!pdo_fieldexists("wx_school_ddscorelog", "createtime")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_ddscorelog")." ADD `createtime` int(11) NOT NULL DEFAULT '1';");
}
...
if(!pdo_fieldexists("wx_school_ddscorelog", "tid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_ddscorelog")." ADD `tid` int(11) NOT NULL DEFAULT '0';");
}
...
if(!pdo_fieldexists("wx_school_dianzan", "kujx")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_dianzan")." ADD `kujx` varchar(30) NOT NULL DEFAULT '0' COMMENT '图片路径';");
}
if(!pdo_fieldexists("wx_school_dianzan", "userid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_dianzan")." ADD `userid` int(10) unsigned COMMENT 'userid';");
}
if(!pdo_fieldexists("wx_school_drug", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_drug")." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("wx_school_drug", "weid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_drug")." ADD `weid` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_drug", "schoolid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_drug")." ADD `schoolid` int(10) unsigned NOT NULL COMMENT '学校ID';");
}
...
if(!pdo_fieldexists("wx_school_druglog", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_druglog")." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("wx_school_druglog", "weid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_druglog")." ADD `weid` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_druglog", "schoolid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_druglog")." ADD `schoolid` int(10) unsigned NOT NULL COMMENT '学校ID';");
}
...
if(!pdo_fieldexists("wx_school_freekslog", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_freekslog")." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_getcash", "paytype")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_getcash")." ADD `paytype` tinyint(1) NOT NULL DEFAULT '0' COMMENT '1微信支付2现金付费3其他方式';");
}
...
if(!pdo_fieldexists("wx_school_getcash", "approval")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_getcash")." ADD `approval` tinyint(1) NOT NULL DEFAULT '0' COMMENT '1未审核2审核';");
}
if(!pdo_fieldexists("wx_school_getcash", "shtid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_getcash")." ADD `shtid` varchar(50) NOT NULL DEFAULT '0' COMMENT '审核人';");
}
...
if(!pdo_fieldexists("wx_school_getcash", "paytid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_getcash")." ADD `paytid` varchar(50) NOT NULL DEFAULT '0' COMMENT '付款操作人';");
}
...
if(!pdo_fieldexists("wx_school_getcash", "status")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_getcash")." ADD `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '1未付2已付';");
}
...
if(!pdo_fieldexists("wx_school_getcash_order", "status")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_getcash_order")." ADD `status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '1未结2已付';");
}
...
if(!pdo_fieldexists("wx_school_getcash_order", "kdid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_getcash_order")." ADD `kdid` int(10) DEFAULT '0';");
}
...
if(!pdo_fieldexists("wx_school_glkebiao", "is_send")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_glkebiao")." ADD `is_send` tinyint(1) NOT NULL DEFAULT '0';");
}
...
if(!pdo_fieldexists("wx_school_growuppage", "isok")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_growuppage")." ADD `isok` tinyint(1) NOT NULL DEFAULT '0';");
}
if(!pdo_fieldexists("wx_school_growuppage", "isallok")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_growuppage")." ADD `isallok` tinyint(1) NOT NULL DEFAULT '0';");
}
if(!pdo_fieldexists("wx_school_growuppage", "is_send")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_growuppage")." ADD `is_send` tinyint(1) NOT NULL DEFAULT '0';");
}
if(!pdo_fieldexists("wx_school_growuppage", "is_ok_stu")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_growuppage")." ADD `is_ok_stu` tinyint(1) NOT NULL DEFAULT '0' COMMENT '学生是否完成';");
}
...
if(!pdo_fieldexists("wx_school_guige", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_guige")." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_guige", "price")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_guige")." ADD `price` decimal(18,2) NOT NULL DEFAULT '0.00';");
}
...
if(!pdo_fieldexists("wx_school_helps", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_helps")." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_helps", "createtime")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_helps")." ADD `createtime` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_helps", "lasttime")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_helps")." ADD `lasttime` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_helps", "click")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_helps")." ADD `click` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_helps", "is_share")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_helps")." ADD `is_share` tinyint(1) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_helps", "share_id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_helps")." ADD `share_id` tinyint(1) unsigned NOT NULL;");
}
...
if(!pdo_fieldexists("wx_school_helps", "displayorder")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_helps")." ADD `displayorder` int(10) unsigned NOT NULL;");
}
...
if(!pdo_fieldexists("wx_school_icon", "typeid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_icon")." ADD `typeid` int(10) unsigned NOT NULL COMMENT 'icon分类ID';");
}
if(!pdo_fieldexists("wx_school_icontype", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_icontype")." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("wx_school_icontype", "weid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_icontype")." ADD `weid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '公众号';");
}
if(!pdo_fieldexists("wx_school_icontype", "schoolid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_icontype")." ADD `schoolid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '分校id';");
}
...
if(!pdo_fieldexists("wx_school_icontype", "place")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_icontype")." ADD `place` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '位置';");
}
if(!pdo_fieldexists("wx_school_icontype", "ssort")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_icontype")." ADD `ssort` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '排序';");
}
if(!pdo_fieldexists("wx_school_icontype", "status")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_icontype")." ADD `status` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '显示状态';");
}
...
if(!pdo_fieldexists("wx_school_idcard", "cardtype")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_idcard")." ADD `cardtype` tinyint(1) NOT NULL DEFAULT '1';");
}
...
if(!pdo_fieldexists("wx_school_index", "logo")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_index")." ADD `logo` varchar(1000) NOT NULL DEFAULT '' COMMENT '学校logo';");
}
...
if(!pdo_fieldexists("wx_school_index", "copyright")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_index")." ADD `copyright` varchar(100) NOT NULL DEFAULT '' COMMENT '版权';");
}
if(!pdo_fieldexists("wx_school_index", "is_stuewcode")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_index")." ADD `is_stuewcode` tinyint(1) NOT NULL DEFAULT '1' COMMENT '1开启2关闭';");
}
...
if(!pdo_fieldexists("wx_school_index", "is_showew")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_index")." ADD `is_showew` tinyint(1) NOT NULL DEFAULT '1' COMMENT '页面显示二维码开关';");
}
if(!pdo_fieldexists("wx_school_index", "is_showad")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_index")." ADD `is_showad` int(10) NOT NULL DEFAULT '0' COMMENT '是否显示广告';");
}
...
if(!pdo_fieldexists("wx_school_index", "is_zjh")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_index")." ADD `is_zjh` tinyint(1) NOT NULL DEFAULT '1' COMMENT '1启用2不启用周计划';");
}
...
if(!pdo_fieldexists("wx_school_index", "manger")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_index")." ADD `manger` varchar(200) NOT NULL DEFAULT '' COMMENT '模版名称1';");
}
if(!pdo_fieldexists("wx_school_index", "isopen")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_index")." ADD `isopen` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0显示1不';");
}
...
if(!pdo_fieldexists("wx_school_index", "userstyle")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_index")." ADD `userstyle` varchar(50) NOT NULL DEFAULT '' COMMENT '家长学生中心模板';");
}
...
if(!pdo_fieldexists("wx_school_index", "headcolor")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_index")." ADD `headcolor` varchar(20) NOT NULL DEFAULT '#06c1ae' COMMENT '头部颜色';");
}
if(!pdo_fieldexists("wx_school_index", "savevideoto")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_index")." ADD `savevideoto` tinyint(1) NOT NULL DEFAULT '1';");
}
...
if(!pdo_fieldexists("wx_school_index", "is_shoufei")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_index")." ADD `is_shoufei` int(3) NOT NULL DEFAULT '1';");
}
...
if(!pdo_fieldexists("wx_school_index", "is_qx")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_index")." ADD `is_qx` int(3) NOT NULL DEFAULT '1';");
}
...
if(!pdo_fieldexists("wx_school_index", "is_printer")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_index")." ADD `is_printer` tinyint(1) NOT NULL DEFAULT '1' COMMENT '是否启用打印机';");
}
...
if(!pdo_fieldexists("wx_school_index", "is_online")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_index")." ADD `is_online` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否在线教程0否，1是';");
}
if(!pdo_fieldexists("wx_school_kc_formal_log", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_formal_log")." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("wx_school_kc_formal_log", "weid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_formal_log")." ADD `weid` int(10) unsigned NOT NULL COMMENT '公众号ID';");
}
if(!pdo_fieldexists("wx_school_kc_formal_log", "schoolid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_formal_log")." ADD `schoolid` int(10) unsigned NOT NULL COMMENT '学校ID';");
}
if(!pdo_fieldexists("wx_school_kc_formal_log", "kcid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_formal_log")." ADD `kcid` int(10) unsigned NOT NULL COMMENT '来源kcid';");
}
if(!pdo_fieldexists("wx_school_kc_formal_log", "tokcid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_formal_log")." ADD `tokcid` int(10) unsigned NOT NULL COMMENT '转正到kcid';");
}
if(!pdo_fieldexists("wx_school_kc_formal_log", "sid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_formal_log")." ADD `sid` int(10) unsigned NOT NULL COMMENT 'sid';");
}
if(!pdo_fieldexists("wx_school_kc_formal_log", "tid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_formal_log")." ADD `tid` int(10) unsigned NOT NULL COMMENT '申请操作人';");
}
if(!pdo_fieldexists("wx_school_kc_formal_log", "shtid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_formal_log")." ADD `shtid` int(10) unsigned NOT NULL COMMENT '审核人';");
}
if(!pdo_fieldexists("wx_school_kc_formal_log", "status")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_formal_log")." ADD `status` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '0未审核1通过2拒绝';");
}
if(!pdo_fieldexists("wx_school_kc_formal_log", "createtime")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_formal_log")." ADD `createtime` int(10) unsigned NOT NULL COMMENT '创建时间';");
}
...
if(!pdo_fieldexists("wx_school_kc_getcashrule", "is_needsh")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_getcashrule")." ADD `is_needsh` tinyint(1) NOT NULL DEFAULT '0' COMMENT '1需要审核,2否';");
}
...
if(!pdo_fieldexists("wx_school_kc_menu", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_menu")." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("wx_school_kc_menu", "weid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_menu")." ADD `weid` int(10) unsigned NOT NULL COMMENT '公众号ID';");
}
if(!pdo_fieldexists("wx_school_kc_menu", "schoolid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_menu")." ADD `schoolid` int(10) unsigned NOT NULL COMMENT '学校ID';");
}
if(!pdo_fieldexists("wx_school_kc_menu", "kcid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_menu")." ADD `kcid` int(10) unsigned NOT NULL COMMENT '归属课程ID';");
}
...
if(!pdo_fieldexists("wx_school_kc_menu", "createtime")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_menu")." ADD `createtime` int(10) unsigned NOT NULL COMMENT '创建时间';");
}
if(!pdo_fieldexists("wx_school_kc_promote", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_promote")." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("wx_school_kc_promote", "weid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_promote")." ADD `weid` int(10) unsigned NOT NULL COMMENT '公众号ID';");
}
if(!pdo_fieldexists("wx_school_kc_promote", "schoolid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_promote")." ADD `schoolid` int(10) unsigned NOT NULL COMMENT '学校ID';");
}
if(!pdo_fieldexists("wx_school_kc_promote", "kcid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_promote")." ADD `kcid` int(10) unsigned NOT NULL COMMENT '归属课程ID';");
}
...
if(!pdo_fieldexists("wx_school_kc_promote", "price")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_promote")." ADD `price` decimal(18,2) NOT NULL DEFAULT '0.00' COMMENT '优惠格';");
}
if(!pdo_fieldexists("wx_school_kc_promote", "use_pop")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_promote")." ADD `use_pop` tinyint(1) unsigned NOT NULL DEFAULT '2' COMMENT '1启用海报2禁止';");
}
if(!pdo_fieldexists("wx_school_kc_promote", "pop_id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_promote")." ADD `pop_id` int(10) unsigned NOT NULL COMMENT '海报风格ID';");
}
...
if(!pdo_fieldexists("wx_school_kc_promote", "allow_normal")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_promote")." ADD `allow_normal` tinyint(1) unsigned NOT NULL DEFAULT '2' COMMENT '1允许普通粉丝推广2禁止';");
}
if(!pdo_fieldexists("wx_school_kc_promote", "show_ranking")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_promote")." ADD `show_ranking` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '1推广员端排名2禁止';");
}
if(!pdo_fieldexists("wx_school_kc_promote", "tg_number")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_promote")." ADD `tg_number` int(10) unsigned NOT NULL COMMENT '试听任务人数';");
}
if(!pdo_fieldexists("wx_school_kc_promote", "is_royalty")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_promote")." ADD `is_royalty` tinyint(1) unsigned NOT NULL DEFAULT '2' COMMENT '1提成2否';");
}
if(!pdo_fieldexists("wx_school_kc_promote", "need_done")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_promote")." ADD `need_done` tinyint(1) unsigned NOT NULL DEFAULT '2' COMMENT '1需完成2否';");
}
if(!pdo_fieldexists("wx_school_kc_promote", "royalty")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_promote")." ADD `royalty` decimal(18,2) NOT NULL DEFAULT '0.00' COMMENT '提成';");
}
if(!pdo_fieldexists("wx_school_kc_promote", "xg_royalty")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_promote")." ADD `xg_royalty` decimal(18,2) NOT NULL DEFAULT '0.00' COMMENT '续购提成';");
}
if(!pdo_fieldexists("wx_school_kc_promote", "mobile_sign")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_promote")." ADD `mobile_sign` tinyint(1) unsigned NOT NULL DEFAULT '2' COMMENT '1前端分配2否';");
}
if(!pdo_fieldexists("wx_school_kc_promote", "mobile_sign_fp")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_promote")." ADD `mobile_sign_fp` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '1随机2顺序';");
}
if(!pdo_fieldexists("wx_school_kc_promote", "count_menber")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_promote")." ADD `count_menber` int(10) unsigned NOT NULL COMMENT '达标人数';");
}
if(!pdo_fieldexists("wx_school_kc_promote", "type")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_promote")." ADD `type` tinyint(1) unsigned NOT NULL COMMENT '1推广';");
}
if(!pdo_fieldexists("wx_school_kc_promote", "createtime")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_promote")." ADD `createtime` int(10) unsigned NOT NULL COMMENT '创建时间';");
}
if(!pdo_fieldexists("wx_school_kc_saleset", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_saleset")." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("wx_school_kc_saleset", "weid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_saleset")." ADD `weid` int(10) unsigned NOT NULL COMMENT '公众号ID';");
}
if(!pdo_fieldexists("wx_school_kc_saleset", "schoolid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_saleset")." ADD `schoolid` int(10) unsigned NOT NULL COMMENT '学校ID';");
}
if(!pdo_fieldexists("wx_school_kc_saleset", "kcid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_saleset")." ADD `kcid` int(10) unsigned NOT NULL COMMENT '归属课程ID';");
}
...
if(!pdo_fieldexists("wx_school_kc_saleset", "price")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_saleset")." ADD `price` decimal(18,2) NOT NULL DEFAULT '0.00' COMMENT '优惠格';");
}
if(!pdo_fieldexists("wx_school_kc_saleset", "tuanz_price")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_saleset")." ADD `tuanz_price` decimal(18,2) NOT NULL DEFAULT '0.00' COMMENT '团长优惠';");
}
if(!pdo_fieldexists("wx_school_kc_saleset", "suc_munber")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_saleset")." ADD `suc_munber` int(10) unsigned NOT NULL COMMENT '成功人数';");
}
if(!pdo_fieldexists("wx_school_kc_saleset", "overtimeset")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_saleset")." ADD `overtimeset` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '1按课程结束时间2自定义';");
}
if(!pdo_fieldexists("wx_school_kc_saleset", "overtime")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_saleset")." ADD `overtime` int(10) unsigned NOT NULL COMMENT '结束时间小时';");
}
if(!pdo_fieldexists("wx_school_kc_saleset", "endtime")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_saleset")." ADD `endtime` int(10) unsigned NOT NULL COMMENT '整个活动结束时间';");
}
if(!pdo_fieldexists("wx_school_kc_saleset", "allow_again")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_saleset")." ADD `allow_again` tinyint(1) unsigned NOT NULL DEFAULT '2' COMMENT '1允许继续2禁止';");
}
if(!pdo_fieldexists("wx_school_kc_saleset", "allow_help")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_saleset")." ADD `allow_help` tinyint(1) unsigned NOT NULL DEFAULT '2' COMMENT '1允许虚拟2禁止';");
}
if(!pdo_fieldexists("wx_school_kc_saleset", "use_pop")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_saleset")." ADD `use_pop` tinyint(1) unsigned NOT NULL DEFAULT '2' COMMENT '1启用海报2禁止';");
}
if(!pdo_fieldexists("wx_school_kc_saleset", "pop_id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_saleset")." ADD `pop_id` int(10) unsigned NOT NULL COMMENT '海报风格ID';");
}
...
if(!pdo_fieldexists("wx_school_kc_saleset", "type")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_saleset")." ADD `type` tinyint(1) unsigned NOT NULL COMMENT '1团购2助力';");
}
if(!pdo_fieldexists("wx_school_kc_saleset", "createtime")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_saleset")." ADD `createtime` int(10) unsigned NOT NULL COMMENT '创建时间';");
}
if(!pdo_fieldexists("wx_school_kc_signset", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_signset")." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("wx_school_kc_signset", "weid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_signset")." ADD `weid` int(10) unsigned NOT NULL COMMENT '公众号ID';");
}
if(!pdo_fieldexists("wx_school_kc_signset", "schoolid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_signset")." ADD `schoolid` int(10) unsigned NOT NULL COMMENT '学校ID';");
}
if(!pdo_fieldexists("wx_school_kc_signset", "kcid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_signset")." ADD `kcid` int(10) unsigned NOT NULL COMMENT '归属课程ID';");
}
if(!pdo_fieldexists("wx_school_kc_signset", "tea_sign_confirm")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_signset")." ADD `tea_sign_confirm` tinyint(1) unsigned NOT NULL DEFAULT '2';");
}
if(!pdo_fieldexists("wx_school_kc_signset", "stu_sign_confirm")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_signset")." ADD `stu_sign_confirm` tinyint(1) unsigned NOT NULL DEFAULT '2';");
}
if(!pdo_fieldexists("wx_school_kc_signset", "more_tea_sign")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_signset")." ADD `more_tea_sign` tinyint(1) unsigned NOT NULL DEFAULT '2';");
}
if(!pdo_fieldexists("wx_school_kc_signset", "sh_tea_teacherids")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_signset")." ADD `sh_tea_teacherids` varchar(600) DEFAULT '';");
}
if(!pdo_fieldexists("wx_school_kc_signset", "tea_change_stutype")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_signset")." ADD `tea_change_stutype` tinyint(1) unsigned NOT NULL DEFAULT '2';");
}
if(!pdo_fieldexists("wx_school_kc_signset", "tea_sign_fuke")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_signset")." ADD `tea_sign_fuke` tinyint(1) unsigned NOT NULL DEFAULT '2';");
}
if(!pdo_fieldexists("wx_school_kc_signset", "tea_sign_old")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_signset")." ADD `tea_sign_old` tinyint(1) unsigned NOT NULL DEFAULT '2';");
}
if(!pdo_fieldexists("wx_school_kc_signset", "tea_add_ks")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_signset")." ADD `tea_add_ks` tinyint(1) unsigned NOT NULL DEFAULT '2';");
}
if(!pdo_fieldexists("wx_school_kc_signset", "tea_edit_ks")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_signset")." ADD `tea_edit_ks` tinyint(1) unsigned NOT NULL DEFAULT '2';");
}
if(!pdo_fieldexists("wx_school_kc_signset", "tea_mobile_pk")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_signset")." ADD `tea_mobile_pk` tinyint(1) unsigned NOT NULL DEFAULT '2';");
}
if(!pdo_fieldexists("wx_school_kc_signset", "tea_no_myks")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_signset")." ADD `tea_no_myks` tinyint(1) unsigned NOT NULL DEFAULT '2';");
}
if(!pdo_fieldexists("wx_school_kc_signset", "allow_ksdf")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_signset")." ADD `allow_ksdf` tinyint(1) unsigned NOT NULL DEFAULT '2';");
}
if(!pdo_fieldexists("wx_school_kc_signset", "allow_kspl")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_signset")." ADD `allow_kspl` tinyint(1) unsigned NOT NULL DEFAULT '2';");
}
if(!pdo_fieldexists("wx_school_kc_signset", "allow_shera_pl")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_signset")." ADD `allow_shera_pl` tinyint(1) unsigned NOT NULL DEFAULT '2';");
}
if(!pdo_fieldexists("wx_school_kc_signset", "createtime")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_signset")." ADD `createtime` int(10) unsigned NOT NULL COMMENT '创建时间';");
}
if(!pdo_fieldexists("wx_school_kc_vislog", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_vislog")." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("wx_school_kc_vislog", "weid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_vislog")." ADD `weid` int(10) unsigned NOT NULL COMMENT '公众号ID';");
}
if(!pdo_fieldexists("wx_school_kc_vislog", "schoolid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_vislog")." ADD `schoolid` int(10) unsigned NOT NULL COMMENT '学校ID';");
}
if(!pdo_fieldexists("wx_school_kc_vislog", "kcid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_vislog")." ADD `kcid` int(10) unsigned NOT NULL COMMENT '归属课程ID';");
}
if(!pdo_fieldexists("wx_school_kc_vislog", "sid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_vislog")." ADD `sid` int(10) unsigned NOT NULL COMMENT 'sid';");
}
...
if(!pdo_fieldexists("wx_school_kc_vislog", "tid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_vislog")." ADD `tid` int(10) unsigned NOT NULL COMMENT '回访人';");
}
if(!pdo_fieldexists("wx_school_kc_vislog", "createtime")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kc_vislog")." ADD `createtime` int(10) unsigned NOT NULL COMMENT '创建时间';");
}
...
if(!pdo_fieldexists("wx_school_kcbiao", "isxiangqing")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kcbiao")." ADD `isxiangqing` tinyint(1) NOT NULL DEFAULT '0' COMMENT '内容显示开关';");
}
...
if(!pdo_fieldexists("wx_school_kcbiao", "re_type")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kcbiao")." ADD `re_type` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '1每周2隔周3日期0手动';");
}
if(!pdo_fieldexists("wx_school_kcbiao", "is_try_see")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kcbiao")." ADD `is_try_see` tinyint(1) unsigned NOT NULL DEFAULT '2' COMMENT '1试看2否';");
}
...
if(!pdo_fieldexists("wx_school_kcbiao", "content_type")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kcbiao")." ADD `content_type` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '0富文本1直播2视频3语音4纯图5文档';");
}
...
if(!pdo_fieldexists("wx_school_kcbiao", "createtime")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kcbiao")." ADD `createtime` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_kcbiao", "sk_start")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kcbiao")." ADD `sk_start` int(11) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_kcbiao", "sk_end")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kcbiao")." ADD `sk_end` int(11) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_kcbiao", "is_allow_reply")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kcbiao")." ADD `is_allow_reply` tinyint(1) NOT NULL DEFAULT '2' COMMENT '1允许2否';");
}
if(!pdo_fieldexists("wx_school_kcbiao", "is_allow_ykreply")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kcbiao")." ADD `is_allow_ykreply` tinyint(1) NOT NULL DEFAULT '2' COMMENT '1允许2否';");
}
if(!pdo_fieldexists("wx_school_kcbiao", "sid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kcbiao")." ADD `sid` int(10) DEFAULT '0';");
}
if(!pdo_fieldexists("wx_school_kcbiao", "tempsid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kcbiao")." ADD `tempsid` int(10) DEFAULT '0';");
}
...
if(!pdo_fieldexists("wx_school_kcpingjia", "ksid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kcpingjia")." ADD `ksid` int(10) unsigned NOT NULL COMMENT '所属课时';");
}
if(!pdo_fieldexists("wx_school_kcpingjia", "tosid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kcpingjia")." ADD `tosid` int(10) unsigned NOT NULL COMMENT '评价的学生';");
}
if(!pdo_fieldexists("wx_school_kcpingjia", "totid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kcpingjia")." ADD `totid` int(10) unsigned NOT NULL COMMENT '评价的老师';");
}
if(!pdo_fieldexists("wx_school_kcpingjia", "masterid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kcpingjia")." ADD `masterid` int(10) unsigned NOT NULL COMMENT '主ID';");
}
if(!pdo_fieldexists("wx_school_kcpingjia", "is_master")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kcpingjia")." ADD `is_master` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '1主评论0回复';");
}
if(!pdo_fieldexists("wx_school_kcpingjia", "is_show")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kcpingjia")." ADD `is_show` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '是否显示';");
}
...
if(!pdo_fieldexists("wx_school_kcsign", "costnum")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kcsign")." ADD `costnum` tinyint(3) NOT NULL DEFAULT '1' COMMENT '消耗课时';");
}
if(!pdo_fieldexists("wx_school_kcsign", "ismaster_tid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kcsign")." ADD `ismaster_tid` tinyint(1) NOT NULL DEFAULT '1' COMMENT '1主讲2助教';");
}
if(!pdo_fieldexists("wx_school_kcsign", "signtype")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kcsign")." ADD `signtype` tinyint(1) NOT NULL DEFAULT '0';");
}
...
if(!pdo_fieldexists("wx_school_language", "weid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_language")." ADD `weid` int(10) unsigned NOT NULL COMMENT '公众号';");
}
if(!pdo_fieldexists("wx_school_language", "schoolid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_language")." ADD `schoolid` int(10) unsigned NOT NULL COMMENT '分校id';");
}
if(!pdo_fieldexists("wx_school_language", "is_on")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_language")." ADD `is_on` tinyint(1) NOT NULL DEFAULT '1' COMMENT '是否启用';");
}
...
if(!pdo_fieldexists("wx_school_leave", "uid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_leave")." ADD `uid` int(10) unsigned NOT NULL COMMENT '微擎UID';");
}
if(!pdo_fieldexists("wx_school_leave", "tuid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_leave")." ADD `tuid` int(10) unsigned NOT NULL COMMENT '老师微擎UID';");
}
if(!pdo_fieldexists("wx_school_leave", "userid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_leave")." ADD `userid` int(10) unsigned NOT NULL COMMENT '发送者id';");
}
if(!pdo_fieldexists("wx_school_leave", "touserid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_leave")." ADD `touserid` int(10) unsigned NOT NULL COMMENT '接收者id';");
}
...
if(!pdo_fieldexists("wx_school_leave", "startime1")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_leave")." ADD `startime1` int(10) unsigned NOT NULL COMMENT '开始时间';");
}
if(!pdo_fieldexists("wx_school_leave", "endtime1")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_leave")." ADD `endtime1` int(10) unsigned NOT NULL COMMENT '结束时间';");
}
...
if(!pdo_fieldexists("wx_school_leave", "reconet")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_leave")." ADD `reconet` varchar(200) DEFAULT '' COMMENT '详细内容';");
}
...
if(!pdo_fieldexists("wx_school_leave", "isfrist")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_leave")." ADD `isfrist` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '1是0否';");
}
...
if(!pdo_fieldexists("wx_school_leave", "isread")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_leave")." ADD `isread` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '1未读2已读';");
}
if(!pdo_fieldexists("wx_school_leave", "audio")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_leave")." ADD `audio` varchar(1000) DEFAULT '';");
}
if(!pdo_fieldexists("wx_school_leave", "kcid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_leave")." ADD `kcid` int(10) unsigned NOT NULL;");
}
...
if(!pdo_fieldexists("wx_school_leave", "kcsignid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_leave")." ADD `kcsignid` int(10) unsigned NOT NULL;");
}
...
if(!pdo_fieldexists("wx_school_leave", "pardstatus")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_leave")." ADD `pardstatus` tinyint(1) DEFAULT '0';");
}
...
if(!pdo_fieldexists("wx_school_liuyan", "leaveid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_liuyan")." ADD `leaveid` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_liuyan", "weid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_liuyan")." ADD `weid` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_liuyan", "schoolid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_liuyan")." ADD `schoolid` int(10) unsigned NOT NULL COMMENT '学校ID';");
}
if(!pdo_fieldexists("wx_school_liuyan", "uid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_liuyan")." ADD `uid` int(10) unsigned NOT NULL COMMENT '微擎UID';");
}
if(!pdo_fieldexists("wx_school_liuyan", "tuid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_liuyan")." ADD `tuid` int(10) unsigned NOT NULL COMMENT '老师微擎UID';");
}
if(!pdo_fieldexists("wx_school_liuyan", "openid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_liuyan")." ADD `openid` varchar(200) DEFAULT '' COMMENT 'openid';");
}
if(!pdo_fieldexists("wx_school_liuyan", "sid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_liuyan")." ADD `sid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '学生ID';");
}
if(!pdo_fieldexists("wx_school_liuyan", "tid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_liuyan")." ADD `tid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '教师ID';");
}
if(!pdo_fieldexists("wx_school_liuyan", "type")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_liuyan")." ADD `type` varchar(10) DEFAULT '' COMMENT '请假类型';");
}
if(!pdo_fieldexists("wx_school_liuyan", "startime")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_liuyan")." ADD `startime` varchar(200) DEFAULT '' COMMENT '开始时间';");
}
if(!pdo_fieldexists("wx_school_liuyan", "endtime")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_liuyan")." ADD `endtime` varchar(200) DEFAULT '' COMMENT '结束时间';");
}
if(!pdo_fieldexists("wx_school_liuyan", "conet")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_liuyan")." ADD `conet` varchar(200) DEFAULT '' COMMENT '详细内容';");
}
if(!pdo_fieldexists("wx_school_liuyan", "createtime")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_liuyan")." ADD `createtime` int(10) unsigned NOT NULL COMMENT '创建时间';");
}
if(!pdo_fieldexists("wx_school_liuyan", "cltime")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_liuyan")." ADD `cltime` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '处理时间';");
}
if(!pdo_fieldexists("wx_school_liuyan", "status")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_liuyan")." ADD `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '审核状态';");
}
if(!pdo_fieldexists("wx_school_liuyan", "bj_id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_liuyan")." ADD `bj_id` int(10) unsigned NOT NULL COMMENT '班级ID';");
}
if(!pdo_fieldexists("wx_school_liuyan", "isliuyan")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_liuyan")." ADD `isliuyan` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '是否留言';");
}
...
if(!pdo_fieldexists("wx_school_liuyan", "isfrist")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_liuyan")." ADD `isfrist` tinyint(1) NOT NULL DEFAULT '0' COMMENT '1是0否';");
}
...
if(!pdo_fieldexists("wx_school_liuyan", "isread")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_liuyan")." ADD `isread` tinyint(1) NOT NULL DEFAULT '1' COMMENT '1是2否';");
}
...
if(!pdo_fieldexists("wx_school_liuyan", "cltid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_liuyan")." ADD `cltid` int(10) unsigned NOT NULL COMMENT '老师id';");
}
if(!pdo_fieldexists("wx_school_liuyan", "reconet")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_liuyan")." ADD `reconet` varchar(200) DEFAULT '' COMMENT '教师回复';");
}
if(!pdo_fieldexists("wx_school_liuyan", "audio")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_liuyan")." ADD `audio` varchar(1000) DEFAULT '';");
}
...
if(!pdo_fieldexists("wx_school_liuyan", "kcid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_liuyan")." ADD `kcid` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_liuyan", "ksid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_liuyan")." ADD `ksid` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_liuyan", "kcsignid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_liuyan")." ADD `kcsignid` int(10) unsigned NOT NULL;");
}
...
if(!pdo_fieldexists("wx_school_lxvis", "is_sync")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_lxvis")." ADD `is_sync` tinyint(1) NOT NULL DEFAULT '0';");
}
if(!pdo_fieldexists("wx_school_lxvis", "snowid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_lxvis")." ADD `snowid` varchar(20) NOT NULL DEFAULT '0';");
}
if(!pdo_fieldexists("wx_school_lxvis", "tempcard")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_lxvis")." ADD `tempcard` char(16) NOT NULL DEFAULT '0';");
}
...
if(!pdo_fieldexists("wx_school_lxvislog", "type")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_lxvislog")." ADD `type` tinyint(1) NOT NULL DEFAULT '0';");
}
if(!pdo_fieldexists("wx_school_lxvislog", "createtime")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_lxvislog")." ADD `createtime` int(10) NOT NULL DEFAULT '0';");
}
if(!pdo_fieldexists("wx_school_lxvislog", "signtime")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_lxvislog")." ADD `signtime` int(10) NOT NULL DEFAULT '0';");
}
...
if(!pdo_fieldexists("wx_school_mcreportlist", "semestertype")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_mcreportlist")." ADD `semestertype` tinyint(1) NOT NULL DEFAULT '1';");
}
...
if(!pdo_fieldexists("wx_school_mcreportlist", "cnbotssemesterid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_mcreportlist")." ADD `cnbotssemesterid` varchar(40) NOT NULL DEFAULT '0';");
}
if(!pdo_fieldexists("wx_school_mcreportlist", "bjid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_mcreportlist")." ADD `bjid` int(10) NOT NULL DEFAULT '0';");
}
...
if(!pdo_fieldexists("wx_school_media", "type")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_media")." ADD `type` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0班级圈1学生相册';");
}
if(!pdo_fieldexists("wx_school_media", "isfm")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_media")." ADD `isfm` tinyint(1) NOT NULL DEFAULT '0' COMMENT '1是0否';");
}
...
if(!pdo_fieldexists("wx_school_media", "is_video")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_media")." ADD `is_video` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0相册1视频';");
}
...
if(!pdo_fieldexists("wx_school_meetinglog", "type")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_meetinglog")." ADD `type` tinyint(1) NOT NULL DEFAULT '1';");
}
...
if(!pdo_fieldexists("wx_school_meetinglog", "sid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_meetinglog")." ADD `sid` int(10) DEFAULT '0';");
}
if(!pdo_fieldexists("wx_school_morningcheck", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_morningcheck")." ADD `id` int(11) unsigned NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_morningcheck", "height")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_morningcheck")." ADD `height` float(6,2) NOT NULL DEFAULT '1.00' COMMENT 'cm';");
}
if(!pdo_fieldexists("wx_school_morningcheck", "weight")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_morningcheck")." ADD `weight` float(6,3) NOT NULL DEFAULT '1.000' COMMENT 'kg';");
}
...
if(!pdo_fieldexists("wx_school_morningcheck", "is_send")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_morningcheck")." ADD `is_send` tinyint(1) NOT NULL DEFAULT '1' COMMENT '是否发送';");
}
if(!pdo_fieldexists("wx_school_morningcheck", "cough")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_morningcheck")." ADD `cough` tinyint(1) NOT NULL DEFAULT '2' COMMENT '咳嗽，1是2否';");
}
if(!pdo_fieldexists("wx_school_morningcheck", "vomit")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_morningcheck")." ADD `vomit` tinyint(1) NOT NULL DEFAULT '2' COMMENT '呕吐，1是2否';");
}
if(!pdo_fieldexists("wx_school_morningcheck", "trauma")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_morningcheck")." ADD `trauma` tinyint(1) NOT NULL DEFAULT '2' COMMENT '外伤，1是2否';");
}
if(!pdo_fieldexists("wx_school_morningcheck", "diarrhea")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_morningcheck")." ADD `diarrhea` tinyint(1) NOT NULL DEFAULT '2' COMMENT '腹泻，1是2否';");
}
if(!pdo_fieldexists("wx_school_morningcheck", "cold")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_morningcheck")." ADD `cold` tinyint(1) NOT NULL DEFAULT '2' COMMENT '感冒，1是2否';");
}
...
if(!pdo_fieldexists("wx_school_morningcheck", "issb")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_morningcheck")." ADD `issb` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否设备0不是1是';");
}
if(!pdo_fieldexists("wx_school_morningcheck", "nail")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_morningcheck")." ADD `nail` tinyint(1) NOT NULL DEFAULT '1' COMMENT '指甲1正常2异常';");
}
...
if(!pdo_fieldexists("wx_school_morningcheck", "headache")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_morningcheck")." ADD `headache` tinyint(1) NOT NULL DEFAULT '2' COMMENT '头痛，1是2否';");
}
if(!pdo_fieldexists("wx_school_morningcheck", "is_mc")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_morningcheck")." ADD `is_mc` tinyint(1) NOT NULL DEFAULT '0' COMMENT '晨检定制，1是0否';");
}
...
if(!pdo_fieldexists("wx_school_muban", "type")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_muban")." ADD `type` tinyint(1) NOT NULL DEFAULT '1';");
}
...
if(!pdo_fieldexists("wx_school_mubanpage", "auth")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_mubanpage")." ADD `auth` tinyint(1) NOT NULL DEFAULT '1';");
}
...
if(!pdo_fieldexists("wx_school_news", "isshow")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_news")." ADD `isshow` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否显示内容2关闭，0-1开启';");
}
if(!pdo_fieldexists("wx_school_news", "isopenpl")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_news")." ADD `isopenpl` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否开启评论2关闭，0-1开启';");
}
if(!pdo_fieldexists("wx_school_news", "defaultshow")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_news")." ADD `defaultshow` tinyint(1) NOT NULL DEFAULT '1' COMMENT '默认显示评论0-1显示，2隐藏';");
}
if(!pdo_fieldexists("wx_school_news", "isopendz")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_news")." ADD `isopendz` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否开启点赞2关闭，0-1开启';");
}
...
if(!pdo_fieldexists("wx_school_notice", "ismobile")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_notice")." ADD `ismobile` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0手机端1电脑端';");
}
...
if(!pdo_fieldexists("wx_school_notice", "video")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_notice")." ADD `video` varchar(2000) NOT NULL DEFAULT '' COMMENT '视频地址';");
}
if(!pdo_fieldexists("wx_school_notice", "ali_vod_id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_notice")." ADD `ali_vod_id` varchar(100) DEFAULT '' COMMENT '视频画面ID';");
}
if(!pdo_fieldexists("wx_school_notice", "videopic")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_notice")." ADD `videopic` varchar(1000) NOT NULL DEFAULT '' COMMENT '视频封面';");
}
...
if(!pdo_fieldexists("wx_school_notice", "usertype")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_notice")." ADD `usertype` varchar(100) DEFAULT '' COMMENT '接收用户';");
}
if(!pdo_fieldexists("wx_school_notice", "userdatas")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_notice")." ADD `userdatas` varchar(1000) DEFAULT '' COMMENT '用户数据';");
}
if(!pdo_fieldexists("wx_school_notice", "comment")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_notice")." ADD `comment` tinyint(1) NOT NULL DEFAULT '0';");
}
...
if(!pdo_fieldexists("wx_school_notice", "is_sync")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_notice")." ADD `is_sync` tinyint(1) DEFAULT '0' COMMENT '是否同步班牌';");
}
if(!pdo_fieldexists("wx_school_notice", "starttime")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_notice")." ADD `starttime` int(10) NOT NULL DEFAULT '0';");
}
if(!pdo_fieldexists("wx_school_notice", "endtime")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_notice")." ADD `endtime` int(10) NOT NULL DEFAULT '0';");
}
if(!pdo_fieldexists("wx_school_notice_comment", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_notice_comment")." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("wx_school_notice_comment", "weid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_notice_comment")." ADD `weid` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_notice_comment", "schoolid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_notice_comment")." ADD `schoolid` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_notice_comment", "userid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_notice_comment")." ADD `userid` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_notice_comment", "noticeid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_notice_comment")." ADD `noticeid` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_notice_comment", "commentid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_notice_comment")." ADD `commentid` int(10) unsigned NOT NULL;");
}
...
if(!pdo_fieldexists("wx_school_notice_comment", "createtime")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_notice_comment")." ADD `createtime` int(10) unsigned NOT NULL;");
}
...
if(!pdo_fieldexists("wx_school_online", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_online")." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("wx_school_online", "weid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_online")." ADD `weid` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_online", "schoolid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_online")." ADD `schoolid` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_online", "macid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_online")." ADD `macid` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_online", "commond")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_online")." ADD `commond` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_online", "result")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_online")." ADD `result` tinyint(1) unsigned NOT NULL DEFAULT '2';");
}
if(!pdo_fieldexists("wx_school_online", "isread")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_online")." ADD `isread` tinyint(1) unsigned NOT NULL DEFAULT '2';");
}
if(!pdo_fieldexists("wx_school_online", "createtime")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_online")." ADD `createtime` int(10) unsigned NOT NULL COMMENT '生成时间';");
}
if(!pdo_fieldexists("wx_school_online", "dotime")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_online")." ADD `dotime` int(10) unsigned NOT NULL COMMENT '执行时间';");
}
...
if(!pdo_fieldexists("wx_school_online", "type")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_online")." ADD `type` tinyint(1) DEFAULT '1' COMMENT '1任务2在线';");
}
...
if(!pdo_fieldexists("wx_school_order", "sid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_order")." ADD `sid` int(10) unsigned NOT NULL COMMENT '学生id';");
}
...
if(!pdo_fieldexists("wx_school_order", "obid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_order")." ADD `obid` int(10) unsigned NOT NULL COMMENT '功能ID';");
}
...
if(!pdo_fieldexists("wx_school_order", "status")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_order")." ADD `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '1未支付2为已支付3为已退款';");
}
if(!pdo_fieldexists("wx_school_order", "type")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_order")." ADD `type` tinyint(1) NOT NULL DEFAULT '0' COMMENT '1课程2项目3功能4报名';");
}
...
if(!pdo_fieldexists("wx_school_order", "kujx")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_order")." ADD `kujx` varchar(30) NOT NULL DEFAULT '0' COMMENT '支付LOGO';");
}
...
if(!pdo_fieldexists("wx_school_order", "tuitime")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_order")." ADD `tuitime` int(10) unsigned NOT NULL COMMENT '退费时间';");
}
...
if(!pdo_fieldexists("wx_school_order", "uniontid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_order")." ADD `uniontid` varchar(1000) DEFAULT '' COMMENT '微信或支付宝返回的订单号';");
}
if(!pdo_fieldexists("wx_school_order", "refundid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_order")." ADD `refundid` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_order", "wxpayid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_order")." ADD `wxpayid` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_order", "vodid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_order")." ADD `vodid` int(10) unsigned COMMENT '视频ID';");
}
...
if(!pdo_fieldexists("wx_school_order", "new_stu")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_order")." ADD `new_stu` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '0默认1新增学生';");
}
if(!pdo_fieldexists("wx_school_order", "sale_type")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_order")." ADD `sale_type` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '1团2助力0关闭';");
}
if(!pdo_fieldexists("wx_school_order", "sale_rule")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_order")." ADD `sale_rule` int(10) unsigned NOT NULL COMMENT '营销所属规则';");
}
if(!pdo_fieldexists("wx_school_order", "team_id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_order")." ADD `team_id` int(10) unsigned NOT NULL COMMENT '组队ID';");
}
if(!pdo_fieldexists("wx_school_order", "superior_tid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_order")." ADD `superior_tid` int(10) unsigned NOT NULL COMMENT '推广员ID';");
}
if(!pdo_fieldexists("wx_school_order", "team_price")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_order")." ADD `team_price` decimal(18,2) NOT NULL DEFAULT '0.00' COMMENT '队伍优惠';");
}
if(!pdo_fieldexists("wx_school_order", "team_dz_price")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_order")." ADD `team_dz_price` decimal(18,2) NOT NULL DEFAULT '0.00' COMMENT '队长优惠';");
}
...
if(!pdo_fieldexists("wx_school_order", "redpacketlogid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_order")." ADD `redpacketlogid` int(10) DEFAULT '0' COMMENT '红包记录id';");
}
if(!pdo_fieldexists("wx_school_order", "couponlogid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_order")." ADD `couponlogid` int(10) DEFAULT '0' COMMENT '优惠券记录id';");
}
if(!pdo_fieldexists("wx_school_order", "extra_info")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_order")." ADD `extra_info` int(10) DEFAULT '0';");
}
if(!pdo_fieldexists("wx_school_order", "wqorderid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_order")." ADD `wqorderid` varchar(1000) DEFAULT '' COMMENT '本地流水号';");
}
...
if(!pdo_fieldexists("wx_school_print_log", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_print_log")." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("wx_school_print_log", "weid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_print_log")." ADD `weid` int(10) unsigned NOT NULL DEFAULT '0';");
}
if(!pdo_fieldexists("wx_school_print_log", "schoolid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_print_log")." ADD `schoolid` int(10) unsigned NOT NULL DEFAULT '0';");
}
if(!pdo_fieldexists("wx_school_print_log", "pid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_print_log")." ADD `pid` tinyint(3) unsigned NOT NULL DEFAULT '0';");
}
if(!pdo_fieldexists("wx_school_print_log", "oid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_print_log")." ADD `oid` int(10) unsigned NOT NULL DEFAULT '0';");
}
...
if(!pdo_fieldexists("wx_school_print_log", "status")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_print_log")." ADD `status` tinyint(3) unsigned NOT NULL DEFAULT '2' COMMENT '1:打印成功,2:打印未成功';");
}
if(!pdo_fieldexists("wx_school_print_log", "printer_type")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_print_log")." ADD `printer_type` varchar(20) NOT NULL DEFAULT 'feie';");
}
if(!pdo_fieldexists("wx_school_print_log", "createtime")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_print_log")." ADD `createtime` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_printer", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_printer")." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("wx_school_printer", "weid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_printer")." ADD `weid` int(10) unsigned NOT NULL DEFAULT '0';");
}
if(!pdo_fieldexists("wx_school_printer", "schoolid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_printer")." ADD `schoolid` int(10) unsigned NOT NULL;");
}
...
if(!pdo_fieldexists("wx_school_printer", "type")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_printer")." ADD `type` varchar(20) NOT NULL DEFAULT 'feie';");
}
...
if(!pdo_fieldexists("wx_school_printer", "print_nums")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_printer")." ADD `print_nums` tinyint(3) unsigned NOT NULL DEFAULT '1';");
}
...
if(!pdo_fieldexists("wx_school_printer", "status")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_printer")." ADD `status` tinyint(3) unsigned NOT NULL DEFAULT '1';");
}
if(!pdo_fieldexists("wx_school_printer", "delivery_type")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_printer")." ADD `delivery_type` int(10) unsigned NOT NULL DEFAULT '0';");
}
...
if(!pdo_fieldexists("wx_school_printset", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_printset")." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("wx_school_printset", "weid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_printset")." ADD `weid` int(10) unsigned NOT NULL DEFAULT '0';");
}
if(!pdo_fieldexists("wx_school_printset", "schoolid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_printset")." ADD `schoolid` int(10) unsigned NOT NULL;");
}
...
if(!pdo_fieldexists("wx_school_printset", "status")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_printset")." ADD `status` tinyint(1) NOT NULL DEFAULT '1';");
}
...
if(!pdo_fieldexists("wx_school_printset", "print_nums")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_printset")." ADD `print_nums` int(10) NOT NULL DEFAULT '1';");
}
...
if(!pdo_fieldexists("wx_school_promote_fans", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_promote_fans")." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("wx_school_promote_fans", "weid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_promote_fans")." ADD `weid` int(10) unsigned NOT NULL COMMENT '公众号ID';");
}
if(!pdo_fieldexists("wx_school_promote_fans", "schoolid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_promote_fans")." ADD `schoolid` int(10) unsigned NOT NULL COMMENT '学校ID';");
}
if(!pdo_fieldexists("wx_school_promote_fans", "kcid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_promote_fans")." ADD `kcid` int(10) unsigned NOT NULL COMMENT '归属课程ID';");
}
...
if(!pdo_fieldexists("wx_school_promote_fans", "userid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_promote_fans")." ADD `userid` int(10) unsigned NOT NULL COMMENT '用户userid';");
}
...
if(!pdo_fieldexists("wx_school_promote_fans", "superior_userid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_promote_fans")." ADD `superior_userid` int(10) unsigned NOT NULL COMMENT '归属推广userid';");
}
if(!pdo_fieldexists("wx_school_promote_fans", "opt_tid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_promote_fans")." ADD `opt_tid` int(10) unsigned NOT NULL COMMENT '分配操作人';");
}
if(!pdo_fieldexists("wx_school_promote_fans", "is_sale")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_promote_fans")." ADD `is_sale` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '是否消费';");
}
if(!pdo_fieldexists("wx_school_promote_fans", "com_form")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_promote_fans")." ADD `com_form` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '1推广海报2团购海报3助力海报4前端分配';");
}
if(!pdo_fieldexists("wx_school_promote_fans", "createtime")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_promote_fans")." ADD `createtime` int(10) unsigned NOT NULL COMMENT '创建时间';");
}
if(!pdo_fieldexists("wx_school_promote_pop", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_promote_pop")." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("wx_school_promote_pop", "weid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_promote_pop")." ADD `weid` int(10) unsigned NOT NULL COMMENT '公众号ID';");
}
if(!pdo_fieldexists("wx_school_promote_pop", "schoolid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_promote_pop")." ADD `schoolid` int(10) unsigned NOT NULL COMMENT '学校ID';");
}
if(!pdo_fieldexists("wx_school_promote_pop", "kcid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_promote_pop")." ADD `kcid` int(10) unsigned NOT NULL COMMENT '归属课程ID';");
}
if(!pdo_fieldexists("wx_school_promote_pop", "teamid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_promote_pop")." ADD `teamid` int(10) unsigned NOT NULL COMMENT '队伍ID';");
}
...
if(!pdo_fieldexists("wx_school_promote_pop", "userid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_promote_pop")." ADD `userid` int(10) unsigned NOT NULL COMMENT '用户userid';");
}
...
if(!pdo_fieldexists("wx_school_promote_pop", "type")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_promote_pop")." ADD `type` tinyint(1) unsigned NOT NULL COMMENT '1营销海报2推广海报';");
}
if(!pdo_fieldexists("wx_school_promote_pop", "createtime")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_promote_pop")." ADD `createtime` int(10) unsigned NOT NULL COMMENT '创建时间';");
}
if(!pdo_fieldexists("wx_school_promote_team", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_promote_team")." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("wx_school_promote_team", "weid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_promote_team")." ADD `weid` int(10) unsigned NOT NULL COMMENT '公众号ID';");
}
if(!pdo_fieldexists("wx_school_promote_team", "schoolid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_promote_team")." ADD `schoolid` int(10) unsigned NOT NULL COMMENT '学校ID';");
}
if(!pdo_fieldexists("wx_school_promote_team", "kcid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_promote_team")." ADD `kcid` int(10) unsigned NOT NULL COMMENT '归属课程ID';");
}
if(!pdo_fieldexists("wx_school_promote_team", "tid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_promote_team")." ADD `tid` int(10) unsigned NOT NULL COMMENT '推广员TID';");
}
if(!pdo_fieldexists("wx_school_promote_team", "sid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_promote_team")." ADD `sid` int(10) unsigned NOT NULL COMMENT '正式学生ID';");
}
...
if(!pdo_fieldexists("wx_school_promote_team", "createtime")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_promote_team")." ADD `createtime` int(10) unsigned NOT NULL COMMENT '创建时间';");
}
...
if(!pdo_fieldexists("wx_school_psychology", "isread")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_psychology")." ADD `isread` tinyint(1) NOT NULL DEFAULT '1';");
}
...
if(!pdo_fieldexists("wx_school_qrcode_info", "schoolid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_qrcode_info")." ADD `schoolid` int(10) unsigned COMMENT '学校ID';");
}
...
if(!pdo_fieldexists("wx_school_qrcode_info", "type")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_qrcode_info")." ADD `type` int(11) NOT NULL DEFAULT '1';");
}
...
if(!pdo_fieldexists("wx_school_qzkh", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_qzkh")." ADD `id` int(11) unsigned NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_qzkh", "status")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_qzkh")." ADD `status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '1未分配2已分配';");
}
...
if(!pdo_fieldexists("wx_school_roomcheck", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_roomcheck")." ADD `id` int(11) unsigned NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_sale_team", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_sale_team")." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("wx_school_sale_team", "weid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_sale_team")." ADD `weid` int(10) unsigned NOT NULL COMMENT '公众号ID';");
}
if(!pdo_fieldexists("wx_school_sale_team", "schoolid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_sale_team")." ADD `schoolid` int(10) unsigned NOT NULL COMMENT '学校ID';");
}
if(!pdo_fieldexists("wx_school_sale_team", "kcid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_sale_team")." ADD `kcid` int(10) unsigned NOT NULL COMMENT '归属课程ID';");
}
if(!pdo_fieldexists("wx_school_sale_team", "userid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_sale_team")." ADD `userid` int(10) unsigned NOT NULL COMMENT '参团的学生归属用户ID';");
}
...
if(!pdo_fieldexists("wx_school_sale_team", "ismaster")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_sale_team")." ADD `ismaster` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '队长团长';");
}
if(!pdo_fieldexists("wx_school_sale_team", "masterid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_sale_team")." ADD `masterid` int(10) unsigned NOT NULL COMMENT '归属团或组';");
}
if(!pdo_fieldexists("wx_school_sale_team", "is_sale")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_sale_team")." ADD `is_sale` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '是否消费';");
}
if(!pdo_fieldexists("wx_school_sale_team", "is_success")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_sale_team")." ADD `is_success` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '是否成功';");
}
if(!pdo_fieldexists("wx_school_sale_team", "is_really")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_sale_team")." ADD `is_really` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '0真实1虚拟';");
}
...
if(!pdo_fieldexists("wx_school_sale_team", "orderid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_sale_team")." ADD `orderid` int(10) unsigned NOT NULL COMMENT '订单ID';");
}
if(!pdo_fieldexists("wx_school_sale_team", "tuifei")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_sale_team")." ADD `tuifei` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '退费申请';");
}
...
if(!pdo_fieldexists("wx_school_sale_team", "type")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_sale_team")." ADD `type` tinyint(1) unsigned NOT NULL COMMENT '1团购2助力';");
}
if(!pdo_fieldexists("wx_school_sale_team", "endtime")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_sale_team")." ADD `endtime` int(10) unsigned NOT NULL COMMENT '创建时间';");
}
if(!pdo_fieldexists("wx_school_sale_team", "createtime")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_sale_team")." ADD `createtime` int(10) unsigned NOT NULL COMMENT '创建时间';");
}
...
if(!pdo_fieldexists("wx_school_saleform", "tid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_saleform")." ADD `tid` varchar(10) NOT NULL DEFAULT '0';");
}
if(!pdo_fieldexists("wx_school_saleform", "status")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_saleform")." ADD `status` tinyint(1) NOT NULL DEFAULT '0';");
}
...
if(!pdo_fieldexists("wx_school_schoolset", "refund")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_schoolset")." ADD `refund` tinyint(1) NOT NULL DEFAULT '0';");
}
...
if(!pdo_fieldexists("wx_school_schoolset", "stutemplate")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_schoolset")." ADD `stutemplate` varchar(10) DEFAULT 'old';");
}
if(!pdo_fieldexists("wx_school_schoolset", "teatemplate")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_schoolset")." ADD `teatemplate` varchar(10) DEFAULT 'old';");
}
if(!pdo_fieldexists("wx_school_schoolset", "tx_pay")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_schoolset")." ADD `tx_pay` tinyint(1) NOT NULL DEFAULT '2' COMMENT '提现付款1启用2关闭';");
}
if(!pdo_fieldexists("wx_school_schoolset", "is_dybp")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_schoolset")." ADD `is_dybp` tinyint(1) NOT NULL DEFAULT '1' COMMENT '大云班牌';");
}
...
if(!pdo_fieldexists("wx_school_schoolset", "is_teatotea")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_schoolset")." ADD `is_teatotea` tinyint(1) NOT NULL DEFAULT '1' COMMENT '1开启2关闭';");
}
if(!pdo_fieldexists("wx_school_schoolset", "is_stutostu")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_schoolset")." ADD `is_stutostu` tinyint(1) NOT NULL DEFAULT '1' COMMENT '1开启2关闭';");
}
if(!pdo_fieldexists("wx_school_schoolset", "is_teatostu")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_schoolset")." ADD `is_teatostu` tinyint(1) NOT NULL DEFAULT '1' COMMENT '1开启2关闭';");
}
if(!pdo_fieldexists("wx_school_schoolset", "is_unbind")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_schoolset")." ADD `is_unbind` tinyint(1) NOT NULL DEFAULT '0';");
}
if(!pdo_fieldexists("wx_school_schoolset", "is_sure_kq")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_schoolset")." ADD `is_sure_kq` tinyint(1) NOT NULL DEFAULT '0';");
}
if(!pdo_fieldexists("wx_school_schoolset", "twqswitch")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_schoolset")." ADD `twqswitch` tinyint(1) NOT NULL DEFAULT '1';");
}
...
if(!pdo_fieldexists("wx_school_schoolset", "top")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_schoolset")." ADD `top` tinyint(1) NOT NULL DEFAULT '0' COMMENT '人脸是否是否。0否，1是';");
}
...
if(!pdo_fieldexists("wx_school_schoolset", "isallowup")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_schoolset")." ADD `isallowup` tinyint(1) NOT NULL DEFAULT '2' COMMENT '是否允许家长上传1是2否';");
}
if(!pdo_fieldexists("wx_school_schoolset", "is_mc")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_schoolset")." ADD `is_mc` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否晨检';");
}
...
if(!pdo_fieldexists("wx_school_schoolset", "is_manual")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_schoolset")." ADD `is_manual` tinyint(3) NOT NULL DEFAULT '0' COMMENT '成长手册';");
}
...
if(!pdo_fieldexists("wx_school_schoolset", "is_allow_send_voice")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_schoolset")." ADD `is_allow_send_voice` tinyint(1) DEFAULT '2' COMMENT '发送语音1允许2不允许';");
}
...
if(!pdo_fieldexists("wx_school_schoolset", "senddoor")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_schoolset")." ADD `senddoor` tinyint(1) DEFAULT '0';");
}
if(!pdo_fieldexists("wx_school_schoolset", "priority")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_schoolset")." ADD `priority` tinyint(1) DEFAULT '0';");
}
if(!pdo_fieldexists("wx_school_schoolset", "is_tx_tea")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_schoolset")." ADD `is_tx_tea` tinyint(1) DEFAULT '0';");
}
if(!pdo_fieldexists("wx_school_schoolset", "synctime")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_schoolset")." ADD `synctime` varchar(10) NOT NULL DEFAULT '0';");
}
if(!pdo_fieldexists("wx_school_schoolset", "is_limit_send")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_schoolset")." ADD `is_limit_send` tinyint(1) NOT NULL DEFAULT '1';");
}
if(!pdo_fieldexists("wx_school_schoolset", "is_repet")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_schoolset")." ADD `is_repet` tinyint(1) NOT NULL DEFAULT '1';");
}
if(!pdo_fieldexists("wx_school_schoolset", "dd_limit_time")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_schoolset")." ADD `dd_limit_time` int(10) NOT NULL DEFAULT '0';");
}
if(!pdo_fieldexists("wx_school_schoolset", "dd_repet_time")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_schoolset")." ADD `dd_repet_time` int(10) NOT NULL DEFAULT '0';");
}
if(!pdo_fieldexists("wx_school_schoolset", "synctime_month")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_schoolset")." ADD `synctime_month` varchar(10) NOT NULL DEFAULT '0';");
}
if(!pdo_fieldexists("wx_school_schoolset", "synctime_xq")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_schoolset")." ADD `synctime_xq` varchar(10) NOT NULL DEFAULT '0';");
}
...
if(!pdo_fieldexists("wx_school_score", "tid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_score")." ADD `tid` varchar(200) NOT NULL DEFAULT '' COMMENT '操作人';");
}
...
if(!pdo_fieldexists("wx_school_set", "bjqshjg")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_set")." ADD `bjqshjg` varchar(200) DEFAULT '' COMMENT '班级圈审核结果';");
}
if(!pdo_fieldexists("wx_school_set", "bjqshtz")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_set")." ADD `bjqshtz` varchar(200) DEFAULT '' COMMENT '班级圈审核提醒';");
}
...
if(!pdo_fieldexists("wx_school_set", "bd_set")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_set")." ADD `bd_set` varchar(1000) DEFAULT '';");
}
if(!pdo_fieldexists("wx_school_set", "sms_acss")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_set")." ADD `sms_acss` varchar(1000) DEFAULT '';");
}
...
if(!pdo_fieldexists("wx_school_set", "baidumapapi")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_set")." ADD `baidumapapi` varchar(200) DEFAULT '';");
}
if(!pdo_fieldexists("wx_school_set", "kcpjtx")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_set")." ADD `kcpjtx` varchar(200) DEFAULT '';");
}
...
if(!pdo_fieldexists("wx_school_set", "bgimg")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_set")." ADD `bgimg` varchar(200) DEFAULT '';");
}
...
if(!pdo_fieldexists("wx_school_set", "is_new")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_set")." ADD `is_new` tinyint(1) NOT NULL DEFAULT '1' COMMENT '新旧风格';");
}
...
if(!pdo_fieldexists("wx_school_set", "dkcgtz")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_set")." ADD `dkcgtz` varchar(300) DEFAULT '';");
}
if(!pdo_fieldexists("wx_school_set", "twcltz")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_set")." ADD `twcltz` varchar(300) DEFAULT '';");
}
if(!pdo_fieldexists("wx_school_set", "jktxtz")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_set")." ADD `jktxtz` varchar(300) DEFAULT '';");
}
...
if(!pdo_fieldexists("wx_school_set", "school_max")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_set")." ADD `school_max` int(10) NOT NULL DEFAULT '0';");
}
...
if(!pdo_fieldexists("wx_school_set", "faceset")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_set")." ADD `faceset` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否开启，0否，1是';");
}
...
if(!pdo_fieldexists("wx_school_set", "xzfstatus")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_set")." ADD `xzfstatus` tinyint(1) DEFAULT '2' COMMENT '1开启2关闭';");
}
...
if(!pdo_fieldexists("wx_school_set", "tyshtx")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_set")." ADD `tyshtx` varchar(200) DEFAULT '' COMMENT '通用审核提醒';");
}
...
if(!pdo_fieldexists("wx_school_sharerecord", "shtime")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_sharerecord")." ADD `shtime` int(11) NOT NULL DEFAULT '1';");
}
...
if(!pdo_fieldexists("wx_school_shoucepyk", "sid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_shoucepyk")." ADD `sid` int(10) NOT NULL DEFAULT '0' COMMENT '评语分类ID';");
}
...
if(!pdo_fieldexists("wx_school_signup", "sid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_signup")." ADD `sid` int(11) unsigned NOT NULL;");
}
...
if(!pdo_fieldexists("wx_school_sms_log", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_sms_log")." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("wx_school_sms_log", "weid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_sms_log")." ADD `weid` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_sms_log", "schoolid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_sms_log")." ADD `schoolid` int(10) unsigned NOT NULL;");
}
...
if(!pdo_fieldexists("wx_school_sms_log", "status")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_sms_log")." ADD `status` tinyint(1) NOT NULL DEFAULT '1';");
}
if(!pdo_fieldexists("wx_school_sms_log", "sendtime")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_sms_log")." ADD `sendtime` int(10) unsigned NOT NULL COMMENT '生成时间';");
}
...
if(!pdo_fieldexists("wx_school_special", "marketingtype")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_special")." ADD `marketingtype` tinyint(1) NOT NULL DEFAULT '0';");
}
...
if(!pdo_fieldexists("wx_school_students", "other")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_students")." ADD `other` varchar(30) NOT NULL DEFAULT '0' COMMENT '其他家长微信info';");
}
...
if(!pdo_fieldexists("wx_school_students", "keyid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_students")." ADD `keyid` int(11) unsigned DEFAULT '0';");
}
if(!pdo_fieldexists("wx_school_students", "qrcode_id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_students")." ADD `qrcode_id` int(10) unsigned COMMENT '二维码ID';");
}
...
if(!pdo_fieldexists("wx_school_students", "s_type")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_students")." ADD `s_type` tinyint(3) NOT NULL DEFAULT '1' COMMENT '走读住校';");
}
...
if(!pdo_fieldexists("wx_school_students", "status")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_students")." ADD `status` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '0激活1锁定';");
}
if(!pdo_fieldexists("wx_school_students", "superior_tid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_students")." ADD `superior_tid` int(10) unsigned NOT NULL COMMENT '招生tid';");
}
if(!pdo_fieldexists("wx_school_students", "from_kcid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_students")." ADD `from_kcid` int(10) unsigned NOT NULL COMMENT '来源课程ID';");
}
...
if(!pdo_fieldexists("wx_school_students", "is_banzhang")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_students")." ADD `is_banzhang` tinyint(4) NOT NULL DEFAULT '0' COMMENT '是否为班长0否，1是';");
}
if(!pdo_fieldexists("wx_school_students", "isopen")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_students")." ADD `isopen` tinyint(1) NOT NULL DEFAULT '1' COMMENT 'keep_Ls考勤开关1开2关';");
}
if(!pdo_fieldexists("wx_school_students", "xzf_datastatus")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_students")." ADD `xzf_datastatus` tinyint(1) DEFAULT '1';");
}
if(!pdo_fieldexists("wx_school_students", "xzf_needsync")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_students")." ADD `xzf_needsync` tinyint(1) DEFAULT '0';");
}
...
if(!pdo_fieldexists("wx_school_stuoverhuifang", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_stuoverhuifang")." ADD `id` int(11) unsigned NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_task", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_task")." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_task", "kcid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_task")." ADD `kcid` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_task", "status")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_task")." ADD `status` tinyint(1) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_task", "type")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_task")." ADD `type` tinyint(1) unsigned NOT NULL COMMENT '分类';");
}
...
if(!pdo_fieldexists("wx_school_task_list", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_task_list")." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_task_list", "taskid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_task_list")." ADD `taskid` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_task_list", "ksid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_task_list")." ADD `ksid` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_task_list", "type")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_task_list")." ADD `type` tinyint(1) unsigned NOT NULL COMMENT '分类';");
}
...
if(!pdo_fieldexists("wx_school_tcourse", "ssort")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_tcourse")." ADD `ssort` tinyint(3) NOT NULL DEFAULT '0';");
}
if(!pdo_fieldexists("wx_school_tcourse", "is_dm")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_tcourse")." ADD `is_dm` tinyint(1) NOT NULL DEFAULT '1' COMMENT '弹幕';");
}
if(!pdo_fieldexists("wx_school_tcourse", "is_tx")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_tcourse")." ADD `is_tx` tinyint(1) unsigned NOT NULL COMMENT '提醒开关';");
}
if(!pdo_fieldexists("wx_school_tcourse", "txtime")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_tcourse")." ADD `txtime` int(10) unsigned NOT NULL COMMENT '提前分钟';");
}
...
if(!pdo_fieldexists("wx_school_tcourse", "is_print")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_tcourse")." ADD `is_print` tinyint(1) NOT NULL DEFAULT '2' COMMENT '是否启用打印机';");
}
if(!pdo_fieldexists("wx_school_tcourse", "printarr")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_tcourse")." ADD `printarr` varchar(100) NOT NULL DEFAULT '' COMMENT '打印机';");
}
...
if(!pdo_fieldexists("wx_school_tcourse", "tea_sign_confirm")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_tcourse")." ADD `tea_sign_confirm` tinyint(1) unsigned NOT NULL DEFAULT '2' COMMENT '1老师签到确认2无需确认';");
}
...
if(!pdo_fieldexists("wx_school_tcourse", "tea_getcash")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_tcourse")." ADD `tea_getcash` tinyint(1) unsigned NOT NULL DEFAULT '2' COMMENT '1启用老师提现2否';");
}
if(!pdo_fieldexists("wx_school_tcourse", "allow_menu")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_tcourse")." ADD `allow_menu` tinyint(1) unsigned NOT NULL DEFAULT '2' COMMENT '1启用章节2否';");
}
if(!pdo_fieldexists("wx_school_tcourse", "allow_tuiguang")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_tcourse")." ADD `allow_tuiguang` tinyint(1) unsigned NOT NULL DEFAULT '2' COMMENT '1启用推广2否';");
}
if(!pdo_fieldexists("wx_school_tcourse", "kc_type")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_tcourse")." ADD `kc_type` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '1线上0线下';");
}
if(!pdo_fieldexists("wx_school_tcourse", "is_try")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_tcourse")." ADD `is_try` tinyint(1) unsigned NOT NULL DEFAULT '2' COMMENT '1试听2否';");
}
if(!pdo_fieldexists("wx_school_tcourse", "allow_pl")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_tcourse")." ADD `allow_pl` tinyint(1) unsigned NOT NULL DEFAULT '2' COMMENT '1评论2否';");
}
if(!pdo_fieldexists("wx_school_tcourse", "sale_type")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_tcourse")." ADD `sale_type` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '1团2助力0关闭';");
}
if(!pdo_fieldexists("wx_school_tcourse", "sale_id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_tcourse")." ADD `sale_id` int(10) unsigned NOT NULL COMMENT '营销设置ID';");
}
if(!pdo_fieldexists("wx_school_tcourse", "tg_id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_tcourse")." ADD `tg_id` int(10) unsigned NOT NULL COMMENT '推广设置ID';");
}
...
if(!pdo_fieldexists("wx_school_tcourse", "guigetype")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_tcourse")." ADD `guigetype` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0单规格1多规格';");
}
if(!pdo_fieldexists("wx_school_tcourse", "coupon")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_tcourse")." ADD `coupon` tinyint(1) NOT NULL DEFAULT '1' COMMENT '优惠券0开1关';");
}
if(!pdo_fieldexists("wx_school_tcourse", "redpacket")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_tcourse")." ADD `redpacket` tinyint(1) NOT NULL DEFAULT '1' COMMENT '红包0开1关';");
}
...
if(!pdo_fieldexists("wx_school_teachers", "cn")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_teachers")." ADD `cn` varchar(30) NOT NULL DEFAULT '0';");
}
...
if(!pdo_fieldexists("wx_school_teachers", "openid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_teachers")." ADD `openid` varchar(30) NOT NULL DEFAULT '0' COMMENT '教师微信';");
}
...
if(!pdo_fieldexists("wx_school_teachers", "lxvis")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_teachers")." ADD `lxvis` tinyint(1) NOT NULL DEFAULT '0' COMMENT '受访老师1开启0关闭';");
}
if(!pdo_fieldexists("wx_school_teachers", "lxdoorman")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_teachers")." ADD `lxdoorman` tinyint(1) NOT NULL DEFAULT '0' COMMENT '门卫1开启0关闭';");
}
if(!pdo_fieldexists("wx_school_teachers", "com")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_teachers")." ADD `com` int(11) unsigned NOT NULL;");
}
...
if(!pdo_fieldexists("wx_school_teachers", "xzf_datastatus")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_teachers")." ADD `xzf_datastatus` tinyint(1) DEFAULT '1';");
}
if(!pdo_fieldexists("wx_school_teachers", "xzf_needsync")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_teachers")." ADD `xzf_needsync` tinyint(1) DEFAULT '1';");
}
...
if(!pdo_fieldexists("wx_school_template_library", "name")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_template_library")." ADD `name` varchar(64) NOT NULL;");
}
...
if(!pdo_fieldexists("wx_school_template_library", "thumb")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_template_library")." ADD `thumb` varchar(1000) NOT NULL DEFAULT '' COMMENT '封面';");
}
...
if(!pdo_fieldexists("wx_school_template_library", "status")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_template_library")." ADD `status` tinyint(1) NOT NULL DEFAULT '1';");
}
...
if(!pdo_fieldexists("wx_school_template_library", "cate_id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_template_library")." ADD `cate_id` int(10) NOT NULL DEFAULT '0';");
}
...
if(!pdo_fieldexists("wx_school_timetable", "schoolid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_timetable")." ADD `schoolid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '分校id';");
}
...
if(!pdo_fieldexists("wx_school_timetable", "ishow")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_timetable")." ADD `ishow` int(1) NOT NULL DEFAULT '1' COMMENT '1:显示,2隐藏,默认1';");
}
...
if(!pdo_fieldexists("wx_school_todo", "ali_vod_id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_todo")." ADD `ali_vod_id` varchar(100) DEFAULT '' COMMENT '视频画面ID';");
}
...
if(!pdo_fieldexists("wx_school_upsence", "ali_vod_id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_upsence")." ADD `ali_vod_id` varchar(100) DEFAULT '' COMMENT '视频画面ID';");
}
...
if(!pdo_fieldexists("wx_school_user", "uid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_user")." ADD `uid` int(10) unsigned NOT NULL COMMENT '微擎系统memberID';");
}
...
if(!pdo_fieldexists("wx_school_user", "is_frist")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_user")." ADD `is_frist` tinyint(1) NOT NULL DEFAULT '1' COMMENT '1首次2不是';");
}
...
if(!pdo_fieldexists("wx_school_user", "superior_tid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_user")." ADD `superior_tid` int(10) unsigned NOT NULL COMMENT '招生tid';");
}
if(!pdo_fieldexists("wx_school_user", "com_from")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_user")." ADD `com_from` tinyint(1) DEFAULT '0' COMMENT '1营销0正常';");
}
if(!pdo_fieldexists("wx_school_user", "is_allow_video")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_user")." ADD `is_allow_video` tinyint(1) DEFAULT '1' COMMENT '1不允许2允许';");
}
if(!pdo_fieldexists("wx_school_user", "createtime")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_user")." ADD `createtime` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_user_class", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_user_class")." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("wx_school_user_class", "weid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_user_class")." ADD `weid` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_user_class", "schoolid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_user_class")." ADD `schoolid` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_user_class", "tid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_user_class")." ADD `tid` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_user_class", "sid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_user_class")." ADD `sid` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_user_class", "bj_id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_user_class")." ADD `bj_id` int(10) unsigned NOT NULL;");
}
if(!pdo_fieldexists("wx_school_user_class", "km_id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_user_class")." ADD `km_id` int(10) unsigned NOT NULL;");
}
...
if(!pdo_fieldexists("wx_school_welfare", "type")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_welfare")." ADD `type` tinyint(1) NOT NULL DEFAULT '1';");
}
...
if(!pdo_fieldexists("wx_school_welfarelog", "status")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_welfarelog")." ADD `status` tinyint(1) NOT NULL DEFAULT '0';");
}
...
if(!pdo_fieldexists("wx_school_wxpay", "kujx")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_wxpay")." ADD `kujx` varchar(30) NOT NULL DEFAULT '0' COMMENT '订单ID';");
}
...
if(!pdo_fieldexists("wx_school_yqdk", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_yqdk")." ADD `id` int(11) unsigned NOT NULL AUTO_INCREMENT;");
}
