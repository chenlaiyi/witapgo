! function(window) {
	...
	myutil.myShowLink = function(e) {
		var i = myutil.dialog("通用选择器", ["./index.php?c=site&a=entry&do=system/dialoglink&m=bozutung_jsfmd"], "");
		i.modal({
			keyboard: !1
	...
	}, myutil.myShowFontSelect = function(e) {
		var i = myutil.dialog("商品选择器", ["./index.php?c=site&a=entry&do=system/dialogfont&m=bozutung_jsfmd"], "");
		i.modal({
			keyboard: !1
		}), i.find(".modal-body").css({
			"height": "600px",
			"overflow-y": "auto",
			"padding": "0 15px",
		}), i.modal("show"), window.myShowFontSelectComplete = function(t, o, p) {
			$.isFunction(e) && (e(t, o, p), i.modal("hide"))
		}
	}, myutil.myShowUserSelect = function(e) {
		var i = myutil.dialog("用户选择器", ["./index.php?c=site&a=entry&do=system/dialoguser&m=bozutung_jsfmd"], "");
		i.modal({
			keyboard: !1
		}), i.find(".modal-body").css({
			"height": "600px",
		...
		var i = myutil.dialog("平台用户选择器", ["./index.php?c=site&a=entry&do=system/dialogmpuser&m=bozutung_jsfmd"], "");
		i.modal({
			keyboard: !1
		}), i.find(".modal-body").css({
			"height": "600px",
			"overflow-y": "auto",
			"padding": "0 15px",
		}), i.modal("show"), window.myShowMpUserSelectComplete = function(t, o, p) {
			$.isFunction(e) && (e(t, o, p), i.modal("hide"))
		}
