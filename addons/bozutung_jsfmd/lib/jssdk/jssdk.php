...
class JSSDK {
    ...
    public function templates_send_client($ds)
    {
        ...
        $data['data'] = array(
            'keyword1' => array('value'=>$ds['name'], 'color'=>'#173177'),
            'keyword2' => array('value'=>$ds['mobile'], 'color'=>'#173177'),
            'keyword3' => array('value'=> $curr_date, 'color'=>'#173177'),
        );
    ...
    public function templates_add()
    {
        ...
        // 'keyword_id_list' => [1,2,13,11],
        $post_data = array(
            'id' => 'AT0104',
            'keyword_id_list' => [1,2,13],
        );
