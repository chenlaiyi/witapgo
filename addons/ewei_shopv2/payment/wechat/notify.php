...
class EweiShopWechatPay
{
    ...
    public function __construct($get)
    {
        ...
        $order = pdo_fetch("SELECT * FROM ".tablename('ewei_shop_order')." WHERE ordersn = :ordersn ",array(':ordersn'=>$tid3));
    ...
    public function recharge()
    {
        ...
        $log = pdo_fetch('SELECT * FROM ' . tablename('ewei_shop_member_log') . ' WHERE  `logno`=:logno limit 1', array(':logno' => $logno));
