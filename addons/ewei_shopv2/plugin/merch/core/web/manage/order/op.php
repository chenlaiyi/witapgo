...
class Op_EweiShopV2Page extends MerchWebPage {
    ...
    function fetch() {
        ...
        /*$verify = pdo_fetch("select * from ".tablename('ewei_shop_order')." where id = :id and uniacid = :uniacid and merchid = :merchid ",array(':id'=>$item['id'],':uniacid'=>$_W['uniacid'],'merchid'=>$_W['merchid']));
