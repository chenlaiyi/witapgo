...
class Common_EweiShopV2Model
{
    ...
    public function unionpay_build($params, $unionpay, $type = 0){
        ...
        $data = pdo_fetch('SELECT * FROM ' . tablename('ewei_shop_payment') . ' WHERE id=:id', array(':id' => $data['weixin_id']));
    ...
    public function unionpay_jspay($params, $unionpay, $type = 0){
        ...
        pdo_update('ewei_shop_order', array("ordersn3"=>$tid), array('ordersn'=>trim($params["tid"])));
