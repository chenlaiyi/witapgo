                            ...
                            if ($refund["rtype"] == 2 || $refund["rtype"] == 1) {
                                if (0 < $order["merchid"]) {
                                    ...
                                    if (empty($raid)) {
                                        ...
                                        $salerefund = pdo_fetch("select * from " . tablename("ewei_shop_refund_address") . " where uniacid=:uniacid and id=:id limit 1", array(":uniacid" => $_W["uniacid"], ":id" => $raid));
                                    }
