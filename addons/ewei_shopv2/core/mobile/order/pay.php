...
class Pay_EweiShopV2Page extends MobileLoginPage
{
    ...
    public function main()
    {
        ...
        if( is_weixin() ) 
        {
            ...
            $datasss = pdo_fetch('SELECT * FROM ' . tablename('ewei_shop_payment') . ' WHERE id=:id', array(':id' => $datasss['weixin_id']));
            
            if($datasss['type']==5){
            
                pdo_update('ewei_shop_order', array('isunion' => 1), array('ordersn'=>$params['tid']));
