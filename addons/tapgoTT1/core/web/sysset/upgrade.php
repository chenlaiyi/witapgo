...
if ($op == 'display') {
	...
	if (!empty($path)) {
		...
		file_put_contents(IA_ROOT . '/addons/tapgo_ttv2/version.php', '<?php if(!defined(\'IN_IA\')) {exit(\'Access Denied\');}if(!defined(\'EWEI_SHOPV2_VERSION\')) {define(\'EWEI_SHOPV2_VERSION\', \'' . $upgrade['version'] . '\');}');
	...
	if ($op == 'checkversion') {
		file_put_contents(IA_ROOT . '/addons/tapgo_ttv2/version.php', '<?php if(!defined(\'IN_IA\')) {exit(\'Access Denied\');}if(!defined(\'EWEI_SHOPV2_VERSION\')) {define(\'EWEI_SHOPV2_VERSION\', \'1.0\');}');
