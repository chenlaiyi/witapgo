...
!(defined('EWEI_SHOPV2_PATH')) && define('EWEI_SHOPV2_PATH', IA_ROOT . '/addons/tapgo_ttv2/');
...
!(defined('EWEI_SHOPV2_URL')) && define('EWEI_SHOPV2_URL', $_W['siteroot'] . 'addons/tapgo_ttv2/');
!(defined('EWEI_SHOPV2_TASK_URL')) && define('EWEI_SHOPV2_TASK_URL', $_W['siteroot'] . 'addons/tapgo_ttv2/core/task/');
!(defined('EWEI_SHOPV2_LOCAL')) && define('EWEI_SHOPV2_LOCAL', '../addons/tapgo_ttv2/');
!(defined('EWEI_SHOPV2_STATIC')) && define('EWEI_SHOPV2_STATIC', EWEI_SHOPV2_URL . 'static/');
!(defined('EWEI_SHOPV2_PREFIX')) && define('EWEI_SHOPV2_PREFIX', 'tapgo_tt_');
define("EWEI_SHOPV2_AUTH_WXAPP","http://renren.weapp.cc/");
define('EWEI_SHOPV2_PLACEHOLDER', '../addons/tapgo_ttv2/static/images/placeholder.png');
