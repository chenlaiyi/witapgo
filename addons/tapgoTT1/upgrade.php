...
@unlink( IA_ROOT.'/addons/tapgo_TT/plugin/app/core/mobile/bargain/c.json');
@unlink( IA_ROOT.'/addons/tapgo_TT/plugin/app/static/images/wxcode.jpg');
@unlink( IA_ROOT.'/addons/tapgo_TT/plugin/app/static/images/wxcode_1.jpg');
@unlink( IA_ROOT.'/addons/tapgo_TT/plugin/app/static/images/wxcode_2.jpg');
@unlink( IA_ROOT.'/addons/tapgo_TT/plugin/app/core/wxapp/wxappOpemCrypt.php');
@unlink( IA_ROOT.'/addons/tapgo_TT/plugin/app/core/wxapp/WxpayAPI.class.php');
@unlink( IA_ROOT.'/addons/tapgo_TT/core/web/system/auth/index1.php');
@unlink( IA_ROOT.'/addons/tapgo_TT/plugin/wxlive/core/form.php');
