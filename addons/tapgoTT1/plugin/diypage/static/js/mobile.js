define(['core', 'tpl'], function (core, tpl) {
    ...
    modal.initSwiper = function () {
        ...
        if($('[data-toggle="timer"]').length>0){
            require(['../addons/tapgo_ttv2/plugin/seckill/static/js/timer.js'],function(timerUtil){
                ...
                if (result.status == 1) {
                    ...
                    if (list) {
                        ...
                        $.each(list, function (id, merch) {
                            var thumb = merch.thumb ? merch.thumb : '../addons/tapgo_ttv2/plugin/diypage/static/images/default/logo.jpg';
                            var html = '';
                ...
                $.get(core.getUrl('diypage/getInfo'),{url:url,num:num,paramsType:'goods'},function(ret){
                    ...
                    if(ret.status == 1){
                        ...
                        $.each(list,function(id,item){
                            ...
                            if(item.total <= 0){
                                html += '<div class="salez diy" style="background-image: url(\'../addons/tapgo_ttv2/static/images/shouqin.png\'); "></div>';
                            }
                            html += '</div>';
