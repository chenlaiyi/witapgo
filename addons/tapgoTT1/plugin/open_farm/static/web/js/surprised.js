        ...
        function ($scope, $http, $compile, $controller, $sce, $interval) {
            ...
            $scope.function = {
                'get_category': function () {
                    $http.get(
                        url = "/web/index.php?c=site&a=entry&m=tapgo_ttv2&do=web&r=open_farm.surprised.getCategory"
                    ).then(
                        function (result) {
                ...
                'get_list': function (url, page) {
                    if (!url) {
                        url = "/web/index.php?c=site&a=entry&m=tapgo_ttv2&do=web&r=open_farm.surprised.getList&page=1"
                    }
                    if (page) {
                ...
                'add_surprised': function () {
                    ...
                    $http.post(
                        '/web/index.php?c=site&a=entry&m=tapgo_ttv2&do=web&r=open_farm.surprised.addInfo',
                        $scope.data.surprised_info
                    ).then(
                        function (result) {
                ...
                'delete_surprised': function (id) {
                    if (confirm('确定要删除该彩蛋吗?')) {
                        $http.post(
                            '/web/index.php?c=site&a=entry&m=tapgo_ttv2&do=web&r=open_farm.surprised.deleteInfo',
                            {
                                'id': id
                            }
                        ).then(
                ...
                'delete_all_surprised': function (id) {
                    if (confirm('确定要删除该彩蛋吗?')) {
                        $http.post(
                            '/web/index.php?c=site&a=entry&m=tapgo_ttv2&do=web&r=open_farm.surprised.deleteAll',
                            {
                                'ids': id
                            }
                        ).then(
            ...
            $scope.function.get_list("/web/index.php?c=site&a=entry&m=tapgo_ttv2&do=web&r=open_farm.surprised.getList&page=1");
