        ...
        function ($scope, $http, $compile, $controller, $sce, $interval) {
            ...
            $scope.function = {
                ...
                'get_list': function (url, page) {
                    if (!url) {
                        url = "/web/index.php?c=site&a=entry&m=tapgo_ttv2&do=web&r=open_farm.reply.getList&page=1"
                    }
                    if (page) {
                ...
                'add_reply': function () {
                    ...
                    $http.post(
                        '/web/index.php?c=site&a=entry&m=tapgo_ttv2&do=web&r=open_farm.reply.addInfo',
                        $scope.data.reply_info
                    ).then(
                        function (result) {
                ...
                'delete_reply': function (id) {
                    if (confirm('确定要删除该回复吗?')) {
                        $http.post(
                            '/web/index.php?c=site&a=entry&m=tapgo_ttv2&do=web&r=open_farm.reply.deleteInfo',
                            {
                                'id': id
                            }
                        ).then(
            ...
            $scope.function.get_list("/web/index.php?c=site&a=entry&m=tapgo_ttv2&do=web&r=open_farm.reply.getList&page=1");
