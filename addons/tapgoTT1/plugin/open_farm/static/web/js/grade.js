        ...
        function ($scope, $http, $compile, $controller, $sce, $interval) {
            ...
            $scope.function = {
                ...
                'get_list': function (url, page) {
                    ...
                    if (!url) {
                        url = "/web/index.php?c=site&a=entry&m=tapgo_ttv2&do=web&r=open_farm.grade.getList"
                    }
                    $http.post(
                        url,
                        $scope.data.where
                ...
                'add_grade': function () {
                    $http.post(
                        '/web/index.php?c=site&a=entry&m=tapgo_ttv2&do=web&r=open_farm.grade.addInfo',
                ...
                'save_info': function () {
                    $http.post(
                        '/web/index.php?c=site&a=entry&m=tapgo_ttv2&do=web&r=open_farm.grade.saveInfo',
                ...
                'delete_info': function (id) {
                    $http.post(
                        '/web/index.php?c=site&a=entry&m=tapgo_ttv2&do=web&r=open_farm.grade.deleteInfo',
                        {
                            id: id
                        }
                    ).then(
            ...
            $scope.function.get_list("/web/index.php?c=site&a=entry&m=tapgo_ttv2&do=web&r=open_farm.grade.getList");
        }
    ]
);