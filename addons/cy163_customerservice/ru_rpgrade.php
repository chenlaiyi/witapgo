...
CREATE TABLE IF NOT EXISTS `ims_messikefu_chat` (
  ...
  `yyzming` tinyint(1) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=25574 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE IF NOT EXISTS `ims_messikefu_cservice` (
  ...
  `qrmsg` text NOT NULL,
  `jhtext` varchar(30) NOT NULL,
  `lyon` tinyint(1) NOT NULL,
  `lytitle` varchar(30) NOT NULL,
  `nowjdnumbasic` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ims_messikefu_fanskefu` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=12122 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
) ENGINE=MyISAM AUTO_INCREMENT=23418 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE IF NOT EXISTS `ims_messikefu_kefuandgroup` (
  ...
  `groupid` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=98 DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED;
...
CREATE TABLE IF NOT EXISTS `ims_messikefu_liuyan` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `weid` int(11) NOT NULL,
  `openid` varchar(100) NOT NULL,
  `kefuopenid` varchar(100) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ims_messikefu_lyfield` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `weid` int(11) DEFAULT '0',
  `openid` varchar(50) NOT NULL,
  `name` varchar(50) NOT NULL,
  `ftype` varchar(20) NOT NULL,
  `yushe` varchar(100) NOT NULL,
  `isneed` tinyint(1) NOT NULL,
  `isimg` tinyint(1) NOT NULL,
  `fname` varchar(30) NOT NULL,
  `displayorder` int(11) NOT NULL,
  `neizhi` text NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `ims_messikefu_xcxchat` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1284 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
if(!pdo_fieldexists("messikefu_adv", "endtime")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_adv")." ADD `endtime` int(11) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_adv", "isdadi")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_adv")." ADD `isdadi` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_adv", "groupid")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_adv")." ADD `groupid` int(11) NOT NULL;");
}
...
if(!pdo_fieldexists("messikefu_biaoqian", "realname")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_biaoqian")." ADD `realname` varchar(50) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_biaoqian", "telphone")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_biaoqian")." ADD `telphone` varchar(50) NOT NULL;");
}
...
if(!pdo_fieldexists("messikefu_chat", "content")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_chat")." ADD `content` text NOT NULL;");
}
...
if(!pdo_fieldexists("messikefu_chat", "fansdel")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_chat")." ADD `fansdel` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_chat", "kefudel")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_chat")." ADD `kefudel` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_chat", "isck")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_chat")." ADD `isck` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_chat", "mp3du")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_chat")." ADD `mp3du` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_chat", "istuwen")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_chat")." ADD `istuwen` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_chat", "yyzming")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_chat")." ADD `yyzming` tinyint(1) NOT NULL;");
}
...
if(!pdo_fieldexists("messikefu_cservice", "isgly")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_cservice")." ADD `isgly` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_cservice", "iszx")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_cservice")." ADD `iszx` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_cservice", "isrealzx")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_cservice")." ADD `isrealzx` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_cservice", "username")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_cservice")." ADD `username` varchar(50) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_cservice", "pwd")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_cservice")." ADD `pwd` varchar(50) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_cservice", "djkey")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_cservice")." ADD `djkey` varchar(30) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_cservice", "isxingqi")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_cservice")." ADD `isxingqi` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_cservice", "day1")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_cservice")." ADD `day1` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_cservice", "day2")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_cservice")." ADD `day2` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_cservice", "day3")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_cservice")." ADD `day3` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_cservice", "day4")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_cservice")." ADD `day4` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_cservice", "day5")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_cservice")." ADD `day5` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_cservice", "day6")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_cservice")." ADD `day6` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_cservice", "day7")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_cservice")." ADD `day7` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_cservice", "beibang")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_cservice")." ADD `beibang` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_cservice", "bdchat")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_cservice")." ADD `bdchat` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_cservice", "cangzh")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_cservice")." ADD `cangzh` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_cservice", "gzhqzval")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_cservice")." ADD `gzhqzval` int(11) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_cservice", "gzhqzval2")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_cservice")." ADD `gzhqzval2` int(11) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_cservice", "nowfkid")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_cservice")." ADD `nowfkid` int(11) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_cservice", "nowjdnum")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_cservice")." ADD `nowjdnum` int(11) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_cservice", "ispczx")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_cservice")." ADD `ispczx` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_cservice", "autoreplyimg")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_cservice")." ADD `autoreplyimg` varchar(200) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_cservice", "qrmsg")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_cservice")." ADD `qrmsg` text NOT NULL;");
}
if(!pdo_fieldexists("messikefu_cservice", "jhtext")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_cservice")." ADD `jhtext` varchar(30) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_cservice", "lyon")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_cservice")." ADD `lyon` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_cservice", "lytitle")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_cservice")." ADD `lytitle` varchar(30) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_cservice", "nowjdnumbasic")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_cservice")." ADD `nowjdnumbasic` int(11) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_cservice", "telphone")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_cservice")." ADD `telphone` varchar(30) NOT NULL;");
}
...
if(!pdo_fieldexists("messikefu_cservicegroup", "sanbs")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_cservicegroup")." ADD `sanbs` varchar(50) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_cservicegroup", "sanremark")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_cservicegroup")." ADD `sanremark` varchar(200) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_cservicegroup", "bsid")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_cservicegroup")." ADD `bsid` int(11) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_cservicegroup", "qrright")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_cservicegroup")." ADD `qrright` int(11) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_cservicegroup", "qrbottom")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_cservicegroup")." ADD `qrbottom` int(11) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_cservicegroup", "fid")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_cservicegroup")." ADD `fid` int(11) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_cservicegroup", "notext")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_cservicegroup")." ADD `notext` varchar(100) NOT NULL;");
}
...
if(!pdo_fieldexists("messikefu_fanskefu", "ishei")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_fanskefu")." ADD `ishei` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_fanskefu", "fansdel")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_fanskefu")." ADD `fansdel` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_fanskefu", "kefudel")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_fanskefu")." ADD `kefudel` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_fanskefu", "fszx")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_fanskefu")." ADD `fszx` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_fanskefu", "kfzx")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_fanskefu")." ADD `kfzx` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_fanskefu", "isxcx")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_fanskefu")." ADD `isxcx` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_fanskefu", "bdopenid")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_fanskefu")." ADD `bdopenid` varchar(100) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_fanskefu", "fangke")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_fanskefu")." ADD `fangke` text NOT NULL;");
}
if(!pdo_fieldexists("messikefu_fanskefu", "nowjd")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_fanskefu")." ADD `nowjd` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_fanskefu", "jdtime")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_fanskefu")." ADD `jdtime` int(11) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_fanskefu", "wherefrom")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_fanskefu")." ADD `wherefrom` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_fanskefu", "goodsmsg")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_fanskefu")." ADD `goodsmsg` text NOT NULL;");
}
if(!pdo_fieldexists("messikefu_fanskefu", "intime")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_fanskefu")." ADD `intime` int(11) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_fromck", "id")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_fromck")." ADD `id` int(11) NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("messikefu_fromck", "weid")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_fromck")." ADD `weid` int(11) DEFAULT '0';");
}
if(!pdo_fieldexists("messikefu_fromck", "msgid")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_fromck")." ADD `msgid` varchar(100);");
}
...
if(!pdo_fieldexists("messikefu_group", "autotx")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_group")." ADD `autotx` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_group", "isfs")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_group")." ADD `isfs` tinyint(1) NOT NULL;");
}
...
if(!pdo_fieldexists("messikefu_groupchat", "content")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_groupchat")." ADD `content` text NOT NULL;");
}
...
if(!pdo_fieldexists("messikefu_groupmember", "txkaiguan")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_groupmember")." ADD `txkaiguan` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_groupmember", "isdel")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_groupmember")." ADD `isdel` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_groupmember", "isjin")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_groupmember")." ADD `isjin` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_groupvoicedu", "id")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_groupvoicedu")." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("messikefu_groupvoicedu", "weid")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_groupvoicedu")." ADD `weid` int(11) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_groupvoicedu", "groupid")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_groupvoicedu")." ADD `groupid` int(11) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_groupvoicedu", "gchatid")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_groupvoicedu")." ADD `gchatid` int(11) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_groupvoicedu", "openid")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_groupvoicedu")." ADD `openid` varchar(200) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_groupvoicedu", "content")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_groupvoicedu")." ADD `content` varchar(200) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_groupvoicedu", "time")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_groupvoicedu")." ADD `time` int(11) NOT NULL;");
}
...
if(!pdo_fieldexists("messikefu_kefuandcjwt", "id")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_kefuandcjwt")." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("messikefu_kefuandcjwt", "weid")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_kefuandcjwt")." ADD `weid` int(11) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_kefuandcjwt", "kefuid")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_kefuandcjwt")." ADD `kefuid` int(11) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_kefuandcjwt", "wtid")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_kefuandcjwt")." ADD `wtid` int(11) NOT NULL;");
}
...
if(!pdo_fieldexists("messikefu_kuaijie", "id")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_kuaijie")." ADD `id` int(11) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("messikefu_kuaijie", "weid")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_kuaijie")." ADD `weid` int(11) DEFAULT '0';");
}
if(!pdo_fieldexists("messikefu_kuaijie", "kjtype")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_kuaijie")." ADD `kjtype` tinyint(1) DEFAULT '0';");
}
if(!pdo_fieldexists("messikefu_kuaijie", "con")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_kuaijie")." ADD `con` varchar(255) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_kuaijie", "thumb")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_kuaijie")." ADD `thumb` varchar(255) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_kuaijie", "kfid")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_kuaijie")." ADD `kfid` int(11) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_kuaijie", "allcon")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_kuaijie")." ADD `allcon` text NOT NULL;");
}
if(!pdo_fieldexists("messikefu_kuaijie", "displayorder")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_kuaijie")." ADD `displayorder` int(11) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_liuyan", "id")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_liuyan")." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("messikefu_liuyan", "weid")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_liuyan")." ADD `weid` int(11) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_liuyan", "openid")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_liuyan")." ADD `openid` varchar(100) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_liuyan", "kefuopenid")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_liuyan")." ADD `kefuopenid` varchar(100) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_liuyan", "content")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_liuyan")." ADD `content` text NOT NULL;");
}
if(!pdo_fieldexists("messikefu_liuyan", "time")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_liuyan")." ADD `time` int(11) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_liuyan", "realname")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_liuyan")." ADD `realname` varchar(50) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_liuyan", "telphone")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_liuyan")." ADD `telphone` varchar(50) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_liuyan", "wxh")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_liuyan")." ADD `wxh` varchar(30) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_liuyan", "readstatus")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_liuyan")." ADD `readstatus` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_liuyan", "autotext")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_liuyan")." ADD `autotext` text NOT NULL;");
}
if(!pdo_fieldexists("messikefu_lyfield", "id")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_lyfield")." ADD `id` int(11) NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("messikefu_lyfield", "weid")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_lyfield")." ADD `weid` int(11) DEFAULT '0';");
}
if(!pdo_fieldexists("messikefu_lyfield", "openid")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_lyfield")." ADD `openid` varchar(50) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_lyfield", "name")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_lyfield")." ADD `name` varchar(50) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_lyfield", "ftype")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_lyfield")." ADD `ftype` varchar(20) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_lyfield", "yushe")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_lyfield")." ADD `yushe` varchar(100) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_lyfield", "isneed")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_lyfield")." ADD `isneed` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_lyfield", "isimg")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_lyfield")." ADD `isimg` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_lyfield", "fname")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_lyfield")." ADD `fname` varchar(30) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_lyfield", "displayorder")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_lyfield")." ADD `displayorder` int(11) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_lyfield", "neizhi")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_lyfield")." ADD `neizhi` text NOT NULL;");
}
...
if(!pdo_fieldexists("messikefu_sanchat", "content")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_sanchat")." ADD `content` text NOT NULL;");
}
...
if(!pdo_fieldexists("messikefu_set", "suiji")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_set")." ADD `suiji` tinyint(1) NOT NULL;");
}
...
if(!pdo_fieldexists("messikefu_set", "qdgly")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_set")." ADD `qdgly` text NOT NULL;");
}
...
if(!pdo_fieldexists("messikefu_tplmessage_sendlog", "tpl_id")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_tplmessage_sendlog")." ADD `tpl_id` int(11);");
}
if(!pdo_fieldexists("messikefu_tplmessage_sendlog", "tpl_title")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_tplmessage_sendlog")." ADD `tpl_title` varchar(50);");
}
if(!pdo_fieldexists("messikefu_tplmessage_sendlog", "message")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_tplmessage_sendlog")." ADD `message` text;");
}
if(!pdo_fieldexists("messikefu_tplmessage_sendlog", "success")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_tplmessage_sendlog")." ADD `success` int(11) DEFAULT '0';");
}
if(!pdo_fieldexists("messikefu_tplmessage_sendlog", "fail")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_tplmessage_sendlog")." ADD `fail` int(11) DEFAULT '0';");
}
if(!pdo_fieldexists("messikefu_tplmessage_sendlog", "time")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_tplmessage_sendlog")." ADD `time` int(11);");
}
if(!pdo_fieldexists("messikefu_tplmessage_sendlog", "uniacid")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_tplmessage_sendlog")." ADD `uniacid` int(5);");
}
if(!pdo_fieldexists("messikefu_tplmessage_sendlog", "type")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_tplmessage_sendlog")." ADD `type` int(5) DEFAULT '0';");
}
if(!pdo_fieldexists("messikefu_tplmessage_sendlog", "target")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_tplmessage_sendlog")." ADD `target` varchar(80) DEFAULT '';");
}
if(!pdo_fieldexists("messikefu_tplmessage_sendlog", "status")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_tplmessage_sendlog")." ADD `status` int(2) DEFAULT '0';");
}
if(!pdo_fieldexists("messikefu_tplmessage_sendlog", "error")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_tplmessage_sendlog")." ADD `error` text;");
}
if(!pdo_fieldexists("messikefu_tplmessage_sendlog", "mid")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_tplmessage_sendlog")." ADD `mid` int(11);");
}
...
if(!pdo_fieldexists("messikefu_tplmessage_tpllist", "tpl_id")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_tplmessage_tpllist")." ADD `tpl_id` varchar(80);");
}
if(!pdo_fieldexists("messikefu_tplmessage_tpllist", "tpl_title")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_tplmessage_tpllist")." ADD `tpl_title` varchar(20);");
}
if(!pdo_fieldexists("messikefu_tplmessage_tpllist", "tpl_key")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_tplmessage_tpllist")." ADD `tpl_key` varchar(500);");
}
if(!pdo_fieldexists("messikefu_tplmessage_tpllist", "tpl_example")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_tplmessage_tpllist")." ADD `tpl_example` varchar(500);");
}
if(!pdo_fieldexists("messikefu_tplmessage_tpllist", "uniacid")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_tplmessage_tpllist")." ADD `uniacid` int(5);");
}
if(!pdo_fieldexists("messikefu_wenzhang", "id")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_wenzhang")." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("messikefu_wenzhang", "weid")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_wenzhang")." ADD `weid` int(11) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_wenzhang", "title")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_wenzhang")." ADD `title` varchar(200) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_wenzhang", "des")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_wenzhang")." ADD `des` text NOT NULL;");
}
if(!pdo_fieldexists("messikefu_wenzhang", "views")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_wenzhang")." ADD `views` int(11) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_wenzhang", "addtime")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_wenzhang")." ADD `addtime` int(11) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_wenzhang", "paixu")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_wenzhang")." ADD `paixu` int(11) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_wenzhang", "url")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_wenzhang")." ADD `url` varchar(200) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcx", "id")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcx")." ADD `id` int(11) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("messikefu_xcx", "uniacid")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcx")." ADD `uniacid` int(11);");
}
if(!pdo_fieldexists("messikefu_xcx", "name")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcx")." ADD `name` varchar(30);");
}
if(!pdo_fieldexists("messikefu_xcx", "gh_id")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcx")." ADD `gh_id` varchar(30);");
}
if(!pdo_fieldexists("messikefu_xcx", "appid")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcx")." ADD `appid` varchar(30);");
}
if(!pdo_fieldexists("messikefu_xcx", "secret")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcx")." ADD `secret` varchar(50);");
}
if(!pdo_fieldexists("messikefu_xcx", "token")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcx")." ADD `token` varchar(50);");
}
if(!pdo_fieldexists("messikefu_xcx", "aeskey")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcx")." ADD `aeskey` varchar(50);");
}
if(!pdo_fieldexists("messikefu_xcx", "url")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcx")." ADD `url` varchar(200);");
}
if(!pdo_fieldexists("messikefu_xcx", "access_token")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcx")." ADD `access_token` text NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcx", "guoqitime")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcx")." ADD `guoqitime` int(11) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcx", "status")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcx")." ADD `status` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcx", "admins")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcx")." ADD `admins` varchar(100) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcx", "btnsession")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcx")." ADD `btnsession` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxauto", "id")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxauto")." ADD `id` int(11) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("messikefu_xcxauto", "weid")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxauto")." ADD `weid` int(11);");
}
if(!pdo_fieldexists("messikefu_xcxauto", "kfid")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxauto")." ADD `kfid` int(11) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxauto", "name")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxauto")." ADD `name` varchar(30);");
}
if(!pdo_fieldexists("messikefu_xcxauto", "msgtype")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxauto")." ADD `msgtype` varchar(30) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxauto", "pagepath")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxauto")." ADD `pagepath` varchar(100) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxauto", "pagethumb")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxauto")." ADD `pagethumb` varchar(255) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxauto", "title")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxauto")." ADD `title` varchar(100) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxauto", "description")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxauto")." ADD `description` varchar(100) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxauto", "url")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxauto")." ADD `url` varchar(200) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxauto", "thumb_url")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxauto")." ADD `thumb_url` varchar(200) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxauto", "thumb")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxauto")." ADD `thumb` varchar(255) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxauto", "paixu")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxauto")." ADD `paixu` int(11) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxauto", "iszdhf")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxauto")." ADD `iszdhf` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxauto", "zdhftitle")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxauto")." ADD `zdhftitle` varchar(100) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxauto", "zdhftype")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxauto")." ADD `zdhftype` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxchat", "id")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxchat")." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("messikefu_xcxchat", "weid")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxchat")." ADD `weid` int(11) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxchat", "openid")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxchat")." ADD `openid` varchar(100) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxchat", "toopenid")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxchat")." ADD `toopenid` varchar(100) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxchat", "content")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxchat")." ADD `content` text NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxchat", "time")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxchat")." ADD `time` int(11) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxchat", "msgtype")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxchat")." ADD `msgtype` varchar(50) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxchat", "fkid")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxchat")." ADD `fkid` int(11) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxchat", "gh_id")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxchat")." ADD `gh_id` varchar(50) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxchat", "msgid")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxchat")." ADD `msgid` varchar(50) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxchat", "mediaId")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxchat")." ADD `mediaId` varchar(100) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxchat", "title")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxchat")." ADD `title` varchar(100) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxchat", "description")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxchat")." ADD `description` varchar(255) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxchat", "url")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxchat")." ADD `url` varchar(255) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxchat", "thumb_url")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxchat")." ADD `thumb_url` varchar(255) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxcservice", "id")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxcservice")." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("messikefu_xcxcservice", "weid")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxcservice")." ADD `weid` int(11) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxcservice", "name")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxcservice")." ADD `name` varchar(50) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxcservice", "content")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxcservice")." ADD `content` varchar(100) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxcservice", "thumb")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxcservice")." ADD `thumb` varchar(255) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxcservice", "displayorder")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxcservice")." ADD `displayorder` int(11) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxcservice", "kefuauto")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxcservice")." ADD `kefuauto` text NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxcservice", "isautosub")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxcservice")." ADD `isautosub` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxcservice", "xcxid")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxcservice")." ADD `xcxid` int(11) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxcservice", "jhtext")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxcservice")." ADD `jhtext` varchar(50) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxcservice", "jhname")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxcservice")." ADD `jhname` varchar(100) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxcservice", "autoreply")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxcservice")." ADD `autoreply` varchar(100) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxcservice", "gzhqzval")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxcservice")." ADD `gzhqzval` int(11) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxcservice", "lingjie")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxcservice")." ADD `lingjie` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxcservice", "starthour")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxcservice")." ADD `starthour` smallint(6) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxcservice", "endhour")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxcservice")." ADD `endhour` smallint(6) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxcservice", "isxingqi")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxcservice")." ADD `isxingqi` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxcservice", "day1")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxcservice")." ADD `day1` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxcservice", "day2")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxcservice")." ADD `day2` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxcservice", "day3")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxcservice")." ADD `day3` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxcservice", "day4")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxcservice")." ADD `day4` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxcservice", "day5")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxcservice")." ADD `day5` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxcservice", "day6")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxcservice")." ADD `day6` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxcservice", "day7")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxcservice")." ADD `day7` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxfanskefu", "id")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxfanskefu")." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("messikefu_xcxfanskefu", "weid")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxfanskefu")." ADD `weid` int(11) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxfanskefu", "fansopenid")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxfanskefu")." ADD `fansopenid` varchar(100) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxfanskefu", "kefuopenid")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxfanskefu")." ADD `kefuopenid` varchar(100) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxfanskefu", "fansavatar")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxfanskefu")." ADD `fansavatar` varchar(200) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxfanskefu", "kefuavatar")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxfanskefu")." ADD `kefuavatar` varchar(200) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxfanskefu", "fansnickname")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxfanskefu")." ADD `fansnickname` varchar(100) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxfanskefu", "kefunickname")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxfanskefu")." ADD `kefunickname` varchar(100) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxfanskefu", "lasttime")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxfanskefu")." ADD `lasttime` int(11) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxfanskefu", "notread")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxfanskefu")." ADD `notread` int(11) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxfanskefu", "lastcon")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxfanskefu")." ADD `lastcon` varchar(255) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxfanskefu", "msgtype")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxfanskefu")." ADD `msgtype` varchar(30) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxfanskefu", "gh_id")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxfanskefu")." ADD `gh_id` varchar(50) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxfanskefu", "createtime")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxfanskefu")." ADD `createtime` int(11) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxfanskefu", "sessionfrom")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxfanskefu")." ADD `sessionfrom` varchar(100) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxfanskefu", "huifunum")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxfanskefu")." ADD `huifunum` int(11) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_xcxfanskefu", "nowkefu")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcxfanskefu")." ADD `nowkefu` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_zdhf", "id")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_zdhf")." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("messikefu_zdhf", "weid")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_zdhf")." ADD `weid` int(11) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_zdhf", "title")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_zdhf")." ADD `title` varchar(200) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_zdhf", "content")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_zdhf")." ADD `content` text NOT NULL;");
}
if(!pdo_fieldexists("messikefu_zdhf", "type")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_zdhf")." ADD `type` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_zdhf", "paixu")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_zdhf")." ADD `paixu` int(11) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_zdhf", "hftype")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_zdhf")." ADD `hftype` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_zdhf", "imgcon")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_zdhf")." ADD `imgcon` varchar(200) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_zdhf", "allcon")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_zdhf")." ADD `allcon` text NOT NULL;");
}
if(!pdo_fieldexists("messikefu_zdhf", "kefuids")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_zdhf")." ADD `kefuids` text NOT NULL;");
}
if(!pdo_fieldexists("messikefu_zhuizong", "id")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_zhuizong")." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("messikefu_zhuizong", "weid")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_zhuizong")." ADD `weid` int(11) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_zhuizong", "kefuopenid")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_zhuizong")." ADD `kefuopenid` varchar(200) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_zhuizong", "kefuname")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_zhuizong")." ADD `kefuname` varchar(50) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_zhuizong", "kefuavatar")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_zhuizong")." ADD `kefuavatar` varchar(200) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_zhuizong", "fansopenid")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_zhuizong")." ADD `fansopenid` varchar(200) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_zhuizong", "fansavatar")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_zhuizong")." ADD `fansavatar` varchar(200) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_zhuizong", "fansname")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_zhuizong")." ADD `fansname` varchar(50) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_zhuizong", "content")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_zhuizong")." ADD `content` text NOT NULL;");
}
if(!pdo_fieldexists("messikefu_zhuizong", "time")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_zhuizong")." ADD `time` int(11) NOT NULL;");
}
if(!pdo_fieldexists("messikefu_zhuizong", "zztype")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_zhuizong")." ADD `zztype` tinyint(1) NOT NULL;");
}
