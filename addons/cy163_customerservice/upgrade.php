...
if(!pdo_fieldexists('messikefu_group','isdel')) {pdo_query("ALTER TABLE ".tablename('messikefu_group')." ADD   `isdel` tinyint(1) NOT NULL");}
...
if(!pdo_fieldexists('messikefu_set','qdgly')) {pdo_query("ALTER TABLE ".tablename('messikefu_set')." ADD   `qdgly` text NOT NULL");}
