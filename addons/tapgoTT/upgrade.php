...
INSERT INTO `ims_tapgo_tt_express` (`id`, `name`, `express`, `status`, `displayorder`, `code`, `coding`) VALUES 
...
INSERT INTO `ims_tapgo_tt_exhelper_esheet` (`id`, `name`, `express`, `code`, `datas`) VALUES
...
INSERT INTO `ims_tapgo_tt_member_message_template_type` (`id`, `name`, `typecode`, `templatecode`, `templateid`, `templatename`, `content`, `typegroup`, `groupname`, `showtotaladd`) VALUES
...
CREATE TABLE IF NOT EXISTS `ims_tapgo_tt_plugin` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `ims_tapgo_tt_plugin` (`id`, `displayorder`, `identity`, `category`, `name`, `version`, `author`, `status`, `thumb`, `desc`, `iscom`, `deprecated`, `isv2`) VALUES
(1, 1, 'qiniu', 'tool', '七牛存储', '1.0', '官方', 1, '../addons/tapgo_ttv2/static/images/qiniu.jpg', NULL, 1, 0, 0),
(2, 2, 'taobao', 'tool', '商品助手', '1.0', '官方', 1, '../addons/tapgo_ttv2/static/images/taobao.jpg', '', 0, 0, 0),
(3, 3, 'commission', 'biz', '人人分销', '1.0', '官方', 1, '../addons/tapgo_ttv2/static/images/commission.jpg', '', 0, 0, 0),
(4, 4, 'poster', 'sale', '超级海报', '1.2', '官方', 1, '../addons/tapgo_ttv2/static/images/poster.jpg', '', 0, 0, 0),
(5, 5, 'verify', 'biz', 'O2O核销', '1.0', '官方', 1, '../addons/tapgo_ttv2/static/images/verify.jpg', NULL, 1, 0, 0),
(6, 6, 'tmessage', 'tool', '会员群发', '1.0', '官方', 1, '../addons/tapgo_ttv2/static/images/tmessage.jpg', NULL, 1, 0, 0),
(7, 7, 'perm', 'help', '分权系统', '1.0', '官方', 1, '../addons/tapgo_ttv2/static/images/perm.jpg', NULL, 1, 0, 0),
(8, 8, 'sale', 'sale', '营销宝', '1.0', '官方', 1, '../addons/tapgo_ttv2/static/images/sale.jpg', NULL, 1, 0, 0),
(9, 9, 'designer', 'help', '店铺装修V1', '1.0', '官方', 1, '../addons/tapgo_ttv2/static/images/designer.jpg', NULL, 0, 1, 0),
(10, 10, 'creditshop', 'biz', '积分商城', '1.0', '官方', 1, '../addons/tapgo_ttv2/static/images/creditshop.jpg', '', 0, 0, 0),
(11, 11, 'virtual', 'biz', '虚拟物品', '1.0', '官方', 1, '../addons/tapgo_ttv2/static/images/virtual.jpg', NULL, 1, 0, 0),
(12, 11, 'article', 'help', '文章营销', '1.0', '官方', 1, '../addons/tapgo_ttv2/static/images/article.jpg', '', 0, 0, 0),
(13, 13, 'coupon', 'sale', '超级券', '1.0', '官方', 1, '../addons/tapgo_ttv2/static/images/coupon.jpg', NULL, 1, 0, 0),
(14, 14, 'postera', 'sale', '活动海报', '1.0', '官方', 1, '../addons/tapgo_ttv2/static/images/postera.jpg', '', 0, 0, 0),
(15, 16, 'system', 'help', '系统工具', '1.0', '官方', 0, '../addons/tapgo_ttv2/static/images/system.jpg', NULL, 0, 1, 0),
(16, 15, 'diyform', 'help', '自定表单', '1.0', '官方', 1, '../addons/tapgo_ttv2/static/images/diyform.jpg', '', 0, 0, 0),
(17, 16, 'exhelper', 'help', '快递助手', '1.0', '官方', 1, '../addons/tapgo_ttv2/static/images/exhelper.jpg', '', 0, 0, 0),
(18, 19, 'groups', 'biz', '人人拼团', '1.0', '官方', 1, '../addons/tapgo_ttv2/static/images/groups.jpg', '', 0, 0, 0),
(19, 20, 'diypage', 'help', '店铺装修', '2.0', '官方', 1, '../addons/tapgo_ttv2/static/images/designer.jpg', '', 0, 0, 0),
(20, 22, 'globonus', 'biz', '全民股东', '1.0', '官方', 1, '../addons/tapgo_ttv2/static/images/globonus.jpg', '', 0, 0, 0),
(21, 23, 'merch', 'biz', '多商户', '1.0', '官方', 1, '../addons/tapgo_ttv2/static/images/merch.jpg', '', 0, 0, 1),
(22, 26, 'qa', 'help', '帮助中心', '1.0', '官方', 1, '../addons/tapgo_ttv2/static/images/qa.jpg', '', 0, 0, 1),
(24, 27, 'sms', 'tool', '短信提醒', '1.0', '官方', 1, '../addons/tapgo_ttv2/static/images/sms.jpg', '', 1, 0, 1),
(25, 29, 'sign', 'tool', '积分签到', '1.0', '官方', 1, '../addons/tapgo_ttv2/static/images/sign.jpg', '', 0, 0, 1),
(26, 30, 'sns', 'sale', '全民社区', '1.0', '官方', 1, '../addons/tapgo_ttv2/static/images/sns.jpg', '', 0, 0, 1),
(27, 33, 'wap', 'tool', '全网通', '1.0', '官方', 1, '', '', 1, 0, 1),
(28, 34, 'h5app', 'tool', 'H5APP', '1.0', '官方', 1, '', '', 1, 0, 1),
(29, 26, 'abonus', 'biz', '区域代理', '1.0', '官方', 1, '../addons/tapgo_ttv2/static/images/abonus.jpg', '', 0, 0, 1),
(30, 33, 'printer', 'tool', '小票打印机', '1.0', '官方', 1, '', '', 1, 0, 1),
(31, 34, 'bargain', 'tool', '砍价活动', '1.0', '官方', 1, '../addons/tapgo_ttv2/static/images/bargain.jpg', '', 0, 0, 1),
(32, 35, 'task', 'sale', '任务中心', '1.0', '官方', 1, '../addons/tapgo_ttv2/static/images/task.jpg', '', 0, 0, 1),
(33, 36, 'cashier', 'biz', '收银台', '1.0', '官方', 1, '../addons/tapgo_ttv2/static/images/cashier.jpg', '', 0, 0, 1),
(34, 37, 'messages', 'tool', '消息群发', '1.0', '官方', 1, '../addons/tapgo_ttv2/static/images/messages.jpg', '', 0, 0, 1),
(35, 38, 'seckill', 'sale', '整点秒杀', '1.0', '官方', 1, '../addons/tapgo_ttv2/static/images/seckill.jpg', '', 0, 0, 1),
(36, 39, 'exchange', 'biz', '兑换中心', '1.0', '官方', 1, '../addons/tapgo_ttv2/static/images/exchange.jpg', '', 0, 0, 1),
(37, 65, 'wxcard', 'sale', '微信卡券', '1.0', '官方', 1, '', NULL, 1, 0, 1),
(38, 42, 'quick', 'biz', '快速购买', '1.0', '官方', 1, '../addons/tapgo_ttv2/static/images/quick.jpg', '', 0, 0, 1),
(39, 43, 'mmanage', 'tool', '手机端商家管理中心', '1.0', '官方', 1, '../addons/tapgo_ttv2/static/images/mmanage.jpg', '', 0, 0, 1),
(40, 44, 'polyapi', 'tool', '进销存-网店管家', '1.0', '官方', 1, '../addons/tapgo_ttv2/static/images/polyapi.jpg', '', 0, 0, 1),
(41, 45, 'lottery', 'biz', '游戏营销', '1.0', '官方', 1, '../addons/tapgo_ttv2/static/images/lottery.jpg', '', 0, 0, 1),
(42, 46, 'pc', 'sale', 'PC端', '1.0', '官方', 1, '../addons/tapgo_ttv2/static/images/pc.jpg', '', 0, 0, 1),
(43, 47, 'live', 'sale', '互动直播', '1.0', '官方', 1, '../addons/tapgo_ttv2/static/images/live.jpg', '', 0, 0, 1),
(44, 48, 'invitation', 'sale', '邀请卡', '1.0', '官方', 1, '../addons/tapgo_ttv2/static/images/invitation.png', '', 0, 0, 1),
(45, 46, 'app', 'biz', '小程序', '1.0', '官方', 1, '../addons/tapgo_ttv2/static/images/app.jpg', '', 0, 0, 1),
(46, 49, 'cycelbuy', 'biz', '周期购', '1.0', '官方', 1, '../addons/tapgo_ttv2/static/images/cycelbuy.jpg', '', 0, 0, 1),
(47, 50, 'dividend', 'biz', '团队分红', '1.0', '官方', 1, '../addons/tapgo_ttv2/static/images/dividend.jpg', '', 0, 0, 1),
(48, 51, 'merchmanage', 'tool', '多商户手机端管理中心', '1.0', '官方', 1, '../addons/tapgo_ttv2/static/images/merchmanage.jpg', '', 0, 0, 1),
(49, 52, 'membercard', 'sale', '付费会员卡', '1.0', '官方', 1, '../addons/tapgo_ttv2/static/images/membercard.png', NULL, 0, 0, 1),
(50, 53, 'friendcoupon', 'sale', '好友瓜分券', '1.0', '官方', 1, '../addons/tapgo_ttv2/static/images/friendcoupon.png', NULL, 0, 0, 1),
(51, 54, 'open_messikefu', 'tool', '聚合客服', '1.0', '官方', 1, '../addons/tapgo_ttv2/static/images/open_messikefu.jpg', NULL, 0, 0, 1),
(52, 55, 'goodscircle', 'tool', '好物圈', '1.0', '官方', 1, '../addons/tapgo_ttv2/static/images/goodscircle.png', NULL, 0, 0, 1),
(53, 56, 'open_farm', 'tool', '人人农场', '1.0', '官方', 1, '../addons/tapgo_ttv2/static/images/open_farm.png', NULL, 0, 0, 1),
(54, 57, 'wxlive', 'sale', '小程序直播', '1.0', '官方', 1, '../addons/tapgo_ttv2/static/images/wxlive.png', NULL, 0, 0, 1),
(55,58,'goodshelper','tool','新商品助手','1.0','官方',1,'../addons/tapgo_ttv2/static/images/goodshelper.png', '', 0, 0, 0),
(56,59,'touch_loop','tool','一键发圈','1.0','官方',1,'../addons/tapgo_ttv2/static/images/touch_loop.png', '', 0, 0, 0),
(57,60,'transfer_account','biz','资金转账','1.0','官方',1,'../addons/tapgo_ttv2/static/images/transfer_account.png','',0,0,1);
(58,61,'makeexpress','tool','码科速运','1.0','官方',1,'../addons/tapgo_ttv2/static/images/makeexpress.jpg','',0,0,1);

DROP TABLE IF EXISTS `ims_tapgo_tt_task_extension`;
CREATE TABLE IF NOT EXISTS `ims_tapgo_tt_task_extension` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
insert into `ims_tapgo_tt_task_extension`(`id`,`taskname`,`taskclass`,`status`,`classify`,`classify_name`,`verb`,`unit`) values
...
CREATE TABLE IF NOT EXISTS `ims_tapgo_tt_task_type` (
  `id` int(11) NOT NULL,
...
insert into `ims_tapgo_tt_task_type`(`id`,`type_key`,`type_name`,`description`,`verb`,`numeric`,`unit`,`goods`,`theme`,`once`) values
...
pdo_insert('tapgo_tt_task_type', array('id'=>13,'type_key'=>'child_agent','type_name'=>'下级分销商人数','description'=>'直属下级分销商人数，累计下级分销商人数达标,即可获得奖励','verb'=>'直属下级分销商人数达','numeric'=>1,'unit'=>'人','goods'=>0,'theme'=>'primary','once'=>0), true);

$res = pdo_get('tapgo_tt_member_message_template_type',array('templatecode'=>'OPENTM207266668','name'=>'积分变动提醒'));
    if (empty($res)) {
    pdo_update("tapgo_tt_member_message_template_type", array('templatecode'=> 'OPENTM207266668'), array('name'=> '积分变动提醒'));
    }
$res2 = pdo_get('tapgo_tt_member_message_template_type',array('templatecode'=>'OPENTM202137457','name'=>'订单状态更新(修改收货地址)(修改价格)'));
    if (empty($res2)) {
    pdo_update("tapgo_tt_member_message_template_type", array('templatecode'=> 'OPENTM202137457'), array('name'=> '订单状态更新(修改收货地址)(修改价格)'));
    }
	
$res = pdo_fetchall("select * from ".tablename("tapgo_tt_express")." where name='中通快运'");
        if (empty($res)) {
            pdo_insert('tapgo_tt_express', array('name' => '中通快运', 'express' => 'zhongtongkuaiyun', 'status' => 1, 'displayorder' => 0, 'coding' => 'ZTOKY', 'code' => ''));
        }
$res = pdo_fetch('select * from '.tablename('tapgo_tt_express').' where id=20');
        if ($res['name'] == '德邦物流') {
            pdo_fetch("update ".tablename('tapgo_tt_express')." set name='德邦快递', coding='DBL' where id=20");
            pdo_fetch("update ".tablename('tapgo_tt_express')." set name='德邦物流', coding='DBLKY' where id=96");
        }
		
$list = pdo_fetch(" SELECT * FROM ".tablename('tapgo_tt_exhelper_esheet')." WHERE code=:code",array(':code'=>'STO'));
        ...
        if (!empty($list)){
            ...
            $upd = pdo_update('tapgo_tt_exhelper_esheet',$data,array('id'=>$list['id']));
        }
		
$list = pdo_get('tapgo_tt_exhelper_esheet',array('name'=>'顺丰(陆运)'));

        if (empty($list)){
            pdo_query("INSERT INTO ".tablename('tapgo_tt_exhelper_esheet')."(`id`, `name`, `express`, `code`, `datas`) VALUES (25, '顺丰(陆运)', 'shunfeng', 'SF', 'a:2:{i:0;a:4:{s:5:\"style\";s:9:\"二联150\";s:4:\"spec\";s:33:\"（宽100mm高150mm切点90/60）\";s:4:\"size\";s:3:\"150\";s:9:\"isdefault\";i:1;}i:1;a:4:{s:5:\"style\";s:9:\"三联210\";s:4:\"spec\";s:38:\"（宽100mm 高210mm 切点90/60/60）\";s:4:\"size\";s:3:\"210\";s:9:\"isdefault\";i:0;}}');");
        }


        $list = pdo_get('tapgo_tt_exhelper_esheet',array('name'=>'韵达'));
        ...
        if (!empty($list)){
           ...
           pdo_update('tapgo_tt_exhelper_esheet',array('datas'=>$temp),array('name'=>'韵达'));
        }
		
$mes = pdo_fetch(" SELECT * FROM".tablename('tapgo_tt_member_message_template_type')." WHERE typecode='willcancelverify'" );
        ...
        if (empty($mes)){
            ...
            pdo_insert('tapgo_tt_member_message_template_type',$data);
        }

$mes = pdo_fetch(" SELECT * FROM".tablename('tapgo_tt_exhelper_esheet')." WHERE code='HTKY'" );
        ...
        if (!empty($mes)){
            ...
            pdo_update('tapgo_tt_exhelper_esheet',$data,array('id'=>$mes['id']));
        }

$mes = pdo_fetch(" SELECT * FROM".tablename('tapgo_tt_exhelper_esheet')." WHERE code='YTO'" );
...
pdo_update('tapgo_tt_exhelper_esheet', array ('datas' =>'a:1:{i:0;a:4:{s:5:"style";s:8:"单联76";s:4:"spec";s:17:"(宽76mm高130mm)";s:4:"size";s:2:"76";s:9:"isdefault";i:0;}}'), array ('code' => 'ZTO'));
 pdo_update('tapgo_tt_express',array ('coding'=>'YZPY'),array ('express'=>'youzhengguonei'));	
		
@unlink( IA_ROOT.'/addons/tapgo_ttv2/plugin/app/core/mobile/bargain/c.json');
@unlink( IA_ROOT.'/addons/tapgo_ttv2/plugin/app/static/images/wxcode.jpg');
@unlink( IA_ROOT.'/addons/tapgo_ttv2/plugin/app/static/images/wxcode_1.jpg');
@unlink( IA_ROOT.'/addons/tapgo_ttv2/plugin/app/static/images/wxcode_2.jpg');
@unlink( IA_ROOT.'/addons/tapgo_ttv2/plugin/app/core/wxapp/wxappOpemCrypt.php');
@unlink( IA_ROOT.'/addons/tapgo_ttv2/plugin/app/core/wxapp/WxpayAPI.class.php');
@unlink( IA_ROOT.'/addons/tapgo_ttv2/core/web/system/auth/index1.php');
@unlink( IA_ROOT.'/addons/tapgo_ttv2/plugin/wxlive/core/form.php');
