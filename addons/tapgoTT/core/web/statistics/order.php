...
class Order_TapgoTtPage extends WebPage
{
	public function main()
	{
		...
		unset($row);
		$totalcount = $total = pdo_fetchall('select o.id from ' . tablename('tapgo_tt_order') . ' o ' . ' left join ' . tablename('tapgo_tt_member') . ' m on o.openid = m.openid ' . ' left join ' . tablename('tapgo_tt_member_address') . ' a on a.id = o.addressid ' . ' where 1 ' . $condition, $params);
