...
class FixQiniu_TapgoTtPage extends WebPage 
{
	...
	protected function handler() 
	{
		...
		$goodsTable = tablename("tapgo_tt_goods");
		$categoryTable = tablename("tapgo_tt_category");
		$questionTable = tablename("tapgo_tt_qa_question");
		try 
		{
	...
	{
		$logPath = IA_ROOT . "/addons/tapgo_ttv2/data/backup";
		if( !is_dir($logPath) ) 
		{
			mkdir($logPath);
		}
