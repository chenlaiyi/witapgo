...
class Print_TapgoTtPage extends WebPage 
{
	...
	public function shengchan(){
		...
		$stores[$key] = pdo_fetchall('select * from ' . tablename('tapgo_tt_order') . ' where uniacid=:uniacid and id=:orderid', array(':uniacid' => $uniacid,':orderid' => $orderId));		
