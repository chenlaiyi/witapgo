...
class Sendcoupon_TapgoTtPage extends ComWebPage {
    ...
    function main() {
        ...
        $coupons = pdo_fetchall("SELECT * FROM " . tablename('tapgo_tt_coupon') . " WHERE uniacid = '{$_W['uniacid']}' and merchid=0 and isfriendcoupon = 0  ORDER BY id asc");
