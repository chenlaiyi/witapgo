...
class Route_TapgoTtModel {
    ...
    function run($isweb = true)
    {
        ...
        // autoload
//        if (version_compare(TAPGO_TT_VERSION, '3.14.0', '>=')) {
            @include_once TAPGO_TT_PATH . 'vendor/autoload.php';
//        }
        
        require_once IA_ROOT . "/addons/tapgoTT/core/inc/page.php";
        if ($isweb) {
            require_once TAPGO_TT_CORE . "inc/page_web.php";
            require_once TAPGO_TT_CORE . "inc/page_web_com.php";
        } else{
            require_once TAPGO_TT_CORE . "inc/page_mobile.php";
            require_once TAPGO_TT_CORE . "inc/page_mobile_login.php";
        }
        ...
        $method = "main";
        $root = $isweb ? TAPGO_TT_CORE_WEB : TAPGO_TT_CORE_MOBILE;
        ...
        if(strexists($_W['siteurl'] ,"web/merchant.php")) {
            ...
            $isplugin = !empty($r) && is_dir(TAPGO_TT_PLUGIN . $routes[0]);
        }
        
        if ($isplugin) {
            if ($isweb) {
                require_once TAPGO_TT_CORE . "inc/page_web_plugin.php";
                
            } else {
                require_once TAPGO_TT_CORE . "inc/page_mobile_plugin.php";
                require_once TAPGO_TT_CORE . "inc/page_mobile_plugin_login.php";
                require_once TAPGO_TT_CORE . "inc/page_mobile_plugin_pf.php";
            }
            
            $_W['plugin'] = $routes[0];
            $root = TAPGO_TT_PLUGIN . $routes[0] . "/core/" . ( $isweb ? "web" : "mobile") . "/";
            if($isMerch){
                $_W['plugin'] ="merch";
                $root = TAPGO_TT_PLUGIN .  "merch/core/web/manage/";
            } else if($isNewstore){
                $_W['plugin'] ="newstore";
                $root = TAPGO_TT_PLUGIN .  "newstore/core/web/manage/";
            }
            else{
            ...
            require_once TAPGO_TT_CORE . "inc/page_system.php";
        }
        ...
        if (isset($_GPC['r']) && strpos($_GPC['r'], 'pc') !== false) {
            ...
            $class = ucfirst($class) . "_TapgoTtPage";
        }
