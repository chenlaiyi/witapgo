...
class Bind_TapgoTtModel {
    ...
    public function update($mid=0, $arr=array()){
        ...
        pdo_update('tapgo_tt_member', $arr, array('id'=>$mid,'uniacid'=>$_W['uniacid']));
    }
    public function merge($a=array(), $b=array()){
        ...
        if(!empty($arr) && is_array($arr)){
            pdo_update('tapgo_tt_member', $arr, array('id'=>$b['id']));
        }

        pdo_update('tapgo_tt_commission_apply', array('mid' => $b['id']), array('uniacid' => $_W['uniacid'], 'mid' => $a['id']));
        pdo_update('tapgo_tt_order',array('agentid'=>$b['id']),array('agentid'=>$a['id']));

        pdo_update('tapgo_tt_member',array('agentid'=>$b['id']),array('agentid'=>$a['id']));
        ...
        pdo_delete('tapgo_tt_member', array('id' => $a['id'], 'uniacid' => $_W['uniacid']));
        ...
        pdo_insert("tapgo_tt_member_mergelog", array(
            'uniacid'=>$_W['uniacid'],
            'mergetime'=>time(),
            'openid_a'=>$a['openid'],
            'openid_b'=>$b['openid'],
    ...
    public function mergeforuniacid($a=array(), $b=array()){
        ...
        pdo_update('tapgo_tt_commission_apply', array('mid' => $b['id']), array('mid' => $a['id']));
        pdo_update('tapgo_tt_order',array('agentid'=>$b['id']),array('agentid'=>$a['id']));
        pdo_update('tapgo_tt_member',array('agentid'=>$b['id']),array('agentid'=>$a['id']));
