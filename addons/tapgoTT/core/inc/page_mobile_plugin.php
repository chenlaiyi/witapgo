...
class PluginMobilePage extends MobilePage
{
    ...
    protected function view($template, $params = array())
    {
        ...
        $pluginTemplatePath = TAPGO_TT_PLUGIN . "{$plugin}" . "/template/mobile/default/";
        ...
        // 模板需要的默认参数
        $defaultParams = array(
            'basePath' => TAPGO_TT_LOCAL . "plugin/{$plugin}/static",
            'staticPath' => TAPGO_TT_LOCAL . "static/",
            'appJsPath' => TAPGO_TT_LOCAL . "static/js/app",
            'title' => '人人商城',
        );
