...
class Recharge_TapgoTtPage extends MobileLoginPage {
        ...
        if ($type == 'wechat') {
            ...
            if (isset($set['pay']) && $set['pay']['weixin'] == 1&&$jie!==1) {
                ...
                if($datasss['type']==5){
                    ...
                    $tid=$params['tid'].rand(10000,99999);
                    pdo_update('tapgo_tt_member_log', array('isuni' => 1,'logno'=>$tid), array('logno'=>$params['tid']));
                    $params['tid']=$tid; 
                    $wechat = m("common")->unionpay_build($params,$unionpay,0);
                }else{
            ...
            if ((isset($set['pay']) && $set['pay']['weixin_jie'] == 1&& !$wechat['success'])||$jie===1) {
                ...
                if($datasss['type']==5){
                    $unionpay = [
                     ...
                     pdo_update('tapgo_tt_member_log', array('isuni' => 1), array('logno'=>$logno));
                    $wechat = m("common")->unionpay_build($params,$unionpay,0);
                }else{
