...
class Create_TapgoTtPage extends MobileLoginPage
{
	...
	public function main()
	{
		...
		if (!($packageid)) {
			...
			if (p('bargain') && !(empty($bargain_id))) {
				...
				$bargain_act = pdo_fetch('SELECT *  FROM ' . tablename('tapgo_tt_bargain_actor') . ' WHERE id = :id AND openid = :openid AND status = \'0\'', array(':id' => $bargain_id, ':openid' => $_W['openid']));
				...
				$bargain_act_id = pdo_fetch('SELECT *  FROM ' . tablename('tapgo_tt_bargain_goods') . ' WHERE id = \'' . $bargain_act['goods_id'] . '\'');
				...
				$if_bargain = pdo_fetch('SELECT bargain FROM ' . tablename('tapgo_tt_goods') . ' WHERE id = :id AND uniacid = :uniacid ', array(':id' => $bargain_act_id['goods_id'], ':uniacid' => $_W['uniacid']));
			...
			if (empty($id)) {
				if (!(empty($quickid))) {
					$sql = 'SELECT c.goodsid,c.total,g.maxbuy,g.type,g.intervalfloor,g.intervalprice,g.issendfree,g.isnodiscount,g.ispresell,g.presellprice as gpprice,o.presellprice,g.preselltimeend,g.presellsendstatrttime,g.presellsendtime,g.presellsendtype' . ',g.weight,o.weight as optionweight,g.title,g.thumb,ifnull(o.marketprice, g.marketprice) as marketprice,o.title as optiontitle,c.optionid,' . ' g.storeids,g.isverify,g.isforceverifystore,g.deduct,g.manydeduct,g.manydeduct2,g.virtual,o.virtual as optionvirtual,discounts,' . ' g.deduct2,g.ednum,g.edmoney,g.edareas,g.edareas_code,g.diyformtype,g.diyformid,diymode,g.dispatchtype,g.dispatchid,g.dispatchprice,g.minbuy ' . ' ,g.isdiscount,g.isdiscount_time,g.isdiscount_time_start,g.isdiscount_discounts,g.cates,g.isfullback, ' . ' g.virtualsend,invoice,o.specs,g.merchid,g.checked,g.merchsale,g.unite_total,' . ' g.buyagain,g.buyagain_islong,g.buyagain_condition, g.buyagain_sale, g.hasoption, g.threen' . ' FROM ' . tablename('tapgo_tt_quick_cart') . ' c ' . ' left join ' . tablename('tapgo_tt_goods') . ' g on c.goodsid = g.id ' . ' left join ' . tablename('tapgo_tt_goods_option') . ' o on c.optionid = o.id ' . ' where c.openid=:openid and c.selected=1 and  c.deleted=0 and c.uniacid=:uniacid and c.quickid=' . $quickid . '  order by c.id desc';
					$goods = pdo_fetchall($sql, array(':uniacid' => $uniacid, ':openid' => $openid));
				}
				 else if (empty($exchangeOrder)) {
					$sql = 'SELECT c.goodsid,c.total,g.maxbuy,g.type,g.intervalfloor,g.intervalprice,g.issendfree,g.isnodiscount,g.ispresell,g.presellprice as gpprice,o.presellprice,g.preselltimeend,g.presellsendstatrttime,g.presellsendtime,g.presellsendtype' . ',g.weight,o.weight as optionweight,g.title,g.thumb,ifnull(o.marketprice, g.marketprice) as marketprice,o.title as optiontitle,c.optionid,' . ' g.storeids,g.isverify,g.isforceverifystore,g.deduct,g.manydeduct,g.manydeduct2,g.virtual,o.virtual as optionvirtual,discounts,' . ' g.deduct2,g.ednum,g.edmoney,g.edareas,g.edareas_code,g.diyformtype,g.diyformid,diymode,g.dispatchtype,g.dispatchid,g.dispatchprice,g.minbuy ' . ' ,g.isdiscount,g.isdiscount_time,g.isdiscount_time_start,g.isdiscount_discounts,g.cates, ' . ' g.virtualsend,invoice,o.specs,g.merchid,g.checked,g.merchsale,' . ' g.buyagain,g.buyagain_islong,g.buyagain_condition, g.buyagain_sale, g.hasoption' . ' FROM ' . tablename('tapgo_tt_member_cart') . ' c ' . ' left join ' . tablename('tapgo_tt_goods') . ' g on c.goodsid = g.id ' . ' left join ' . tablename('tapgo_tt_goods_option') . ' o on c.optionid = o.id ' . ' where c.openid=:openid and c.selected=1 and  c.deleted=0 and c.uniacid=:uniacid  order by c.id desc';
					$goods = pdo_fetchall($sql, array(':uniacid' => $uniacid, ':openid' => $openid));
				}
				 else if (p('exchange')) {
					$sql = 'SELECT c.goodsid,c.total,g.maxbuy,g.type,g.intervalfloor,g.intervalprice,g.issendfree,g.isnodiscount,g.ispresell,g.presellprice as gpprice,o.presellprice,g.preselltimeend,g.presellsendstatrttime,g.presellsendtime,g.presellsendtype' . ',g.weight,o.weight as optionweight,g.title,g.thumb,ifnull(o.marketprice, g.marketprice) as marketprice,o.title as optiontitle,c.optionid,' . ' g.storeids,g.isverify,g.isforceverifystore,g.deduct,g.manydeduct,g.manydeduct2,g.virtual,o.virtual as optionvirtual,discounts,' . ' g.deduct2,g.ednum,g.edmoney,g.edareas,g.edareas_code,g.diyformtype,g.diyformid,diymode,g.dispatchtype,g.dispatchid,g.dispatchprice,g.minbuy ' . ' ,g.isdiscount,g.isdiscount_time,g.isdiscount_time_start,g.isdiscount_discounts,g.cates,g.isfullback, ' . ' g.virtualsend,invoice,o.specs,g.merchid,g.checked,g.merchsale,g.unite_total,' . ' g.buyagain,g.buyagain_islong,g.buyagain_condition, g.buyagain_sale, g.hasoption' . ' FROM ' . tablename('tapgo_tt_exchange_cart') . ' c ' . ' left join ' . tablename('tapgo_tt_goods') . ' g on c.goodsid = g.id ' . ' left join ' . tablename('tapgo_tt_goods_option') . ' o on c.optionid = o.id ' . ' where c.openid=:openid and c.selected=1 and  c.deleted=0 and c.uniacid=:uniacid  order by c.id desc';
					$goods = pdo_fetchall($sql, array(':uniacid' => $uniacid, ':openid' => $openid));
				}
				...
				if (empty($goods)) {
					...
					foreach ($goods as $k => $v ) {
						...
						if ($v['isfullback']) {
							$fullbackgoods = pdo_fetch('SELECT * FROM ' . tablename('tapgo_tt_fullback_goods') . ' WHERE goodsid = :goodsid and uniacid = :uniacid and status = 1 limit 1 ', array(':goodsid' => $v['goodsid'], ':uniacid' => $uniacid));
						}
				...
				foreach ($optionsdata as $option ) {
					...
					if (0 < $option['optionid']) {
						$option = pdo_fetch('select id,title,marketprice,presellprice,goodssn,productsn,`virtual`,stock,weight,specs from ' . tablename('tapgo_tt_goods_option') . ' where id=:id and goodsid=:goodsid and uniacid=:uniacid  limit 1', array(':uniacid' => $uniacid, ':goodsid' => $id, ':id' => $option['optionid']));
				...
				$sql = 'SELECT id as goodsid,type,title,weight,issendfree,isnodiscount,ispresell,presellprice,' . ' thumb,marketprice,liveprice,islive,storeids,isverify,isforceverifystore,deduct,hasoption,preselltimeend,presellsendstatrttime,presellsendtime,presellsendtype,' . ' manydeduct,manydeduct2,`virtual`,maxbuy,usermaxbuy,discounts,total as stock,deduct2,showlevels,' . ' ednum,edmoney,edareas,edareas_code,unite_total,diyfields,' . ' diyformtype,diyformid,diymode,dispatchtype,dispatchid,dispatchprice,cates,minbuy, ' . ' isdiscount,isdiscount_time,isdiscount_time_start,isdiscount_discounts,isfullback, ' . ' virtualsend,invoice,needfollow,followtip,followurl,merchid,checked,merchsale, ' . ' buyagain,buyagain_islong,buyagain_condition, buyagain_sale,bargain' . $threensql . $ishotelsql . ' FROM ' . tablename('tapgo_tt_goods') . ' where id=:id and uniacid=:uniacid  limit 1';
				$data = pdo_fetch($sql, array(':uniacid' => $uniacid, ':id' => $id));
				$threenprice = json_decode($data['threen'], 1);

				if (0 < $data['merchid']) {
					$merchstatus = pdo_fetch(' SELECT status FROM ' . tablename('tapgo_tt_merch_user') . ' WHERE id=:id AND uniacid=:uniacid ', array(':id' => $data['merchid'], ':uniacid' => $_W['uniacid']));
				...
				if (!(empty($liveid))) {
					...
					if (!(empty($isLiveGoods))) {
						...
						if ($defaultcardid) {
							$live_product = pdo_fetch('SELECT *  FROM ' . tablename('tapgo_tt_goods') . ' WHERE id = \'' . $data['goodsid'] . '\'');
				...
				if ($data['seckillinfo'] && ($data['seckillinfo']['status'] == 0)) {
					...
					$gift = pdo_fetch('select id,title,thumb,activity,giftgoodsid,goodsid from ' . tablename('tapgo_tt_gift') . "\n" . '                where uniacid = ' . $uniacid . ' and id = ' . $giftid . ' and status = 1 and starttime <= ' . time() . ' and endtime >= ' . time() . ' ');
					...
					if (!(empty($gift['giftgoodsid']))) {
						...
						if ($giftGoodsid) {
							foreach ($giftGoodsid as $key => $value ) {
								$giftGood[$key] = pdo_fetch('select id,title,thumb,marketprice from ' . tablename('tapgo_tt_goods') . ' where uniacid = ' . $uniacid . ' and total > 0 and status = 2 and id = ' . $value . ' and deleted = 0 ');
							}
				...
				if ($data['isfullback']) {
					$fullbackgoods = pdo_fetch('SELECT * FROM ' . tablename('tapgo_tt_fullback_goods') . ' WHERE goodsid = :goodsid and uniacid = :uniacid and status = 1 limit 1 ', array(':goodsid' => $data['goodsid'], ':uniacid' => $uniacid));
				}
			...
			foreach ($goods as &$g ) {
				...
				if ($g['seckillinfo'] && ($g['seckillinfo']['status'] == 0)) {
					...
					if (p('task')) {
						...
						if (!(empty($task_id))) {
							$rewarded = pdo_fetchcolumn('SELECT `rewarded` FROM ' . tablename('tapgo_tt_task_extension_join') . ' WHERE id = :id AND openid = :openid AND  uniacid = :uniacid', array(':id' => $task_id, ':uniacid' => $_W['uniacid'], ':openid' => $_W['openid']));
				...
				if (!(empty($g['seckillinfo'])) && ($g['seckillinfo']['status'] == 0)) {
					...
					if (0 < $g['usermaxbuy']) {
						$order_goodscount = pdo_fetchcolumn('select ifnull(sum(og.total),0)  from ' . tablename('tapgo_tt_order_goods') . ' og ' . ' left join ' . tablename('tapgo_tt_order') . ' o on og.orderid=o.id ' . ' where og.goodsid=:goodsid and  o.status>=0 and o.openid=:openid  and og.uniacid=:uniacid ', array(':goodsid' => $g['goodsid'], ':uniacid' => $uniacid, ':openid' => $openid));
			...
			if ($hasinvoice) {
				$invoicename = pdo_fetchcolumn('select invoicename from ' . tablename('tapgo_tt_order') . ' where openid=:openid and uniacid=:uniacid and ifnull(invoicename,\'\')<>\'\' order by id desc limit 1', array(':openid' => $openid, ':uniacid' => $uniacid));
			...
			if (!($isverify) && !($isvirtual)) {
				if (0 < $merch_id) {
					$carrier_list = pdo_fetchall('select * from ' . tablename('tapgo_tt_merch_store') . ' where  uniacid=:uniacid and merchid=:merchid and status=1 and type in(1,3) order by displayorder desc,id desc', array(':uniacid' => $_W['uniacid'], ':merchid' => $merch_id));
				}
				 else {
					$carrier_list = pdo_fetchall('select * from ' . tablename('tapgo_tt_store') . ' where  uniacid=:uniacid and status=1 and type in(1,3) order by displayorder desc,id desc', array(':uniacid' => $_W['uniacid']));
				}
			}
			...
			if ($isverify) {
				...
				if (empty($storeids)) {
					if (0 < $merchid) {
						$stores = pdo_fetchall('select * from ' . tablename('tapgo_tt_merch_store') . ' where  uniacid=:uniacid and merchid=:merchid and status=1 and type in(2,3) order by displayorder desc,id desc', array(':uniacid' => $_W['uniacid'], ':merchid' => $merchid));
					}
					 else {
						$stores = pdo_fetchall('select * from ' . tablename('tapgo_tt_store') . ' where  uniacid=:uniacid and status=1 and type in(2,3) order by displayorder desc,id desc', array(':uniacid' => $_W['uniacid']));
					}
				}
				 else if (0 < $merchid) {
					$stores = pdo_fetchall('select * from ' . tablename('tapgo_tt_merch_store') . ' where id in (' . implode(',', $storeids) . ') and uniacid=:uniacid and merchid=:merchid and status=1 and type in(2,3) order by displayorder desc,id desc', array(':uniacid' => $_W['uniacid'], ':merchid' => $merchid));
				}
				 else {
					$stores = pdo_fetchall('select * from ' . tablename('tapgo_tt_store') . ' where id in (' . implode(',', $storeids) . ') and uniacid=:uniacid and status=1 and type in(2,3) order by displayorder desc,id desc', array(':uniacid' => $_W['uniacid']));
				}
			}
			 else {
				$address = pdo_fetch('select * from ' . tablename('tapgo_tt_member_address') . ' where openid=:openid and deleted=0 and isdefault=1  and uniacid=:uniacid limit 1', array(':uniacid' => $uniacid, ':openid' => $openid));
			...
			foreach ($goods as $g ) {
				...
				if ($g['seckillinfo'] && ($g['seckillinfo']['status'] == 0)) {
					...
					$gift = array();
					$giftdata = pdo_fetch('select giftgoodsid from ' . tablename('tapgo_tt_gift') . ' where uniacid = ' . $uniacid . ' and id = ' . $giftid . ' and status = 1 and starttime <= ' . time() . ' and endtime >= ' . time() . ' ');

					if ($giftdata['giftgoodsid']) {
						$giftgoodsid = explode(',', $giftdata['giftgoodsid']);

						foreach ($giftgoodsid as $key => $value ) {
							$giftinfo = pdo_fetch('select id as goodsid,title,thumb from ' . tablename('tapgo_tt_goods') . ' where uniacid = ' . $uniacid . ' and total > 0 and status = 2 and id = ' . $value . ' and deleted = 0 ');
					...
					foreach ($gifts as $key => $value ) {
						...
						foreach ($giftgoods as $k => $val ) {
							$giftgoodsdetail = pdo_fetch('select id,title,thumb,marketprice,total from ' . tablename('tapgo_tt_goods') . ' where uniacid = ' . $uniacid . ' and deleted = 0 and status = 2 and id = ' . $val . ' ');
			...
			$package = pdo_fetch('SELECT * FROM ' . tablename('tapgo_tt_package') . ' WHERE uniacid = ' . $uniacid . ' and id = ' . $packageid . ' ');
			...
			foreach ($g as $key => $value ) {
				$tablename = tablename('tapgo_tt_goods');
	...
	public function getcouponprice()
	{
		...
		$allGoods = pdo_fetchall('SELECT id,deduct,manydeduct,deduct2,manydeduct2 FROM ' . tablename('tapgo_tt_goods') . ' WHERE id in (' . implode(',', $goods_ids) . ')', array(), 'id');
		$deductcredit = 0;
		$deductmoney = 0;
		$deductcredit2 = 0;
		$saleset = false;
	...
	public function caculatecoupon($contype, $couponid, $wxid, $wxcardid, $wxcode, $goodsarr, $totalprice, $discountprice, $isdiscountprice, $isSubmit = 0, $discountprice_array = array(), $merchisdiscountprice = 0, $real_price = 0)
	{
		...
		if ($contype == 1) {
			$sql = 'select id,uniacid,card_type,logo_url,title, card_id,least_cost,reduce_cost,discount,merchid,limitgoodtype,limitgoodcatetype,limitgoodcateids,limitgoodids,merchid,limitdiscounttype  from ' . tablename('tapgo_tt_wxcard');
			...
			$sql = 'SELECT d.id,d.couponid,c.enough,c.backtype,c.deduct,c.discount,c.backmoney,c.backcredit,c.backredpack,c.merchid,c.limitgoodtype,c.limitgoodcatetype,c.limitgoodids,c.limitgoodcateids,c.limitdiscounttype  FROM ' . tablename('tapgo_tt_coupon_data') . ' d';
			$sql .= ' left join ' . tablename('tapgo_tt_coupon') . ' c on d.couponid = c.id';
	...
	public function caculate()
	{
		...
		if (!(empty($packageid))) {
			$package = pdo_fetch('SELECT id,title,price,freight,cash,starttime,endtime,dispatchtype FROM ' . tablename('tapgo_tt_package') . "\n" . '                    WHERE uniacid = ' . $uniacid . ' and id = ' . $packageid . ' and deleted = 0 and status = 1  ORDER BY id DESC');
		}
		...
		$address = pdo_fetch('select * from ' . tablename('tapgo_tt_member_address') . ' where  id=:id and openid=:openid and uniacid=:uniacid limit 1', array(':uniacid' => $uniacid, ':openid' => $openid, ':id' => $addressid));
		$member = m('member')->getMember($openid, true);
		$level = m('member')->getLevel($openid);
		...
		if (is_array($goodsarr)) {
			...
			foreach ($goodsarr as &$g ) {
				...
				if (!(empty($optionid))) {
					$option = pdo_fetch('select id,title,marketprice,presellprice,goodssn,productsn,stock,`virtual`,weight,liveprice,islive from ' . tablename('tapgo_tt_goods_option') . ' where id=:id and goodsid=:goodsid and uniacid=:uniacid  limit 1', array(':uniacid' => $uniacid, ':goodsid' => $goodsid, ':id' => $optionid));
				...
				if (p('bargain')) {
					$bargain_act_id = pdo_fetchall('SELECT *  FROM ' . tablename('tapgo_tt_bargain_goods') . ' WHERE goods_id = \'' . $g['goodsid'] . '\' and status = 0');
	...
	public function submit()
	{
		...
		if (!(empty($packageid))) {
			...
			$packgoods = pdo_fetchall('SELECT id,title,thumb,packageprice,`option`,goodsid FROM ' . tablename('tapgo_tt_package_goods') . "\n" . '                    WHERE uniacid = ' . $uniacid . ' and pid = ' . $packageid . '  ORDER BY id DESC');
		...
		$sql = 'SELECT diyformtype,diyfields,bargain,diyformid FROM ' . tablename('tapgo_tt_goods') . ' where id=:id and uniacid=:uniacid  limit 1';
		...
		if ($giftid) {
			...
			if ($giftdata['giftgoodsid']) {
				...
				foreach ($giftgoodsid as $key => $value ) {
					$giftinfo = pdo_fetch('select id as goodsid,title,thumb from ' . tablename('tapgo_tt_goods') . ' where uniacid = ' . $uniacid . ' and status = 2 and total>0 and id = ' . $value . ' and deleted = 0 ');
		...
		foreach ($goods as $g ) {
			...
			if (($data['seckillinfo'] && ($data['seckillinfo']['status'] == 0)) || (0 < $_GPC['card_id'])) {
				...
				if (p('lottery')) {
					$lottery_id = pdo_get('tapgo_tt_lottery_log', array('log_id' => $log_id), array('lottery_id'));

					if ($lottery_id['lottery_id']) {
						$is_goods = pdo_get('tapgo_tt_lottery', array('lottery_id' => $lottery_id['lottery_id']), array('is_goods'));
			...
			if ($data['seckillinfo'] && ($data['seckillinfo']['status'] == 0)) {
				...
				if (0 < $data['usermaxbuy']) {
					$order_goodscount = pdo_fetchcolumn('select ifnull(sum(og.total),0)  from ' . tablename('tapgo_tt_order_goods') . ' og ' . ' left join ' . tablename('tapgo_tt_order') . ' o on og.orderid=o.id ' . ' where og.goodsid=:goodsid and  o.status>=0 and o.openid=:openid  and og.uniacid=:uniacid ', array(':goodsid' => $data['goodsid'], ':uniacid' => $uniacid, ':openid' => $openid));
			...
			if (!(empty($optionid))) {
				$option = pdo_fetch('select id,title,marketprice,liveprice,presellprice,goodssn,productsn,stock,`virtual`,weight' . $sql_condition . ' from ' . tablename('tapgo_tt_goods_option') . ' where id=:id and goodsid=:goodsid and uniacid=:uniacid  limit 1', array(':uniacid' => $uniacid, ':goodsid' => $goodsid, ':id' => $optionid));
				...
				if (!(empty($option))) {
					if (!(empty($_SESSION['exchange'])) && p('exchange')) {
						if ($option['exchange_stock'] <= 0) {
							...
							pdo_query('UPDATE ' . tablename('tapgo_tt_goods_option') . ' SET exchange_stock = exchange_stock - 1 WHERE id = :id AND uniacid = :uniacid', array(':id' => $optionid, ':uniacid' => $_W['uniacid']));
						}
					}
					 else {
						if ($data['seckillinfo'] && ($data['seckillinfo']['status'] == 0)) {
					...
					if ($data['type'] != 4) {
						...
						if ($packageid) {
							$packageoption = pdo_fetch('select packageprice ,marketprice from ' . tablename('tapgo_tt_package_goods_option') . "\n" . '                                where uniacid = ' . $uniacid . ' and goodsid = ' . $goodsid . ' and optionid = ' . $optionid . ' and pid = ' . $packageid . ' ');
			...
			if ($packageid) {
				if (empty($g['giftStatus'])) {
					$pg = pdo_fetch('select packageprice,marketprice from ' . tablename('tapgo_tt_package_goods') . "\n" . '                                    where uniacid = ' . $uniacid . ' and goodsid = ' . $goodsid . ' and pid = ' . $packageid . ' ');
				...
				if (0 < $data['exchange_stock']) {
					pdo_query('UPDATE ' . tablename('tapgo_tt_goods') . ' SET exchange_stock = exchange_stock - 1 WHERE id = :id AND uniacid = :uniacid', array(':id' => $data['goodsid'], ':uniacid' => $_W['uniacid']));
				}
			...
			if (intval($_GPC['fromcart']) == 1) {
				if ($diyform_plugin) {
					$cartdata = pdo_fetch('select id,diyformdataid,diyformfields,diyformdata from ' . tablename('tapgo_tt_member_cart') . ' ' . ' where goodsid=:goodsid and optionid=:optionid and openid=:openid and deleted=0 order by id desc limit 1', array(':goodsid' => $data['goodsid'], ':optionid' => intval($data['optionid']), ':openid' => $openid));
		...
		if (($isverify || $dispatchtype) && !($isonlyverifygoods)) {
			if ($isverify) {
				if (($verifytype == 0) || ($verifytype == 1)) {
					...
					while (1) {
						$count = pdo_fetchcolumn('select count(*) from ' . tablename('tapgo_tt_order') . ' where verifycode=:verifycode and uniacid=:uniacid limit 1', array(':verifycode' => $verifycode, ':uniacid' => $_W['uniacid']));
					...
					while ($i <= $totaltimes) {
						...
						while (1) {
							$count = pdo_fetchcolumn('select count(*) from ' . tablename('tapgo_tt_order') . ' where concat(verifycodes,\'|\' + verifycode +\'|\' ) like :verifycodes and uniacid=:uniacid limit 1', array(':verifycodes' => '%' . $verifycode . '%', ':uniacid' => $_W['uniacid']));
		...
		if (!(empty($goods[0]['bargain_id'])) && p('bargain')) {
			$bargain_act = pdo_fetch('SELECT * FROM ' . tablename('tapgo_tt_bargain_actor') . ' WHERE id = :id AND openid = :openid ', array(':id' => $goods[0]['bargain_id'], ':openid' => $_W['openid']));
			...
			if (!(pdo_update('tapgo_tt_bargain_actor', array('status' => 1), array('id' => $goods[0]['bargain_id'], 'openid' => $_W['openid'])))) {
				exit('下单失败');
			}
		...
		if ($taskgoodsprice) {
			...
			pdo_update('tapgo_tt_task_extension_join', array('rewarded' => serialize($taskGoodsInfo0)), array('id' => $task_id, 'uniacid' => $_W['uniacid'], 'openid' => $_W['openid']));
		...
		pdo_insert('tapgo_tt_order', $order);
		...
		if (!(empty($goods[0]['bargain_id'])) && p('bargain')) {
			pdo_update('tapgo_tt_bargain_actor', array('order' => $orderid), array('id' => $goods[0]['bargain_id'], 'openid' => $_W['openid']));
		}
		...
		if ($multiple_order == 0) {
			...
			foreach ($allgoods as $goods ) {
				...
				if (!(empty($bargain_act)) && p('bargain')) {
					...
					pdo_query('UPDATE ' . tablename('tapgo_tt_goods') . ' SET sales = sales + 1 WHERE id = :id AND uniacid = :uniacid', array(':id' => $goods['goodsid'], ':uniacid' => $uniacid));
				}
				...
				pdo_insert('tapgo_tt_order_goods', $order_goods);
		...
		if ($data['type'] == 3) {
			...
			if (com('virtual')) {
				...
				if (is_array($virtual_res) && $virtual_res['message']) {
					pdo_update('tapgo_tt_order', array('status' => -1, 'canceltime' => time()), array('id' => $orderid, 'uniacid' => $_W['uniacid']));
		...
		if (!(empty($_SESSION['exchange'])) && p('exchange')) {
			$codeResult = pdo_fetch('SELECT * FROM ' . tablename('tapgo_tt_exchange_code') . ' WHERE `key` = :key AND uniacid =:uniacid', array(':key' => $_SESSION['exchange_key'], ':uniacid' => $_W['uniacid']));
			...
			$groupResult = pdo_fetch('SELECT * FROM ' . tablename('tapgo_tt_exchange_group') . ' WHERE id = :id AND uniacid = :uniacid ', array(':uniacid' => $_W['uniacid'], ':id' => $codeResult['groupid']));
			$record_exsit = pdo_fetch('SELECT * FROM ' . tablename('tapgo_tt_exchange_record') . ' WHERE `key`=:key AND uniacid = :uniacid', array(':key' => $_SESSION['exchange_key'], ':uniacid' => $_W['uniacid']));
			...
			if (empty($record_exsit)) {
				...
				pdo_insert('tapgo_tt_exchange_record', $data);
			}
			...
			if (empty($_SESSION['exchange_key']) || is_null($_SESSION['exchangeprice']) || is_null($_SESSION['exchangepostage'])) {
				...
				if ($groupResult['mode'] != 6) {
					$exchange_res = pdo_update('tapgo_tt_exchange_code', array('status' => 2), array('key' => $_SESSION['exchange_key'], 'status' => 1, 'uniacid' => $_W['uniacid']));
					pdo_query('UPDATE ' . tablename('tapgo_tt_exchange_group') . ' SET `use` = `use` + 1 WHERE id = :id AND uniacid = :uniacid', array(':id' => $_SESSION['groupid'], ':uniacid' => $_W['uniacid']));
				}
				 else {
					pdo_update('tapgo_tt_exchange_code', array('goodsstatus' => 2), array('key' => $_SESSION['exchange_key'], 'uniacid' => $_W['uniacid']));
					if ((($codeResult['balancestatus'] == 2) || empty($groupResult['balance_type'])) && (($codeResult['scorestatus'] == 2) || empty($groupResult['score_type'])) && (($codeResult['redstatus'] == 2) || empty($groupResult['red_type'])) && (($codeResult['couponstatus'] == 2) || empty($groupResult['coupon_type']))) {
						pdo_update('tapgo_tt_exchange_code', array('status' => 2), array('key' => $_SESSION['exchange_key'], 'status' => 1, 'uniacid' => $_W['uniacid']));
					}
		...
		if (!(is_null($_SESSION['exchangeprice'])) && !(empty($_SESSION['exchange'])) && p('exchange')) {
			...
			if ($groupResult['mode'] != 6) {
				...
				pdo_update('tapgo_tt_exchange_record', $exchangedata, array('key' => $_SESSION['exchange_key'], 'uniacid' => $_W['uniacid']));
			}
			 else {
			...
			pdo_update('tapgo_tt_exchange_cart', array('selected' => 0), array('uniacid' => $_W['uniacid'], 'openid' => $_W['openid'], 'selected' => 1));
		}
		...
		if ($_GPC['fromcart'] == 1) {
			pdo_query('update ' . tablename('tapgo_tt_member_cart') . ' set deleted=1 where  openid=:openid and uniacid=:uniacid and selected=1 ', array(':uniacid' => $uniacid, ':openid' => $openid));
		}


		if (p('quick') && !(empty($_GPC['fromquick']))) {
			pdo_update('tapgo_tt_quick_cart', array('deleted' => 1), array('quickid' => intval($_GPC['fromquick']), 'uniacid' => $_W['uniacid'], 'openid' => $_W['openid']));
		}
	...
	protected function singleDiyformData($id = 0)
	{
		...
		if ($diyform_plugin && !(empty($id))) {
			$sql = 'SELECT id as goodsid,type,diyformtype,diyformid,diymode,diyfields FROM ' . tablename('tapgo_tt_goods') . ' where id=:id and uniacid=:uniacid  limit 1';
	...
	public function diyform()
	{
		...
		if (empty($goods_temp)) {
			pdo_insert('tapgo_tt_diyform_temp', $insert);
			$gdid = pdo_insertid();
		}
		 else {
			pdo_update('tapgo_tt_diyform_temp', $insert, array('id' => $goods_temp['id']));
			$gdid = $goods_temp['id'];
		}

		if (!(empty($cartid))) {
			$cart_data = array('diyformid' => $insert['diyformid'], 'diyformfields' => $insert['diyformfields'], 'diyformdata' => $insert['diyformdata']);
			pdo_update('tapgo_tt_member_cart', $cart_data, array('id' => $cartid));
		}
	...
	public function getcardprice()
	{
		...
		if (0 < $liveid) {
			$live_product = pdo_fetch('SELECT *  FROM ' . tablename('tapgo_tt_goods') . ' WHERE id = \'' . $goodsarr[0]['goodsid'] . '\'');
	...
	public function caculatecard($card_id, $dispatch_price, $lotterydiscountprice, $taskcut, $goodsarr, $totalprice, $discountprice, $isdiscountprice, $liveid, $isSubmit = 0, $goods_dispatch = array())
	{
		...
		if (is_array($goodsarr)) {
			...
			foreach ($goodsarr as $k => &$g ) {
				...
				if ($g['status'] != 2) {
					if (0 < $liveid) {
						$live_product = pdo_fetch('SELECT *  FROM ' . tablename('tapgo_tt_goods') . ' WHERE id = \'' . $g['goodsid'] . '\'');
	...
	public function isfullbackgoods($goodsid = 0, $optionid = 0)
	{
		...
		if (0 < $optionid) {
			$fullback_goods = pdo_fetch('select id from' . tablename('tapgo_tt_fullback_goods') . 'where goodsid=:goodsid and hasoption =1 and status=1 and uniacid=:uniacid and find_in_set(\'' . $optionid . '\',optionid)', array(':uniacid' => $_W['uniacid'], ':goodsid' => $goodsid));
		}
		 else {
			$fullback_goods = pdo_get('tapgo_tt_fullback_goods', array('status' => 1, 'goodsid' => $goodsid, 'uniacid' => $_W['uniacid']), 'id');
		}
