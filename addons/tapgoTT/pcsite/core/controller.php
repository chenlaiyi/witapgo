...
class Controller
{
	public function template($name = '')
	{
		...
		$compile = IA_ROOT . '/data/tpl/web/tapgo_tt_web/' . ES_STYLE . '/' . $name . '.tpl.php';
	...
	{
		global $_W;
		$basicset = pdo_fetch('select * from ' . tablename('tapgo_tt_system_site') . ' where `type`=:type', array(':type' => 'set'));
