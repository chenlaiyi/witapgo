...
class Queue
{
    ...
    public $tableName = 'tapgo_tt_queue';
    ...
    public static function autoload($className)
    {
        ...
        $classFile = TAPGO_TT_PATH. str_replace('\\', '/', $className) . '.php';
    ...
    protected function runWorker(callable $handler)
    {
        ...
        file_put_contents(TAPGO_TT_CORE.'queue.pid',$this->_workerPid);
        if (function_exists('chmod')){
            chmod(TAPGO_TT_CORE.'queue.pid',0777);
        }
