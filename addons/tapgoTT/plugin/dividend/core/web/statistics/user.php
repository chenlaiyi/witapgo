...
class User_TapgoTtPage extends DividendWebPage 
{
	public function main() 
	{
		...
		$psize = 100;
		$sql = 'select * from ' . tablename('tapgo_tt_member') . ' where headsid = :headsid and uniacid = :uniacid ORDER BY headstime desc';
		...
		if (!(empty($searchstart))) 
		{
			...
			$total_sql = 'select COUNT(1) from ' . tablename('tapgo_tt_member') . ' where headsid = :headsid and uniacid = :uniacid';
