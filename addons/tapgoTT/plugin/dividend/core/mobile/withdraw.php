...
class Withdraw_TapgoTtPage extends DIvidendMobileLoginPage 
{
	public function main() 
	{
		...
		if (!(empty($agentid))) 
		{
			$data = pdo_fetch('select sum(deductionmoney) as sumcharge from ' . tablename('tapgo_tt_dividend_log') . ' where mid=:mid and uniacid=:uniacid  limit 1', array(':uniacid' => $_W['uniacid'], ':mid' => $agentid));
