        ...
        function ($scope, $http, $compile, $controller, $sce, $interval) {
            ...
            $scope.function = {
                ...
                'get_list': function (url, page) {
                    if (!url) {
                        url = "/web/index.php?c=site&a=entry&m=tapgo_ttv2&do=web&r=open_farm.indicate.getList&page=1"
                    }
                    if (page) {
                ...
                'add_indicate': function () {
                    ...
                    $http.post(
                        '/web/index.php?c=site&a=entry&m=tapgo_ttv2&do=web&r=open_farm.indicate.addInfo',
                        $scope.data.indicate_info
                    ).then(
                        function (result) {
                ...
                'delete_indicate': function (id) {
                    if (confirm('确定要删除该新手指引吗?')) {
                        $http.post(
                            '/web/index.php?c=site&a=entry&m=tapgo_ttv2&do=web&r=open_farm.indicate.deleteInfo',
                            {
                                'id': id,
                            }
                        ).then(
            ...
            $scope.function.get_list("/web/index.php?c=site&a=entry&m=tapgo_ttv2&do=web&r=open_farm.indicate.getList&page=1");
