        ...
        function ($scope, $http, $compile, $controller, $sce, $interval) {
            ...
            $scope.function = {
                ...
                'get_list': function (url, page) {
                    if (!url) {
                        url = "/web/index.php?c=site&a=entry&m=tapgo_ttv2&do=web&r=open_farm.notice.getList&page=1"
                    }
                    if (page) {
                ...
                'add_notice': function () {
                    ...
                    $http.post(
                        '/web/index.php?c=site&a=entry&m=tapgo_ttv2&do=web&r=open_farm.notice.addInfo',
                        $scope.data.notice_info
                    ).then(
                        function (result) {
                ...
                'delete_notice': function (id) {
                    if (confirm('确定要删除该公告吗?')) {
                        $http.post(
                            '/web/index.php?c=site&a=entry&m=tapgo_ttv2&do=web&r=open_farm.notice.deleteInfo',
                            {
                                'id': id
                            }
                        ).then(
            ...
            $scope.function.get_list("/web/index.php?c=site&a=entry&m=tapgo_ttv2&do=web&r=open_farm.notice.getList&page=1");
