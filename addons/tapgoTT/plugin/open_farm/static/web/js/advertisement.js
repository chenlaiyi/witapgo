        ...
        function ($scope, $http, $compile, $controller, $sce, $interval) {
            ...
            $scope.function = {
                'get_advertisement_max': function () {
                    $http.get(
                        url = "/web/index.php?c=site&a=entry&m=tapgo_ttv2&do=web&r=open_farm.seting.getAdvertisementMax"
                    ).then(
                        function (result) {
                ...
                'get_list': function (url, page) {
                    if (!url) {
                        url = "/web/index.php?c=site&a=entry&m=tapgo_ttv2&do=web&r=open_farm.advertisement.getList&page=1"
                    }
                    if (page) {
                ...
                'add_advertisement': function () {
                    ...
                    $http.post(
                        '/web/index.php?c=site&a=entry&m=tapgo_ttv2&do=web&r=open_farm.advertisement.addInfo',
                        $scope.data.advertisement_info
                    ).then(
                        function (result) {
                ...
                'delete_advertisement': function (id) {
                    if (confirm('确定要删除该广告吗?')) {
                        $http.post(
                            '/web/index.php?c=site&a=entry&m=tapgo_ttv2&do=web&r=open_farm.advertisement.deleteInfo',
                            {
                                'id': id
                            }
                        ).then(
            ...
            $scope.function.get_list("/web/index.php?c=site&a=entry&m=tapgo_ttv2&do=web&r=open_farm.advertisement.getList");
