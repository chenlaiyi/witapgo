    ...
    [
        ...
        function ($scope, $http, $compile, $controller, $sce, $interval) {
            ...
            $scope.function = {
                'get_type': function () {
                    $http.get(
                        url = "/web/index.php?c=site&a=entry&m=tapgo_ttv2&do=web&r=open_farm.market.getType"
                    ).then(
                        function (result) {
                ...
                'get_list': function (url, page) {
                    if (!url) {
                        url = "/web/index.php?c=site&a=entry&m=tapgo_ttv2&do=web&r=open_farm.market.getList&page=1"
                    }
                    if (page) {
                ...
                'add_market': function () {
                    ...
                    $http.post(
                        '/web/index.php?c=site&a=entry&m=tapgo_ttv2&do=web&r=open_farm.market.addInfo',
                        $scope.data.market_info
                    ).then(
                        function (result) {
                ...
                'delete_market': function (id) {
                    if (confirm('确定要删除该兑换商品吗?')) {
                        $http.post(
                            '/web/index.php?c=site&a=entry&m=tapgo_ttv2&do=web&r=open_farm.market.deleteInfo',
                            {
                                'id':id
                            }
                        ).then(
            ...
            $scope.function.get_list("/web/index.php?c=site&a=entry&m=tapgo_ttv2&do=web&r=open_farm.market.getList&page=1");
