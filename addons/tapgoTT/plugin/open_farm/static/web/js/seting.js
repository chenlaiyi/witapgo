    ...
    [
        ...
        function ($scope, $http, $compile, $controller, $sce, $interval) {
            ...
            $scope.function = {
                ...
                'get_info': function () {
                    $http.get(
                        '/web/index.php?c=site&a=entry&m=tapgo_ttv2&do=web&r=open_farm.seting.getInfo'
                    ).then(
                        function (result) {
                ...
                'edit_info': function () {
                    ...
                    $http.post(
                        '/web/index.php?c=site&a=entry&m=tapgo_ttv2&do=web&r=open_farm.seting.editInfo',
