            ...
            $scope.function = {
                ...
                'list_show': function () {
                    ...
                    $scope.function.get_list(
                        "/web/index.php?c=site&a=entry&m=tapgo_ttv2&do=web&r=open_farm.task.getList"
                    );
                },
                ...
                'get_category': function () {
                    $http.get(
                        '/web/index.php?c=site&a=entry&m=tapgo_ttv2&do=web&r=open_farm.task.getCategory'
                    ).then(
                        function (result) {
                ...
                'get_core': function () {
                    $http.get(
                        '/web/index.php?c=site&a=entry&m=tapgo_ttv2&do=web&r=open_farm.task.getTaskCore'
                    ).then(
                        function (result) {
                ...
                'get_member_level': function () {
                    $http.get(
                        '/web/index.php?c=site&a=entry&m=tapgo_ttv2&do=web&r=open_farm.task.getMemberLevel'
                    ).then(
                        function (result) {
                ...
                'get_goods': function () {
                    $http.get(
                        '/web/index.php?c=site&a=entry&m=tapgo_ttv2&do=web&r=open_farm.task.getGoods'
                    ).then(
                        function (result) {
                ...
                'add_info': function () {
                    ...
                    $http.post(
                        '/web/index.php?c=site&a=entry&m=tapgo_ttv2&do=web&r=open_farm.task.addInfo',
                        $scope.data.task_info
                    ).then(
                        function (result) {
                ...
                'delete_info': function (id) {
                    if (confirm('真的要删除该数据吗?')) {
                        $http.post(
                            '/web/index.php?c=site&a=entry&m=tapgo_ttv2&do=web&r=open_farm.task.deleteInfo',
                            {
                                id: id,
                            }
                        ).then(
