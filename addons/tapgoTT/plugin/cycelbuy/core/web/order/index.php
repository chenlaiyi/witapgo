...
class Index_TapgoTtPage extends PluginWebPage
{
    ...
    protected function selectOrderPrice($day = 0)
    {
        ...
        $sql = "select id,price,paytime from " . tablename("tapgo_tt_order") . " where uniacid = :uniacid and ismr=0 and isparent=0 and (status > 0 or ( status=0 and paytype=3)) and deleted=0 and paytime between :createtime1 and :createtime2";
