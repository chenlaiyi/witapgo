...
class Agent_TapgoTtPage extends PluginWebPage {
    ...
    function main() {
        ...
        $sql = "select dm.*,dm.nickname,dm.avatar,l.levelname,p.agentlevel as parentagentlevel, p.mobile as parentmobile,p.id as pid,p.nickname as parentname,p.avatar as parentavatar,f.follow as followed,p.realname as parentrealname, f.unfollowtime from " . tablename('tapgo_tt_member') . " dm "
