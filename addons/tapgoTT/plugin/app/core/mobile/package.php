...
class Package_TapgoTtPage extends AppMobilePage
{
    /**
     * 商品列表
     */
    ...
    public function get_list()
    {
        ...
        foreach( $packages as $key => $value ) 
        {
            ...
            {
                $g = pdo_fetch("SELECT id,marketprice,title,thumb FROM " . tablename("tapgo_tt_goods") . "\r\n                    WHERE uniacid = " . $uniacid . " and id = " . $val . "  ORDER BY id DESC");
