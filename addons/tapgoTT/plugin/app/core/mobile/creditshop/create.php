...
class Create_TapgoTtPage extends AppMobilePage
{
    public function main()
    {
        ...
        return app_json(array( "goods" => $goods, "is_openmerch" => $is_openmerch, "stores" => $stores, "address" => $address, "shop" => $shop, "member" => $member, "set" => $set ));
    }
    ...
    public function getaddress()
    {
        ...
        {
            $address = pdo_fetch("select * from " . tablename("tapgo_tt_member_address") . " where openid=:openid and deleted=0  and uniacid=:uniacid and id =:id limit 1", array( ":uniacid" => $uniacid, ":openid" => $openid, ":id" => $_GPC["addressid"] ));
