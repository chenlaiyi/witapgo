...
class Team_TapgoTtPage extends AppMobilePage
{
    ...
    public function details()
    {
        ...
        $myorder = pdo_fetch("SELECT * FROM " . tablename("tapgo_tt_groups_order") . " WHERE uniacid = " . $uniacid . " and openid = '" . $openid . "' and teamid = " . $teamid . " and paytime>0");
        ...
        foreach( $orders as $key => $value ) 
        {
            ...
            {
                $orders[$key]["avatar"] = tomedia("../addons/tapgo_ttv2/plugin/groups/template/mobile/default/images/user/" . mt_rand(1, 20) . ".jpg");
            }
        ...
        {
            $ladder = pdo_get("tapgo_tt_groups_ladder", array( "id" => $tuan_first_order["ladder_id"] ));
