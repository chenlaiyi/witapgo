...
class Release_TapgoTtPage extends PluginWebPage
{
	...
	public function main()
	{
		...
		if (is_error($auth)) {
			...
			$authUrl = TAPGO_TT_AUTH_WXAPP . 'index/index/xcxAuth.html?site_id=' . SITE_ID . '&uniacid=' . $_W['uniacid'];
			if ($is_auth) {
	...
	public function audit()
	{
		...
		if ($action == 'upload') {
			...
			$request = ihttp_post(TAPGO_TT_AUTH_WXAPP . 'index/index/submitCode2.html?site_id=' . SITE_ID . '&uniacid=' . $_W['uniacid'], array('tabBar' => $tabBar));
		}
		else {
			$request = ihttp_post(TAPGO_TT_AUTH_WXAPP . 'index/index/auditCode.html?site_id=' . SITE_ID . '&uniacid=' . $_W['uniacid'], array());
		}
	...
	public function auth()
	{
		...
		header('Location:' . TAPGO_TT_AUTH_WXAPP . 'index/index/xcxAuth?site_id=' . SITE_ID . '&uniacid=' . $_W['uniacid']);
	}
