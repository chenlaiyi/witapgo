...
class Template_TapgoTtPage extends PluginWebPage
{
	...
	public function check()
	{
		...
		if ($_W['ispost']) {
			...
			$member = pdo_fetch('select *  from ' . tablename('tapgo_tt_member') . ' where openid=:openid and uniacid = :uniacid ', array(':openid' => $check_openid, ':uniacid' => $_W['uniacid']));
