...
class Create_TapgoTtPage extends PluginMobileLoginPage {
    ...
    function dispatch(){
        ...
        $address = pdo_fetch('select id,realname,mobile,address,province,city,area,datavalue,street from ' . tablename('tapgo_tt_member_address') . '
