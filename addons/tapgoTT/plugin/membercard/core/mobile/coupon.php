...
class Coupon_TapgoTtPage extends PluginMobileLoginPage
{
	...
	public function payresult($a = array())
	{
		...
		pdo_insert('tapgo_tt_member_card_monthsend', $data);
	...
	public function get_month_coupon()
	{
		...
		pdo_insert('tapgo_tt_member_card_monthsend', $send_log);
		show_json(1, '领取成功');
	}
	...
	public function get_month_point()
	{
		...
		$recid = pdo_insert('tapgo_tt_member_card_monthsend', $send_log);
