<?php
class Map_TapgoTtPage extends PluginMobilePage 
{
	public function main() 
	{
		...
		$store = pdo_fetch('select * from ' . tablename('tapgo_tt_merch_user') . ' where id=:merchid and uniacid=:uniacid Limit 1', array(':uniacid' => $_W['uniacid'], ':merchid' => $merchid));
