...
class Order_TapgoTtPage extends PluginWebPage {
    ...
    function main() {
        ...
        $sql = "select o.*, a.realname as addressname,m.realname,u.merchname from " . tablename('tapgo_tt_order') . ' o '
        ...
        foreach ($list as &$row) {
            ...
            $row['goods'] = pdo_fetchall("SELECT g.thumb,og.price,og.total,og.realprice,g.title,og.optionname from " . tablename('tapgo_tt_order_goods') . " og"
        ...
        $total = pdo_fetchall("select o.id from " . tablename('tapgo_tt_order') . ' o '
            . " left join " . tablename('tapgo_tt_member') . " m on o.openid = m.openid "
            . " left join " . tablename('tapgo_tt_member_address') . " a on a.id = o.addressid "
            . " left join " . tablename('tapgo_tt_merch_user') . " u on u.id = o.merchid "
