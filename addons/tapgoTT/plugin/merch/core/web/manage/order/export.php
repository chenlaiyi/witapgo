...
class Export_TapgoTtPage extends MerchWebPage {
    ...
    public function main() {
        ...
        if ($_GPC['export'] == 1) {
            ...
            $sql = "select o.* , a.realname as arealname,a.mobile as amobile,a.province as aprovince ,a.city as acity , a.area as aarea,a.address as aaddress,a.street as astreet,d.dispatchname,m.nickname,m.id as mid,m.realname as mrealname,m.mobile as mmobile,sm.id as salerid,sm.nickname as salernickname,s.salername from " . tablename('tapgo_tt_order') . " o"
                ...
                . " left join " . tablename('tapgo_tt_member') . " sm on sm.openid = o.verifyopenid and sm.uniacid=o.uniacid"
                . " left join " . tablename('tapgo_tt_merch_saler') . " s on s.openid = o.verifyopenid and s.uniacid=o.uniacid"
        ...
        $stores = pdo_fetchall('select id,storename from ' . tablename('tapgo_tt_merch_store') . ' where uniacid=:uniacid and merchid = :merchid', array(':uniacid' => $_W['uniacid'], ':merchid' => $_W['merchid']));
