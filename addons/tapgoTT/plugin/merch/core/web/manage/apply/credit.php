...
class Credit_TapgoTtPage extends MerchWebPage {
    ...
    protected  function applyData($status, $st){
        ...
        $sql = "select b.*,u.merchname,u.realname,u.mobile,u.iscreditmoney,b.creditrate,b.isbillcredit from " . tablename('tapgo_tt_merch_bill') . " b "
    ...
    protected function post() {
        ...
        if ($_W['ispost']) {
            ...
            foreach ($list as $k => $v) {
                ...
                pdo_update('tapgo_tt_creditshop_log', $change_order_data, array('id' => $orderid));
            }
