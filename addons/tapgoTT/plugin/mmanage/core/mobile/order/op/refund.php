...
class Refund_TapgoTtPage extends MmanageMobilePage
{
    ...
    protected function submit()
    {
        ...
        if ($refundstatus == 0) {
            ...
            if ($item['parentid'] > 0) {
                $parent_item = pdo_fetch("SELECT id,ordersn,ordersn2,price FROM " . tablename('tapgo_tt_order') . " WHERE id = :id and uniacid=:uniacid Limit 1", array(':id' => $item['parentid'], ':uniacid' => $_W['uniacid']));
