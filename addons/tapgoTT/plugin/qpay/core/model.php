...
class QpayModel extends PluginModel
{
    ...
    public function RequestHandler()
    {
        ...
        $this->notify_url = $_W["siteroot"] . "addons/tapgo_ttv2/payment/wechat/notify.php";
    }
    /**
     *获取入口地址,不包含参数值
     */
    ...
    */
    public function build($params, $account = array(), $type)
    {
        ...
        $this->setParameter("device_info", isset($this->params["device_info"]) ? "tapgo_ttv2:" . $this->params["device_info"] : "tapgo_ttv2");
