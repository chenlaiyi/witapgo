...
class Index_TapgoTtPage extends PluginMobilePage
{
	...
	public function select()
	{
		...
		if (!empty($shop['selectgoods'])) {
			...
			if (!empty($goodsids)) {
				$goods = pdo_fetchall('select id,title,marketprice,thumb from ' . tablename('tapgo_tt_goods') . ' where uniacid=:uniacid and id in ( ' . trim($shop['goodsids']) . ')', array(':uniacid' => $_W['uniacid']));
