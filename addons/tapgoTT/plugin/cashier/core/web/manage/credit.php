...
class Credit_TapgoTtPage extends CashierWebPage 
{
	...
	public function recharge_submit() 
	{
		...
		pdo_delete('tapgo_tt_cashier_log', array('cashierid' => $_W['cashierid'], 'status' => 0, 'uniacid' => $_W['uniacid']));
		pdo_insert('tapgo_tt_cashier_log', $log);
		$logid = pdo_insertid();
		if (!($logid)) 
		{
