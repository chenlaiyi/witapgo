...
class List_TapgoTtPage extends PluginMobileLoginPage
{
	public function main()
	{
		...
		$categorys = pdo_fetchall('select * from ' . tablename('tapgo_tt_live_category') . ' where uniacid = ' . $uniacid . ' and enabled = 1 ');
	...
	public function get_list()
	{
		...
		if (!empty($total)) {
			$sql = 'SELECT id,title,thumb,livetime,covertype,cover,subscribe,living FROM ' . tablename('tapgo_tt_live') . '
