...
class Taobaocsv_TapgoTtPage extends PluginWebPage
{
    function main()
    {
        global $_W, $_GPC;
        ...
        $excelurl =$_W['siteroot'].'addons/tapgo_ttv2/plugin/goodshelper/data/test.xlsx';
        $zipurl =$_W['siteroot'].'addons/tapgo_ttv2/plugin/goodshelper/data/test.zip';
