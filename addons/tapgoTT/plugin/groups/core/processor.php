...
class GroupsProcessor extends PluginProcessor
{
    public function __construct()
    {
        ...
        $this->sessionkey = TAPGO_TT_PREFIX . "gorder_wechat_verify_info";
        $this->codekey = TAPGO_TT_PREFIX . "gorder_wechat_verify_code";
    }
