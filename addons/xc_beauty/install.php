<?php
pdo_query("DROP TABLE IF EXISTS `ims_xc_beauty_address`;
...
`map` longtext DEFAULT NULL COMMENT '地址',
`content` longtext DEFAULT NULL COMMENT '地址',
...
`content` longtext DEFAULT NULL COMMENT '详情',
`createtime` timestamp NULL DEFAULT CURRENT_TIMESTAMP  COMMENT '添加时间',
...
`order` int(11) DEFAULT NULL DEFAULT '0' COMMENT '订单量',
...
`times` longtext DEFAULT NULL COMMENT '有效期',
...
`content` longtext DEFAULT NULL COMMENT '详情',
`imgs` longtext DEFAULT NULL COMMENT '图片集',
...
`pid` int(11) DEFAULT NULL COMMENT '产品id',
`team` longtext DEFAULT NULL COMMENT '队伍',
`status` int(11) DEFAULT NULL DEFAULT '-1' COMMENT '状态（-1拼团中1成功2失败）',
`createtime` timestamp NULL DEFAULT CURRENT_TIMESTAMP  COMMENT '添加时间',
`failtime` varchar(50) DEFAULT NULL COMMENT '失败天数',
`total` int(11) DEFAULT NULL DEFAULT '0' COMMENT '人数',
`team_total` int(11) DEFAULT NULL DEFAULT '0' COMMENT '团队人数',
PRIMARY KEY (`id`),
...
`userinfo` longtext DEFAULT NULL COMMENT '用户信息',
...
`content` longtext DEFAULT NULL COMMENT '备注',
...
`refund_content` longtext DEFAULT NULL COMMENT '退款理由',
...
`is_use` int(11) DEFAULT NULL DEFAULT '0' COMMENT '已使用',
...
`he_log` longtext DEFAULT NULL COMMENT '核销记录',
...
`openid` varchar(50) DEFAULT NULL COMMENT '用户id',
`out_trade_no` varchar(50) DEFAULT NULL COMMENT '订单号',
`pid` longtext DEFAULT NULL COMMENT '产品',
...
`sort` int(11) DEFAULT NULL DEFAULT '0' COMMENT '排序',
`createtime` timestamp NULL DEFAULT CURRENT_TIMESTAMP  COMMENT '添加时间',
`times` int(11) DEFAULT NULL DEFAULT '0' COMMENT '概率',
...
`uniacid` int(11) DEFAULT NULL,
`openid` varchar(50) DEFAULT NULL COMMENT '用户id',
`times` int(11) DEFAULT NULL DEFAULT '0' COMMENT '签到次数',
`plan_date` varchar(50) DEFAULT NULL COMMENT '签到日期',
`status` int(11) DEFAULT NULL DEFAULT '-1' COMMENT '是否已抽奖',
`rotated` int(11) DEFAULT NULL DEFAULT '0' COMMENT '抽奖次数',
PRIMARY KEY (`id`),
...
`bimg` longtext DEFAULT NULL COMMENT '图片',
`price` varchar(50) DEFAULT NULL COMMENT '价格',
`o_price` varchar(50) DEFAULT NULL COMMENT '原价',
`kind` longtext DEFAULT NULL COMMENT '种类',
`discuss` int(11) DEFAULT NULL DEFAULT '0' COMMENT '评价总人数',
`discuss_total` int(11) DEFAULT NULL DEFAULT '0' COMMENT '评价总数',
`good_total` int(11) DEFAULT NULL DEFAULT '0' COMMENT '满意总数',
`middle_total` int(11) DEFAULT NULL DEFAULT '0' COMMENT '一般总数',
`bad_total` int(11) DEFAULT NULL DEFAULT '0' COMMENT '不满意总数',
`content` longtext DEFAULT NULL COMMENT '详情',
`status` int(11) DEFAULT NULL DEFAULT '1' COMMENT '状态',
`sort` int(11) DEFAULT NULL DEFAULT '0' COMMENT '排序',
`createtime` timestamp NULL DEFAULT CURRENT_TIMESTAMP  COMMENT '添加时间',
...
`group_total` int(11) DEFAULT NULL DEFAULT '0' COMMENT '团购数',
...
`store` longtext DEFAULT NULL COMMENT '适用门店',
...
`sold` int(11) DEFAULT NULL DEFAULT '0' COMMENT '已售数',
`content_type` int(11) DEFAULT NULL DEFAULT '1' COMMENT '详情模式',
`content2` longtext DEFAULT NULL COMMENT '详情2',
`parameter` longtext DEFAULT NULL COMMENT '参数',
...
`flash_order` int(11) DEFAULT NULL DEFAULT '0' COMMENT '每人限买单数',
`flash_shu` int(11) DEFAULT NULL DEFAULT '0' COMMENT '每单限购数',
...
`cid` int(11) DEFAULT NULL DEFAULT '0' COMMENT '店面',
`task` varchar(255) DEFAULT NULL COMMENT '职称',
`service` longtext DEFAULT NULL COMMENT '服务项目',
`sort` int(11) DEFAULT NULL DEFAULT '0' COMMENT '排序',
`status` int(11) DEFAULT NULL DEFAULT '1' COMMENT '状态',
`createtime` timestamp NULL DEFAULT CURRENT_TIMESTAMP  COMMENT '添加时间',
`tag` varchar(255) DEFAULT NULL COMMENT '标签',
`content` longtext DEFAULT NULL COMMENT '个人简介',
`zan` int(11) DEFAULT NULL DEFAULT '0' COMMENT '点赞人数',
...
`plan_date` varchar(50) DEFAULT NULL COMMENT '日期',
`total` int(11) DEFAULT NULL DEFAULT '0' COMMENT '已预约数量',
`createtime` timestamp NULL DEFAULT CURRENT_TIMESTAMP  COMMENT '添加时间',
PRIMARY KEY (`id`),
KEY `uniacid` (`uniacid`,`createtime`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
`status` int(11) DEFAULT NULL DEFAULT '1' COMMENT '状态',
`createtime` timestamp NULL DEFAULT CURRENT_TIMESTAMP  COMMENT '添加时间',
`money` varchar(50) DEFAULT NULL DEFAULT '0' COMMENT '余额',
...
`level_one` int(11) DEFAULT NULL DEFAULT '0' COMMENT '一级数量',
`level_two` int(11) DEFAULT NULL DEFAULT '0' COMMENT '二级数量',
`level_three` int(11) DEFAULT NULL DEFAULT '0' COMMENT '三级数量',
`share_amount` varchar(50) DEFAULT NULL DEFAULT '0' COMMENT '累计佣金',
`share_o_amount` varchar(50) DEFAULT NULL DEFAULT '0' COMMENT '可提现佣金',
`share_t_amount` varchar(50) DEFAULT NULL DEFAULT '0' COMMENT '已提现佣金',
`share_empty` varchar(50) DEFAULT NULL DEFAULT '0' COMMENT '无效佣金',
...
`out_trade_no` varchar(50) DEFAULT NULL COMMENT '订单号',
`wx_out_trade_no` varchar(50) DEFAULT NULL COMMENT '微信订单号',
`content` longtext DEFAULT NULL COMMENT '错误详情',
PRIMARY KEY (`id`),
KEY `uniacid` (`uniacid`,`openid`,`createtime`,`status`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
