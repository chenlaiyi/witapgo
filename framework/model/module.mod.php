...
function module_expired_list() {
	...
	if (!empty($module_list)) {
		foreach ($module_list as $module_name) {
			...
			if (!empty($module['service_expiretime']) && $module['service_expiretime'] < TIMESTAMP && $module['site_branch']['status'] && (empty($module['system_shutdown_delay_time']) || TIMESTAMP < $module['system_shutdown_delay_time'])) {
